...
// RUN: %clang -c -fintegrated-as -target x86_64-linux -target x86_64-linux %t/foo-cg.pch -o %t/foo-cg.o -### 2>&1 | FileCheck %s -check-prefix=CHECK-PCH-CODEGEN-OBJ
...
// RUN: %clang -c -fintegrated-as -target x86_64-linux -target x86_64-linux %t/foo-di.pch -g -o %t/foo-di.o -### 2>&1 | FileCheck %s -check-prefix=CHECK-PCH-DEBUGINFO-OBJ
