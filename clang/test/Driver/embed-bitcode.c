...
// RUN: %clang %s -c -fembed-bitcode -fintegrated-as -target x86_64 2>&1 -### | FileCheck %s -check-prefix=CHECK-CC
// CHECK-CC: -cc1
...
// RUN: %clang %s -c -fembed-bitcode=bitcode -fintegrated-as -target x86_64 2>&1 -### | FileCheck %s -check-prefix=CHECK-BITCODE
// CHECK-BITCODE: -cc1
...
//
// RUN: %clang %s -c -save-temps -fembed-bitcode -fintegrated-as -target x86_64 2>&1 -### | FileCheck %s -check-prefix=CHECK-SAVE-TEMP
// CHECK-SAVE-TEMP: -cc1
// CHECK-SAVE-TEMP: -E
// CHECK-SAVE-TEMP: -cc1
...
// RUN: %clang -c %s -fembed-bitcode-marker -fintegrated-as -target x86_64 2>&1 -### | FileCheck %s -check-prefix=CHECK-MARKER
// CHECK-MARKER: -cc1
