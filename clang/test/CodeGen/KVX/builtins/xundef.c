...
// RUN: %clang_cc1 -triple kvx-kalray-cos -target-cpu kv3-1 -O0 -emit-llvm -o - %s | FileCheck %s
// RUN: %clang_cc1 -triple kvx-kalray-cos -target-cpu kv3-2 -O0 -emit-llvm -o - %s | FileCheck %s
