...
// RUN: %clang_cc1 -triple kvx-kalray-cos -target-cpu kv3-1 -O2 -emit-llvm -o - %s | FileCheck %s --check-prefix=ALL
// RUN: %clang_cc1 -triple kvx-kalray-cos -target-cpu kv3-2 -O2 -emit-llvm -o - %s | FileCheck %s --check-prefix=ALL
