...
//
v4f64 fadddcp(v4f64 lhs, v4f64 rhs) {  return __builtin_kvx_fadddcp(lhs, rhs, ".c.rn");}
...
//
v8f32 faddwcq(v8f32 lhs, v8f32 rhs) {  return __builtin_kvx_faddwcq(lhs, rhs, ".c.rn");}
...
// CHECK-NEXT:    ret <4 x double> [[TMP6]]
//
v4f64 fsbfdcp(v4f64 lhs, v4f64 rhs) {  return __builtin_kvx_fsbfdcp(lhs, rhs, ".c.rn");}
...
// CHECK-NEXT:    ret <8 x float> [[TMP6]]
//
v8f32 fsbfwcq(v8f32 lhs, v8f32 rhs) {  return __builtin_kvx_fsbfwcq(lhs, rhs, ".c.rn.s");}
