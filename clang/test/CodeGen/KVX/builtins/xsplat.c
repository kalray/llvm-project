...
// RUN: %clang_cc1 -O2 -triple kvx-kalray-cos -emit-llvm -target-cpu kv3-1 -o - -x c %s | FileCheck %s
// RUN: %clang_cc1 -O2 -triple kvx-kalray-cos -emit-llvm -target-cpu kv3-2 -o - -x c %s | FileCheck %s
