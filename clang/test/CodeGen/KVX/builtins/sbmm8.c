...
// CHECK-LABEL: @sbmm8do(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = extractelement <8 x i64> [[A:%.*]], i64 0
// CHECK-NEXT:    [[TMP1:%.*]] = extractelement <8 x i64> [[B:%.*]], i64 0
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP0]], i64 [[TMP1]])
// CHECK-NEXT:    [[TMP3:%.*]] = extractelement <8 x i64> [[A]], i64 1
// CHECK-NEXT:    [[TMP4:%.*]] = extractelement <8 x i64> [[B]], i64 1
// CHECK-NEXT:    [[TMP5:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP3]], i64 [[TMP4]])
// CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x i64> [[A]], i64 2
// CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x i64> [[B]], i64 2
// CHECK-NEXT:    [[TMP8:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP6]], i64 [[TMP7]])
// CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i64> [[A]], i64 3
// CHECK-NEXT:    [[TMP10:%.*]] = extractelement <8 x i64> [[B]], i64 3
// CHECK-NEXT:    [[TMP11:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP9]], i64 [[TMP10]])
// CHECK-NEXT:    [[TMP12:%.*]] = extractelement <8 x i64> [[A]], i64 4
// CHECK-NEXT:    [[TMP13:%.*]] = extractelement <8 x i64> [[B]], i64 4
// CHECK-NEXT:    [[TMP14:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP12]], i64 [[TMP13]])
// CHECK-NEXT:    [[TMP15:%.*]] = extractelement <8 x i64> [[A]], i64 5
// CHECK-NEXT:    [[TMP16:%.*]] = extractelement <8 x i64> [[B]], i64 5
// CHECK-NEXT:    [[TMP17:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP15]], i64 [[TMP16]])
// CHECK-NEXT:    [[TMP18:%.*]] = extractelement <8 x i64> [[A]], i64 6
// CHECK-NEXT:    [[TMP19:%.*]] = extractelement <8 x i64> [[B]], i64 6
// CHECK-NEXT:    [[TMP20:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP18]], i64 [[TMP19]])
// CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i64> [[A]], i64 7
// CHECK-NEXT:    [[TMP22:%.*]] = extractelement <8 x i64> [[B]], i64 7
// CHECK-NEXT:    [[TMP23:%.*]] = tail call i64 @llvm.kvx.sbmm8(i64 [[TMP21]], i64 [[TMP22]])
...
// CHECK-NEXT:    [[TMP12:%.*]] = extractelement <8 x i64> [[A]], i64 4
// CHECK-NEXT:    [[TMP13:%.*]] = extractelement <8 x i64> [[B]], i64 4
// CHECK-NEXT:    [[TMP14:%.*]] = tail call i64 @llvm.kvx.sbmmt8(i64 [[TMP12]], i64 [[TMP13]])
// CHECK-NEXT:    [[TMP15:%.*]] = extractelement <8 x i64> [[A]], i64 5
// CHECK-NEXT:    [[TMP16:%.*]] = extractelement <8 x i64> [[B]], i64 5
// CHECK-NEXT:    [[TMP17:%.*]] = tail call i64 @llvm.kvx.sbmmt8(i64 [[TMP15]], i64 [[TMP16]])
// CHECK-NEXT:    [[TMP18:%.*]] = extractelement <8 x i64> [[A]], i64 6
// CHECK-NEXT:    [[TMP19:%.*]] = extractelement <8 x i64> [[B]], i64 6
// CHECK-NEXT:    [[TMP20:%.*]] = tail call i64 @llvm.kvx.sbmmt8(i64 [[TMP18]], i64 [[TMP19]])
// CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i64> [[A]], i64 7
// CHECK-NEXT:    [[TMP22:%.*]] = extractelement <8 x i64> [[B]], i64 7
// CHECK-NEXT:    [[TMP23:%.*]] = tail call i64 @llvm.kvx.sbmmt8(i64 [[TMP21]], i64 [[TMP22]])
// CHECK-NEXT:    [[TMP24:%.*]] = insertelement <8 x i64> poison, i64 [[TMP2]], i64 0
// CHECK-NEXT:    [[TMP25:%.*]] = insertelement <8 x i64> [[TMP24]], i64 [[TMP5]], i64 1
// CHECK-NEXT:    [[TMP26:%.*]] = insertelement <8 x i64> [[TMP25]], i64 [[TMP8]], i64 2
// CHECK-NEXT:    [[TMP27:%.*]] = insertelement <8 x i64> [[TMP26]], i64 [[TMP11]], i64 3
