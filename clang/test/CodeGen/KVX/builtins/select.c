...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = extractelement <8 x i64> [[T:%.*]], i64 0
// CHECK-NEXT:    [[TMP1:%.*]] = extractelement <8 x i64> [[F:%.*]], i64 0
// CHECK-NEXT:    [[TMP2:%.*]] = extractelement <8 x i64> [[C:%.*]], i64 0
// CHECK-NEXT:    [[TMP3:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP0]], i64 [[TMP1]], i64 [[TMP2]], i32 7)
// CHECK-NEXT:    [[TMP4:%.*]] = extractelement <8 x i64> [[T]], i64 1
// CHECK-NEXT:    [[TMP5:%.*]] = extractelement <8 x i64> [[F]], i64 1
// CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x i64> [[C]], i64 1
// CHECK-NEXT:    [[TMP7:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP4]], i64 [[TMP5]], i64 [[TMP6]], i32 7)
// CHECK-NEXT:    [[TMP8:%.*]] = extractelement <8 x i64> [[T]], i64 2
// CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i64> [[F]], i64 2
// CHECK-NEXT:    [[TMP10:%.*]] = extractelement <8 x i64> [[C]], i64 2
// CHECK-NEXT:    [[TMP11:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP8]], i64 [[TMP9]], i64 [[TMP10]], i32 7)
// CHECK-NEXT:    [[TMP12:%.*]] = extractelement <8 x i64> [[T]], i64 3
// CHECK-NEXT:    [[TMP13:%.*]] = extractelement <8 x i64> [[F]], i64 3
// CHECK-NEXT:    [[TMP14:%.*]] = extractelement <8 x i64> [[C]], i64 3
// CHECK-NEXT:    [[TMP15:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP12]], i64 [[TMP13]], i64 [[TMP14]], i32 7)
// CHECK-NEXT:    [[TMP16:%.*]] = extractelement <8 x i64> [[T]], i64 4
// CHECK-NEXT:    [[TMP17:%.*]] = extractelement <8 x i64> [[F]], i64 4
// CHECK-NEXT:    [[TMP18:%.*]] = extractelement <8 x i64> [[C]], i64 4
// CHECK-NEXT:    [[TMP19:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP16]], i64 [[TMP17]], i64 [[TMP18]], i32 7)
// CHECK-NEXT:    [[TMP20:%.*]] = extractelement <8 x i64> [[T]], i64 5
// CHECK-NEXT:    [[TMP21:%.*]] = extractelement <8 x i64> [[F]], i64 5
// CHECK-NEXT:    [[TMP22:%.*]] = extractelement <8 x i64> [[C]], i64 5
// CHECK-NEXT:    [[TMP23:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP20]], i64 [[TMP21]], i64 [[TMP22]], i32 7)
// CHECK-NEXT:    [[TMP24:%.*]] = extractelement <8 x i64> [[T]], i64 6
// CHECK-NEXT:    [[TMP25:%.*]] = extractelement <8 x i64> [[F]], i64 6
// CHECK-NEXT:    [[TMP26:%.*]] = extractelement <8 x i64> [[C]], i64 6
// CHECK-NEXT:    [[TMP27:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP24]], i64 [[TMP25]], i64 [[TMP26]], i32 7)
// CHECK-NEXT:    [[TMP28:%.*]] = extractelement <8 x i64> [[T]], i64 7
// CHECK-NEXT:    [[TMP29:%.*]] = extractelement <8 x i64> [[F]], i64 7
// CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i64> [[C]], i64 7
// CHECK-NEXT:    [[TMP31:%.*]] = tail call i64 @llvm.kvx.select.i64(i64 [[TMP28]], i64 [[TMP29]], i64 [[TMP30]], i32 7)
// CHECK-NEXT:    [[TMP32:%.*]] = insertelement <8 x i64> poison, i64 [[TMP3]], i64 0
// CHECK-NEXT:    [[TMP33:%.*]] = insertelement <8 x i64> [[TMP32]], i64 [[TMP7]], i64 1
// CHECK-NEXT:    [[TMP34:%.*]] = insertelement <8 x i64> [[TMP33]], i64 [[TMP11]], i64 2
// CHECK-NEXT:    [[TMP35:%.*]] = insertelement <8 x i64> [[TMP34]], i64 [[TMP15]], i64 3
// CHECK-NEXT:    [[TMP36:%.*]] = insertelement <8 x i64> [[TMP35]], i64 [[TMP19]], i64 4
// CHECK-NEXT:    [[TMP37:%.*]] = insertelement <8 x i64> [[TMP36]], i64 [[TMP23]], i64 5
// CHECK-NEXT:    [[TMP38:%.*]] = insertelement <8 x i64> [[TMP37]], i64 [[TMP27]], i64 6
// CHECK-NEXT:    [[TMP39:%.*]] = insertelement <8 x i64> [[TMP38]], i64 [[TMP31]], i64 7
// CHECK-NEXT:    ret <8 x i64> [[TMP39]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = shufflevector <16 x i32> [[T:%.*]], <16 x i32> poison, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP1:%.*]] = shufflevector <16 x i32> [[F:%.*]], <16 x i32> poison, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <16 x i32> [[C:%.*]], <16 x i32> poison, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP3:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP0]], <2 x i32> [[TMP1]], <2 x i32> [[TMP2]], i32 7)
// CHECK-NEXT:    [[TMP4:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    [[TMP7:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP4]], <2 x i32> [[TMP5]], <2 x i32> [[TMP6]], i32 7)
// CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 4, i32 5>
// CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 4, i32 5>
// CHECK-NEXT:    [[TMP10:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 4, i32 5>
// CHECK-NEXT:    [[TMP11:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP8]], <2 x i32> [[TMP9]], <2 x i32> [[TMP10]], i32 7)
// CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 6, i32 7>
// CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 6, i32 7>
// CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 6, i32 7>
// CHECK-NEXT:    [[TMP15:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP12]], <2 x i32> [[TMP13]], <2 x i32> [[TMP14]], i32 7)
// CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 8, i32 9>
// CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 8, i32 9>
// CHECK-NEXT:    [[TMP18:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 8, i32 9>
// CHECK-NEXT:    [[TMP19:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP16]], <2 x i32> [[TMP17]], <2 x i32> [[TMP18]], i32 7)
// CHECK-NEXT:    [[TMP20:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 10, i32 11>
// CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 10, i32 11>
// CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 10, i32 11>
// CHECK-NEXT:    [[TMP23:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP20]], <2 x i32> [[TMP21]], <2 x i32> [[TMP22]], i32 7)
// CHECK-NEXT:    [[TMP24:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 12, i32 13>
// CHECK-NEXT:    [[TMP25:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 12, i32 13>
// CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 12, i32 13>
// CHECK-NEXT:    [[TMP27:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP24]], <2 x i32> [[TMP25]], <2 x i32> [[TMP26]], i32 7)
// CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <16 x i32> [[T]], <16 x i32> poison, <2 x i32> <i32 14, i32 15>
// CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <16 x i32> [[F]], <16 x i32> poison, <2 x i32> <i32 14, i32 15>
// CHECK-NEXT:    [[TMP30:%.*]] = shufflevector <16 x i32> [[C]], <16 x i32> poison, <2 x i32> <i32 14, i32 15>
// CHECK-NEXT:    [[TMP31:%.*]] = tail call <2 x i32> @llvm.kvx.select.vec.v2i32(<2 x i32> [[TMP28]], <2 x i32> [[TMP29]], <2 x i32> [[TMP30]], i32 7)
// CHECK-NEXT:    [[TMP32:%.*]] = shufflevector <2 x i32> [[TMP3]], <2 x i32> [[TMP7]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    [[TMP33:%.*]] = shufflevector <2 x i32> [[TMP11]], <2 x i32> [[TMP15]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    [[TMP34:%.*]] = shufflevector <2 x i32> [[TMP19]], <2 x i32> [[TMP23]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    [[TMP35:%.*]] = shufflevector <2 x i32> [[TMP27]], <2 x i32> [[TMP31]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    [[TMP36:%.*]] = shufflevector <4 x i32> [[TMP32]], <4 x i32> [[TMP33]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    [[TMP37:%.*]] = shufflevector <4 x i32> [[TMP34]], <4 x i32> [[TMP35]], <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    [[TMP38:%.*]] = shufflevector <8 x i32> [[TMP36]], <8 x i32> [[TMP37]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
// CHECK-NEXT:    ret <16 x i32> [[TMP38]]
//
