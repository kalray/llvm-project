...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[CONV]], i64* [[TMP0]], i32 8, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
// CHECK-NEXT:    [[CONV1:%.*]] = trunc i64 [[TMP1]] to i8
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 8, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[CONV]], i64* [[TMP0]], i32 16, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
// CHECK-NEXT:    [[CONV1:%.*]] = trunc i64 [[TMP1]] to i16
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 16, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[CONV]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 64, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <2 x i64> @llvm.kvx.loadc.u.v2i64(<2 x i64> [[TMP0]], <2 x i64>* [[TMP1]], i32 128, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call half @llvm.kvx.loadc.u.f16(half [[A:%.*]], half* [[TMP0]], i32 16, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call float @llvm.kvx.loadc.u.f32(float [[A:%.*]], float* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call double @llvm.kvx.loadc.u.f64(double [[A:%.*]], double* [[TMP0]], i32 64, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call <2 x i32> @llvm.kvx.loadc.u.v2i32(<2 x i32> [[A:%.*]], <2 x i32>* [[TMP0]], i32 64, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 1, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 2, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[A:%.*]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 3, i32 2, i32 -1)
// CHECK-NEXT:    ret i64 [[TMP1]]
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 2, i32 -1)
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 0, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 1, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 3, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 4, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 5, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 6, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 7, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 8, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 9, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 10, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 11, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 12, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8* [[PTR:%.*]] to <4 x i64>*
// CHECK-NEXT:    [[TMP2:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP0]], <4 x i64>* [[TMP1]], i32 256, i64 [[COND:%.*]], i32 0, i32 13, i32 -1)
// CHECK-NEXT:    [[TMP3:%.*]] = bitcast <4 x i64> [[TMP2]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP3]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.vol.i64(i64 [[CONV]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 0, i32 11, i32 -1)
...
// CHECK-NEXT:    [[CONV:%.*]] = sext i32 [[A:%.*]] to i64
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8* [[PTR:%.*]] to i64*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.kvx.loadc.u.i64(i64 [[CONV]], i64* [[TMP0]], i32 32, i64 [[COND:%.*]], i32 0, i32 11, i32 -1)
// CHECK-NEXT:    [[CONV3:%.*]] = trunc i64 [[TMP1]] to i32
// CHECK-NEXT:    ret i32 [[CONV3]]
//
