...
// CHECK-NEXT:    [[NEG:%.*]] = xor i128 [[AND]], -1
// CHECK-NEXT:    ret i128 [[NEG]]
//
...
// CHECK-LABEL: @andn_1(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[NEG:%.*]] = xor i128 [[A:%.*]], -1
// CHECK-NEXT:    [[AND:%.*]] = and i128 [[NEG]], [[B:%.*]]
// CHECK-NEXT:    ret i128 [[AND]]
//
...
// CHECK-LABEL: @andn_2(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[NEG:%.*]] = xor i128 [[B:%.*]], -1
// CHECK-NEXT:    [[AND:%.*]] = and i128 [[NEG]], [[A:%.*]]
// CHECK-NEXT:    ret i128 [[AND]]
//
...
// CHECK-NEXT:    [[AND:%.*]] = zext i8 [[TMP0]] to i32
...
// CHECK-LABEL: @shl(
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[SH_PROM:%.*]] = zext i32 [[B:%.*]] to i128
