...
// O2-NEXT:    [[TMP2:%.*]] = call <256 x i1> @llvm.kvx.xconvdhv1(<256 x i1> [[TMP0]], <1024 x i1> [[TMP1]], i32 0, i32 0)
// O2-NEXT:    [[TMP3:%.*]] = call <256 x i1> @llvm.kvx.xconvdhv0(<256 x i1> [[TMP2]], <1024 x i1> [[TMP1]], i32 0, i32 1)
...
// O2-NEXT:    [[TMP5:%.*]] = call <256 x i1> @llvm.kvx.xconvdhv(<1024 x i1> [[TMP4]], i32 3, i32 0)
...
// O2-NEXT:    [[TMP2:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv1(<256 x i1> [[TMP0]], <1024 x i1> [[TMP1]], i32 0, i32 0)
// O2-NEXT:    [[TMP3:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv0(<256 x i1> [[TMP2]], <1024 x i1> [[TMP1]], i32 0, i32 1)
// O2-NEXT:    [[TMP4:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv2(<256 x i1> [[TMP3]], <1024 x i1> [[TMP1]], i32 2, i32 0)
// O2-NEXT:    [[TMP5:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv3(<256 x i1> [[TMP4]], <1024 x i1> [[TMP1]], i32 4, i32 1)
// O2-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds <256 x i1>, <256 x i1>* [[V]], i64 1
// O2-NEXT:    store <256 x i1> [[TMP5]], <256 x i1>* [[ARRAYIDX5]], align 32, [[TBAA2]]
// O2-NEXT:    [[TMP6:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv3(<256 x i1> [[TMP4]], <1024 x i1> [[TMP1]], i32 0, i32 0)
...
// O2-NEXT:    [[TMP8:%.*]] = call <256 x i1> @llvm.kvx.xconvwbv(<1024 x i1> [[TMP7]], i32 3, i32 1)
...
// O2-NEXT:    [[TMP4:%.*]] = call <256 x i1> @llvm.kvx.xfmma242hw0(<256 x i1> [[TMP0]], <512 x i1> [[TMP1]], <256 x i1> [[TMP2]], <256 x i1> [[TMP3]])
// O2-NEXT:    [[TMP5:%.*]] = call <256 x i1> @llvm.kvx.xfmma242hw1(<256 x i1> [[TMP4]], <512 x i1> [[TMP1]], <256 x i1> [[TMP2]], <256 x i1> [[TMP3]])
// O2-NEXT:    [[TMP6:%.*]] = call <256 x i1> @llvm.kvx.xfmma242hw2(<256 x i1> [[TMP5]], <512 x i1> [[TMP1]], <256 x i1> [[TMP2]], <256 x i1> [[TMP3]])
...
// O2-NEXT:    [[TMP2:%.*]] = call <1024 x i1> @llvm.kvx.xinsertwm(<1024 x i1> [[TMP0]], <512 x i1> [[TMP1]], i32 0)
// O2-NEXT:    [[TMP3:%.*]] = call <1024 x i1> @llvm.kvx.xinsertwm(<1024 x i1> [[TMP2]], <512 x i1> [[TMP1]], i32 1)
...
// O2-NEXT:    [[TMP2:%.*]] = call <1024 x i1> @llvm.kvx.xinsertvm(<1024 x i1> [[TMP0]], <256 x i1> [[TMP1]], i32 0)
// O2-NEXT:    [[TMP3:%.*]] = call <1024 x i1> @llvm.kvx.xinsertvm(<1024 x i1> [[TMP2]], <256 x i1> [[TMP1]], i32 1)
// O2-NEXT:    [[TMP4:%.*]] = call <1024 x i1> @llvm.kvx.xinsertvm(<1024 x i1> [[TMP3]], <256 x i1> [[TMP1]], i32 2)
// O2-NEXT:    [[TMP5:%.*]] = call <1024 x i1> @llvm.kvx.xinsertvm(<1024 x i1> [[TMP4]], <256 x i1> [[TMP1]], i32 3)
...
// O2-NEXT:    [[TMP1:%.*]] = load <256 x i1>, <256 x i1>* [[A1:%.*]], align 32, [[TBAA2]]
// O2-NEXT:    [[TMP2:%.*]] = call <512 x i1> @llvm.kvx.xinsertvw(<512 x i1> [[TMP0]], <256 x i1> [[TMP1]], i32 0)
// O2-NEXT:    [[TMP3:%.*]] = call <512 x i1> @llvm.kvx.xinsertvw(<512 x i1> [[TMP2]], <256 x i1> [[TMP1]], i32 1)
...
// O2-NEXT:  entry:
// O2-NEXT:    [[TMP0:%.*]] = load <1024 x i1>, <1024 x i1>* [[A0:%.*]], align 32, [[TBAA6]]
// O2-NEXT:    [[TMP1:%.*]] = call <512 x i1> @llvm.kvx.xmovefmw(<1024 x i1> [[TMP0]], i32 0)
// O2-NEXT:    store <512 x i1> [[TMP1]], <512 x i1>* [[O:%.*]], align 32, [[TBAA8]]
// O2-NEXT:    [[TMP2:%.*]] = call <512 x i1> @llvm.kvx.xmovefmw(<1024 x i1> [[TMP0]], i32 1)
...
// O2-NEXT:  entry:
// O2-NEXT:    [[TMP0:%.*]] = load <1024 x i1>, <1024 x i1>* [[A0:%.*]], align 32, [[TBAA6]]
// O2-NEXT:    [[TMP1:%.*]] = call <256 x i1> @llvm.kvx.xmovefmv(<1024 x i1> [[TMP0]], i32 0)
// O2-NEXT:    store <256 x i1> [[TMP1]], <256 x i1>* [[O:%.*]], align 32, [[TBAA2]]
// O2-NEXT:    [[TMP2:%.*]] = call <256 x i1> @llvm.kvx.xmovefmv(<1024 x i1> [[TMP0]], i32 1)
...
// O2-NEXT:    [[TMP3:%.*]] = call <256 x i1> @llvm.kvx.xmovefmv(<1024 x i1> [[TMP0]], i32 2)
...
// O2-NEXT:    [[TMP4:%.*]] = call <256 x i1> @llvm.kvx.xmovefmv(<1024 x i1> [[TMP0]], i32 3)
...
// O2-NEXT:  entry:
// O2-NEXT:    [[TMP0:%.*]] = load <512 x i1>, <512 x i1>* [[A0:%.*]], align 32, [[TBAA8]]
// O2-NEXT:    [[TMP1:%.*]] = call <256 x i1> @llvm.kvx.xmovefwv(<512 x i1> [[TMP0]], i32 0)
// O2-NEXT:    store <256 x i1> [[TMP1]], <256 x i1>* [[O:%.*]], align 32, [[TBAA2]]
// O2-NEXT:    [[TMP2:%.*]] = call <256 x i1> @llvm.kvx.xmovefwv(<512 x i1> [[TMP0]], i32 1)
// O2-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds <256 x i1>, <256 x i1>* [[O]], i64 1
// O2-NEXT:    store <256 x i1> [[TMP2]], <256 x i1>* [[ARRAYIDX3]], align 32, [[TBAA2]]
// O2-NEXT:    ret void
//
...
// O2-NEXT:    [[TMP1:%.*]] = call <1024 x i1> @llvm.kvx.cat.v1024i1(<512 x i1> [[TMP0]], <512 x i1> [[TMP0]])
...
// O2-NEXT:    [[TMP3:%.*]] = call <1024 x i1> @llvm.kvx.cat.v1024i1(<512 x i1> [[TMP0]], <512 x i1> [[TMP2]])
// O2-NEXT:    store <1024 x i1> [[TMP3]], <1024 x i1>* [[M]], align 32, [[TBAA6]]
// O2-NEXT:    ret void
//
...
// O2-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds <256 x i1>, <256 x i1>* [[A]], i64 2
// O2-NEXT:    [[TMP1:%.*]] = load <256 x i1>, <256 x i1>* [[ARRAYIDX1]], align 32, [[TBAA2]]
// O2-NEXT:    [[TMP2:%.*]] = call <512 x i1> @llvm.kvx.cat.v512i1(<256 x i1> [[TMP0]], <256 x i1> [[TMP1]])
...
// O0-LABEL: @xcat2048(
// O0-NEXT:  entry:
// O0-NEXT:    [[W_ADDR:%.*]] = alloca <2048 x i1>*, align 8
// O0-NEXT:    store <2048 x i1>* [[W:%.*]], <2048 x i1>** [[W_ADDR]], align 8
// O0-NEXT:    [[TMP0:%.*]] = call <2048 x i1> @llvm.kvx.cat.v2048i1(<1024 x i1> zeroinitializer, <1024 x i1> zeroinitializer)
// O0-NEXT:    [[TMP1:%.*]] = load <2048 x i1>*, <2048 x i1>** [[W_ADDR]], align 8
// O0-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds <2048 x i1>, <2048 x i1>* [[TMP1]], i64 0
// O0-NEXT:    store <2048 x i1> [[TMP0]], <2048 x i1>* [[ARRAYIDX]], align 32
// O0-NEXT:    ret void
//
// O2-LABEL: @xcat2048(
// O2-NEXT:  entry:
// O2-NEXT:    [[TMP0:%.*]] = call <2048 x i1> @llvm.kvx.cat.v2048i1(<1024 x i1> zeroinitializer, <1024 x i1> zeroinitializer)
// O2-NEXT:    store <2048 x i1> [[TMP0]], <2048 x i1>* [[W:%.*]], align 32, [[TBAA10:!tbaa !.*]]
// O2-NEXT:    ret void
//
