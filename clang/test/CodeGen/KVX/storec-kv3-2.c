...
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP0]], ptr [[PTR:%.*]], i32 256, i64 [[COND:%.*]], i32 -1, i32 4)
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <8 x i32> [[A:%.*]] to <4 x i64>
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP0]], ptr [[PTR:%.*]], i32 256, i64 [[COND:%.*]], i32 -1, i32 5)
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = and i64 [[COND:%.*]], 65535
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i64> [[TMP0]], <2 x i64> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP2]], ptr [[PTR:%.*]], i32 256, i64 [[TMP1]], i32 -1, i32 4)
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast <4 x i32> [[A:%.*]] to <2 x i64>
// CHECK-NEXT:    [[TMP1:%.*]] = or i64 [[COND:%.*]], -65536
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <2 x i64> [[TMP0]], <2 x i64> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP2]], ptr [[PTR:%.*]], i32 256, i64 [[TMP1]], i32 -1, i32 5)
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <1 x i64> [[TMP1]], <1 x i64> undef, <4 x i32> <i32 0, i32 undef, i32 undef, i32 undef>
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP2]], ptr [[PTR:%.*]], i32 256, i64 [[TMP0]], i32 -1, i32 4)
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast <2 x i32> [[A:%.*]] to <1 x i64>
// CHECK-NEXT:    [[TMP2:%.*]] = shufflevector <1 x i64> [[TMP1]], <1 x i64> undef, <4 x i32> <i32 0, i32 undef, i32 undef, i32 undef>
// CHECK-NEXT:    tail call void (<4 x i64>, ptr, i32, i64, i32, i32, ...) @llvm.kvx.storec.v4i64(<4 x i64> [[TMP2]], ptr [[PTR:%.*]], i32 256, i64 [[TMP0]], i32 -1, i32 5)
// CHECK-NEXT:    ret void
//
