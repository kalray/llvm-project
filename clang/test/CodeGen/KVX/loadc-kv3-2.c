...
// CHECK-NEXT:    [[TMP5:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP4]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 4)
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i32> [[TMP0:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP4]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 5)
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i64> [[TMP5]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i32> [[TMP0:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP4]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 6)
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i64> [[TMP5]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <8 x i32> [[TMP0:%.*]] to <4 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP4]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 7)
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <4 x i64> [[TMP5]] to <8 x i32>
// CHECK-NEXT:    ret <8 x i32> [[TMP6]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP5]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 4)
// CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP6]], <4 x i64> undef, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x i64> [[TMP7]] to <4 x i32>
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP0:%.*]] to <2 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
// CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP5]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 5)
// CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP6]], <4 x i64> undef, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x i64> [[TMP7]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP8]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP0:%.*]] to <2 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
// CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP5]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 6)
// CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP6]], <4 x i64> undef, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x i64> [[TMP7]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP8]]
//
...
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x i32> [[TMP0:%.*]] to <2 x i64>
// CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
// CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP5]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 7)
// CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP6]], <4 x i64> undef, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <2 x i64> [[TMP7]] to <4 x i32>
// CHECK-NEXT:    ret <4 x i32> [[TMP8]]
//
...
// CHECK-NEXT:    [[TMP6:%.*]] = tail call <4 x i64> @llvm.kvx.loadc.u.v4i64(<4 x i64> [[TMP5]], ptr [[TMP1:%.*]], i32 256, i64 [[TMP2:%.*]], i32 0, i32 -1, i32 4)
// CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP6]], <4 x i64> undef, <1 x i32> zeroinitializer
