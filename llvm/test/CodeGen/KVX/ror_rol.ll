...
; CHECK-NEXT:    andd $r11 = $r5, 0xf000f000f000f
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    srlhqs $r3 = $r3, $r11
; CHECK-NEXT:    sllhqs $r4 = $r3, $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    insf $r2 = $r15, 47, 0
