...
; V2:       # %bb.0:
; V2-NEXT:    addd $r12 = $r12, -32
; V2-NEXT:    andd $r2 = $r2, 1
; V2-NEXT:    ;;
; V2-NEXT:    addd $r3 = $r12, 30
; V2-NEXT:    sh 30[$r12] = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sb $r2[$r3] = $r1
; V2-NEXT:    ;;
; V2-NEXT:    lhz $r0 = 30[$r12]
; V2-NEXT:    addd $r12 = $r12, 32
; V2-NEXT:    ret
; V2-NEXT:    ;;
