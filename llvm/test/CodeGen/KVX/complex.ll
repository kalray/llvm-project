...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    muld $r1 = $r3, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    msbfd $r1 = $r2, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    slld $r0 = $r1, 32
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fmuld $r4 = $r0, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmsd $r4 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fmuld $r2 = $r3, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmad $r2 = $r1, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fixedd.rz $r0 = $r2, 0
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulwd $r3 = $r1, $r3
; CHECK-NEXT:    srld $r1 = $r1, 32
; CHECK-NEXT:    ;;
; CHECK-NEXT:    msbfwd $r3 = $r1, $r0
; CHECK-NEXT:    copyd $r0 = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    copyd $r1 = $r3
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    extfs $r3 = $r0, 63, 32
; CHECK-NEXT:    extfs $r1 = $r1, 63, 32
; CHECK-NEXT:    ;;
; CHECK-NEXT:    maddd $r2 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    muld $r1 = $r1, $r4
; CHECK-NEXT:    copyd $r0 = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    msbfd $r1 = $r6, $r3
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    extfs $r1 = $r1, 63, 32
; CHECK-NEXT:    ;;
; CHECK-NEXT:    msbfd $r2 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    muld $r1 = $r1, $r4
; CHECK-NEXT:    copyd $r0 = $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    maddd $r1 = $r6, $r3
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
  %3 = sext <2 x i32> %0 to <2 x i64>
  %4 = sext <2 x i32> %1 to <2 x i64>
