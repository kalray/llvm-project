...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddw $r4 = $r2, 0x3f800000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddw $r6 = $r4, 0x3f800000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddw $r8 = $r6, 0x3f800000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fixedw.rz $r3 = $r1, 0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fixedw.rz $r5 = $r2, 0
; CHECK-NEXT:    sxwd $r3 = $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r3[$r0] = $r1
; CHECK-NEXT:    fixedw.rz $r7 = $r4, 0
; CHECK-NEXT:    sxwd $r5 = $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r5[$r0] = $r2
; CHECK-NEXT:    fixedw.rz $r9 = $r6, 0
; CHECK-NEXT:    sxwd $r7 = $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r7[$r0] = $r4
; CHECK-NEXT:    fixedw.rz $r10 = $r8, 0
; CHECK-NEXT:    sxwd $r3 = $r9
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r3[$r0] = $r6
; CHECK-NEXT:    sxwd $r2 = $r10
; CHECK-NEXT:    faddw $r1 = $r8, 0x3f800000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r2[$r0] = $r8
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddd $r4 = $r2, 0x3ff0000000000000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddd $r6 = $r4, 0x3ff0000000000000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    faddd $r8 = $r6, 0x3ff0000000000000
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    fixedd.rz $r7 = $r4, 0
; CHECK-NEXT:    sxwd $r5 = $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd.xs $r5[$r0] = $r2
; CHECK-NEXT:    fixedd.rz $r9 = $r6, 0
; CHECK-NEXT:    sxwd $r7 = $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd.xs $r7[$r0] = $r4
; CHECK-NEXT:    fixedd.rz $r10 = $r8, 0
; CHECK-NEXT:    sxwd $r3 = $r9
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd.xs $r3[$r0] = $r6
; CHECK-NEXT:    sxwd $r2 = $r10
; CHECK-NEXT:    faddd $r1 = $r8, 0x3ff0000000000000
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd.xs $r2[$r0] = $r8
; CHECK-NEXT:    ;;
