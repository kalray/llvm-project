...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    fmuld $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v4f64_f64:
; V2:       # %bb.0:
; V2-NEXT:    fmuld $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: div_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    addd $r12 = $r12, -64
; V2-NEXT:    get $r16 = $ra
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_def_cfa_offset 64
; V2-NEXT:    .cfi_register 67, 16
; V2-NEXT:    sd 56[$r12] = $r16
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 67, -8
; V2-NEXT:    sd 48[$r12] = $r25
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 25, -16
; V2-NEXT:    so 16[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -24
; V2-NEXT:    .cfi_offset 21, -32
; V2-NEXT:    .cfi_offset 22, -40
; V2-NEXT:    .cfi_offset 23, -48
; V2-NEXT:    sq 0[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r7
; V2-NEXT:    copyd $r19 = $r6
; V2-NEXT:    copyd $r20 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -56
; V2-NEXT:    .cfi_offset 19, -64
; V2-NEXT:    copyd $r21 = $r3
; V2-NEXT:    copyd $r22 = $r2
; V2-NEXT:    copyd $r23 = $r0
; V2-NEXT:    copyd $r0 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r1 = $r5
; V2-NEXT:    call __divdf3
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 67, -8
; V2-NEXT:    sq 40[$r12] = $r24r25
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 24, -16
; V2-NEXT:    .cfi_offset 25, -24
; V2-NEXT:    sd 32[$r12] = $r22
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 22, -32
; V2-NEXT:    sq 16[$r12] = $r20r21
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -40
; V2-NEXT:    .cfi_offset 21, -48
; V2-NEXT:    sq 0[$r12] = $r18r19
...
; V2-NEXT:    lq $r18r19 = 0[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    lq $r20r21 = 16[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r22 = 32[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    lq $r24r25 = 40[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r16 = 56[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    set $ra = $r16
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    fadddp $r2r3 = $r2r3, $r6r7
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r0r1 = $r0r1, $r4r5
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v4f64_f64:
; V2:       # %bb.0:
; V2-NEXT:    copyd $r5 = $r4
; V2-NEXT:    copyd $r6 = $r4
; V2-NEXT:    copyd $r7 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r2r3 = $r6r7, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <4 x double> undef, double %1, i32 0
  %4 = shufflevector <4 x double> %3, <4 x double> undef, <4 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    fsbfdp $r2r3 = $r6r7, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    fsbfdp $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    fmuld $r3 = $r3, $r7
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r0r1 = $r0r1, $r8r9
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r2r3 = $r2r3, $r10r11
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    muld $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    muld $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    muld $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    muld $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = mul <4 x i64> %1, %0
  ret <4 x i64> %3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v4i64_i64:
; V2:       # %bb.0:
; V2-NEXT:    muld $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    muld $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    muld $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    muld $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    addd $r1 = $r5, $r1
; V2-NEXT:    addd $r0 = $r4, $r0
; V2-NEXT:    addd $r2 = $r6, $r2
; V2-NEXT:    addd $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = add <4 x i64> %1, %0
  ret <4 x i64> %3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v4i64_i64:
; V2:       # %bb.0:
; V2-NEXT:    addd $r1 = $r4, $r1
; V2-NEXT:    addd $r0 = $r4, $r0
; V2-NEXT:    addd $r2 = $r4, $r2
; V2-NEXT:    addd $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <4 x i64> undef, i64 %1, i32 0
  %4 = shufflevector <4 x i64> %3, <4 x i64> undef, <4 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    sbfd $r1 = $r5, $r1
; V2-NEXT:    sbfd $r0 = $r4, $r0
; V2-NEXT:    sbfd $r2 = $r6, $r2
; V2-NEXT:    sbfd $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = sub <4 x i64> %0, %1
  ret <4 x i64> %3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v4i64_i64:
; V2:       # %bb.0:
; V2-NEXT:    sbfd $r1 = $r4, $r1
; V2-NEXT:    sbfd $r0 = $r4, $r0
; V2-NEXT:    sbfd $r2 = $r4, $r2
; V2-NEXT:    sbfd $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <4 x i64> undef, i64 %1, i32 0
  %4 = shufflevector <4 x i64> %3, <4 x i64> undef, <4 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_add_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    maddd $r8 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r9 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r10 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r11 = $r7, $r3
; V2-NEXT:    copyd $r0 = $r8
; V2-NEXT:    copyd $r1 = $r9
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_vv8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    fmulwp $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    fmulwp $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    fmulwp $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    fmulwp $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v8f32_f32:
; V2:       # %bb.0:
; V2-NEXT:    copyd $r5 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    insf $r5 = $r5, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r4 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r2r3 = $r4r5, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 26, -16
; V2-NEXT:    sq 64[$r12] = $r24r25
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 24, -24
; V2-NEXT:    .cfi_offset 25, -32
; V2-NEXT:    so 32[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -40
; V2-NEXT:    .cfi_offset 21, -48
; V2-NEXT:    .cfi_offset 22, -56
; V2-NEXT:    .cfi_offset 23, -64
; V2-NEXT:    sq 16[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r7
; V2-NEXT:    copyd $r19 = $r6
; V2-NEXT:    copyd $r20 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -72
; V2-NEXT:    .cfi_offset 19, -80
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    faddwp $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    faddwp $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    faddwp $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    faddwp $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    copyd $r4 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r2r3 = $r4r5, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <8 x float> undef, float %1, i32 0
  %4 = shufflevector <8 x float> %3, <8 x float> undef, <8 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    fsbfwp $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fsbfwp $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fsbfwp $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fsbfwp $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_add_v8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    fmulwq $r2r3 = $r2r3, $r6r7
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r0r1 = $r0r1, $r4r5
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r2r3 = $r2r3, $r10r11
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r0r1 = $r0r1, $r8r9
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v8i32_v8i32:
; V2:       # %bb.0:
; V2-NEXT:    mulwp $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    mulwp $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    mulwp $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    mulwp $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = mul <8 x i32> %1, %0
  ret <8 x i32> %3
...
; V2-NEXT:    copyd $r4 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    mulwq $r2r3 = $r4r5, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    mulwq $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    .cfi_offset 23, -64
; V2-NEXT:    sq 16[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r3
; V2-NEXT:    copyd $r19 = $r2
; V2-NEXT:    copyd $r20 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -72
; V2-NEXT:    .cfi_offset 19, -80
; V2-NEXT:    copyd $r21 = $r0
...
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r25, 63, 32
; V2-NEXT:    insf $r19 = $r24, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    insf $r18 = $r23, 63, 32
; V2-NEXT:    insf $r0 = $r26, 63, 32
; V2-NEXT:    copyd $r1 = $r20
; V2-NEXT:    copyd $r2 = $r19
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v8i32_v8i32:
; V2:       # %bb.0:
; V2-NEXT:    addwp $r0 = $r4, $r0
; V2-NEXT:    addwp $r1 = $r5, $r1
; V2-NEXT:    addwp $r2 = $r6, $r2
; V2-NEXT:    addwp $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = add <8 x i32> %1, %0
  ret <8 x i32> %3
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r4 = $r5
; V2-NEXT:    addwp $r3 = $r5, $r3
; V2-NEXT:    addwp $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    addwp $r2 = $r4, $r2
; V2-NEXT:    addwp $r0 = $r4, $r0
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <8 x i32> undef, i32 %1, i32 0
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r4 = $r5
; V2-NEXT:    sbfwp $r3 = $r5, $r3
; V2-NEXT:    sbfwp $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    sbfwp $r2 = $r4, $r2
; V2-NEXT:    sbfwp $r0 = $r4, $r0
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <8 x i32> undef, i32 %1, i32 0
...
; V2:       # %bb.0:
; V2-NEXT:    maddwp $r8 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r11 = $r7, $r3
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r10 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r9 = $r5, $r1
; V2-NEXT:    copyd $r0 = $r8
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r1 = $r9
; V2-NEXT:    copyd $r2 = $r10
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_vv16f16_v16f16:
; V2:       # %bb.0:
; V2-NEXT:    fmulhq $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r4 = $r4, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    .cfi_offset 24, -16
; V2-NEXT:    .cfi_offset 25, -24
; V2-NEXT:    .cfi_offset 26, -32
; V2-NEXT:    .cfi_offset 27, -40
; V2-NEXT:    so 24[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -48
; V2-NEXT:    .cfi_offset 21, -56
; V2-NEXT:    .cfi_offset 22, -64
; V2-NEXT:    .cfi_offset 23, -72
; V2-NEXT:    sq 8[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r7
; V2-NEXT:    copyd $r21 = $r6
; V2-NEXT:    copyd $r23 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -80
; V2-NEXT:    .cfi_offset 19, -88
; V2-NEXT:    copyd $r20 = $r4
; V2-NEXT:    copyd $r19 = $r3
; V2-NEXT:    copyd $r22 = $r2
; V2-NEXT:    copyd $r24 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r25 = $r0
; V2-NEXT:    srld $r1 = $r20, 48
; V2-NEXT:    ;;
; V2-NEXT:    srld $r0 = $r25, 48
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    srld $r1 = $r20, 32
; V2-NEXT:    fnarrowwh $r26 = $r0
; V2-NEXT:    srld $r0 = $r25, 32
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    call __divsf3
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r26 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r25
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r20
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r20 = $r0
; V2-NEXT:    srld $r0 = $r24, 48
; V2-NEXT:    srld $r1 = $r23, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r26, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r27, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    srld $r1 = $r23, 32
; V2-NEXT:    fnarrowwh $r25 = $r0
; V2-NEXT:    srld $r0 = $r24, 32
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    call __divsf3
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r25 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r24
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r23
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r23 = $r0
; V2-NEXT:    srld $r0 = $r22, 48
; V2-NEXT:    srld $r1 = $r21, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r24 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r22
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r21
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r21 = $r0
; V2-NEXT:    srld $r0 = $r19, 48
; V2-NEXT:    srld $r1 = $r18, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r24, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r25, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    srld $r1 = $r18, 32
; V2-NEXT:    fnarrowwh $r22 = $r0
; V2-NEXT:    srld $r0 = $r19, 32
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    call __divsf3
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r22 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r18
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r3 = $r0
; V2-NEXT:    copyd $r0 = $r20
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r22 = $r0
; V2-NEXT:    srld $r0 = $r21, 48
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    insf $r22 = $r23, 31, 16
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r23 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r21
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r21 = $r0
; V2-NEXT:    srld $r0 = $r20, 48
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    insf $r21 = $r23, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r24, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r23 = $r0
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r23 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r20
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r20 = $r0
; V2-NEXT:    srld $r0 = $r18, 48
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    insf $r20 = $r23, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r24, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r23 = $r0
; V2-NEXT:    srld $r0 = $r18, 32
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    call __divsf3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v16f16_v16f16:
; V2:       # %bb.0:
; V2-NEXT:    faddhq $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    sbmm8 $r4 = $r4, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <16 x half> undef, half %1, i32 0
  %4 = shufflevector <16 x half> %3, <16 x half> undef, <16 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v16f16_v16f16:
; V2:       # %bb.0:
; V2-NEXT:    fsbfhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    fsbfhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fsbfhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <16 x half> undef, half %1, i32 0
  %4 = shufflevector <16 x half> %3, <16 x half> undef, <16 x i32> zeroinitializer
...
; V2-NEXT:    fmulhq $r3 = $r3, $r7
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r0 = $r0, $r8
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r1 = $r1, $r9
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r2 = $r2, $r10
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r3 = $r3, $r11
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    srad $r0 = $r25, 48
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    extfs $r1 = $r20, 47, 32
; V2-NEXT:    copyd $r26 = $r0
; V2-NEXT:    extfs $r0 = $r25, 47, 32
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    call __divdi3
...
; V2-NEXT:    extfs $r0 = $r25, 31, 16
; V2-NEXT:    extfs $r1 = $r20, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v16i16_v16i16:
; V2:       # %bb.0:
; V2-NEXT:    addhq $r0 = $r4, $r0
; V2-NEXT:    addhq $r1 = $r5, $r1
; V2-NEXT:    addhq $r2 = $r6, $r2
; V2-NEXT:    addhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = add <16 x i16> %1, %0
  ret <16 x i16> %3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: add_v16i16_i16:
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r4 = $r4, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    addhq $r0 = $r4, $r0
; V2-NEXT:    addhq $r1 = $r4, $r1
; V2-NEXT:    addhq $r2 = $r4, $r2
; V2-NEXT:    addhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <16 x i16> undef, i16 %1, i32 0
  %4 = shufflevector <16 x i16> %3, <16 x i16> undef, <16 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v16i16_v16i16:
; V2:       # %bb.0:
; V2-NEXT:    sbfhq $r0 = $r4, $r0
; V2-NEXT:    sbfhq $r1 = $r5, $r1
; V2-NEXT:    sbfhq $r2 = $r6, $r2
; V2-NEXT:    sbfhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = sub <16 x i16> %0, %1
  ret <16 x i16> %3
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: sub_v16i16_i16:
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r4 = $r4, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    sbfhq $r0 = $r4, $r0
; V2-NEXT:    sbfhq $r1 = $r4, $r1
; V2-NEXT:    sbfhq $r2 = $r4, $r2
; V2-NEXT:    sbfhq $r3 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = insertelement <16 x i16> undef, i16 %1, i32 0
  %4 = shufflevector <16 x i16> %3, <16 x i16> undef, <16 x i32> zeroinitializer
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_add_v16i16_v16i16:
; V2:       # %bb.0:
; V2-NEXT:    maddhq $r8 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r9 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r10 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r11 = $r7, $r3
; V2-NEXT:    copyd $r0 = $r8
; V2-NEXT:    copyd $r1 = $r9
; V2-NEXT:    copyd $r2 = $r10
; V2-NEXT:    ;;
...
; CHECK-NEXT:    sxmbhq $r10 = $r6
; CHECK-NEXT:    mulhq $r1 = $r4, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r4 = $r6
; CHECK-NEXT:    sxlbhq $r2 = $r2
; CHECK-NEXT:    mulhq $r6 = $r10, $r9
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: mul_v32i8_v32i8:
; V2:       # %bb.0:
; V2-NEXT:    sxmbhq $r8 = $r0
; V2-NEXT:    sxmbhq $r9 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r0 = $r0
; V2-NEXT:    sxlbhq $r4 = $r4
; V2-NEXT:    mulhq $r8 = $r9, $r8
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r9 = $r1
; V2-NEXT:    sxmbhq $r10 = $r5
; V2-NEXT:    mulhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r4 = $r5
; V2-NEXT:    sxlbhq $r1 = $r1
; V2-NEXT:    mulhq $r5 = $r10, $r9
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r9 = $r2
; V2-NEXT:    sxmbhq $r10 = $r6
; V2-NEXT:    mulhq $r1 = $r4, $r1
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r4 = $r6
; V2-NEXT:    sxlbhq $r2 = $r2
; V2-NEXT:    mulhq $r6 = $r10, $r9
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r9 = $r3
; V2-NEXT:    sxmbhq $r10 = $r7
; V2-NEXT:    mulhq $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r4 = $r7
; V2-NEXT:    sxlbhq $r3 = $r3
; V2-NEXT:    mulhq $r7 = $r10, $r9
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r8 = $r8, 0x40100401
; V2-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; V2-NEXT:    mulhq $r3 = $r4, $r3
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r4 = $r5, 0x40100401
; V2-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r5 = $r6, 0x40100401
; V2-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r6 = $r7, 0x40100401
; V2-NEXT:    insf $r0 = $r8, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; V2-NEXT:    insf $r1 = $r4, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    insf $r2 = $r5, 63, 32
; V2-NEXT:    insf $r3 = $r6, 63, 32
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = mul <32 x i8> %1, %0
  ret <32 x i8> %3
...
; V2:       # %bb.0:
; V2-NEXT:    insf $r4 = $r4, 15, 8
; V2-NEXT:    sxmbhq $r5 = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r6 = $r1
; V2-NEXT:    sxmbhq $r7 = $r2
; V2-NEXT:    ;;
; V2-NEXT:    insf $r4 = $r4, 31, 16
; V2-NEXT:    sxmbhq $r8 = $r3
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r0 = $r0
; V2-NEXT:    sxlbhq $r1 = $r1
; V2-NEXT:    ;;
...
; V2-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r5 = $r4, $r5
; V2-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r6 = $r4, $r6
; V2-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r7 = $r4, $r7
; V2-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r8 = $r4, $r8
; V2-NEXT:    sbmm8 $r4 = $r5, 0x40100401
; V2-NEXT:    sbmm8 $r5 = $r6, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r6 = $r7, 0x40100401
; V2-NEXT:    insf $r0 = $r4, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r7 = $r8, 0x40100401
; V2-NEXT:    insf $r1 = $r5, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    insf $r2 = $r6, 63, 32
; V2-NEXT:    insf $r3 = $r7, 63, 32
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 28, -16
; V2-NEXT:    so 48[$r12] = $r24r25r26r27
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 24, -24
; V2-NEXT:    .cfi_offset 25, -32
; V2-NEXT:    .cfi_offset 26, -40
; V2-NEXT:    .cfi_offset 27, -48
; V2-NEXT:    so 16[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -56
; V2-NEXT:    .cfi_offset 21, -64
; V2-NEXT:    .cfi_offset 22, -72
; V2-NEXT:    .cfi_offset 23, -80
; V2-NEXT:    sq 0[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r7
; V2-NEXT:    copyd $r21 = $r6
; V2-NEXT:    copyd $r23 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -88
; V2-NEXT:    .cfi_offset 19, -96
; V2-NEXT:    copyd $r20 = $r4
; V2-NEXT:    copyd $r19 = $r3
; V2-NEXT:    copyd $r22 = $r2
; V2-NEXT:    copyd $r24 = $r1
...
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -32
; V2-NEXT:    .cfi_offset 21, -40
; V2-NEXT:    .cfi_offset 22, -48
; V2-NEXT:    .cfi_offset 23, -56
; V2-NEXT:    sq 24[$r12] = $r18r19
; V2-NEXT:    copyd $r18 = $r3
; V2-NEXT:    copyd $r21 = $r2
; V2-NEXT:    copyd $r22 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -64
; V2-NEXT:    .cfi_offset 19, -72
; V2-NEXT:    copyd $r20 = $r0
; V2-NEXT:    sxbd $r1 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    srld $r0 = $r20, 56
; V2-NEXT:    sxwd $r19 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    copyd $r1 = $r19
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r24 = $r0
; V2-NEXT:    extfz $r0 = $r20, 47, 40
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r24 = $r23, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r23 = $r0
; V2-NEXT:    extfz $r0 = $r20, 39, 32
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r25 = $r0
; V2-NEXT:    srlw $r0 = $r20, 24
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r25 = $r23, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r25 = $r24, 31, 16
; V2-NEXT:    call __divdi3
...
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r20 = $r23, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r20 = $r24, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r25, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r22 = $r0
; V2-NEXT:    srld $r0 = $r21, 56
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r22 = $r23, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r22 = $r24, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r22 = $r25, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r23 = $r0
; V2-NEXT:    extfz $r0 = $r21, 55, 48
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r21 = $r0
; V2-NEXT:    srld $r0 = $r18, 56
; V2-NEXT:    copyd $r1 = $r19
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r21 = $r23, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r21 = $r24, 31, 16
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    andd $r8 = $r0, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r0 = $r4, $r0
; V2-NEXT:    andd $r9 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r4 = $r1, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r1 = $r5, $r1
; V2-NEXT:    andd $r10 = $r5, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r5 = $r2, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r2 = $r6, $r2
; V2-NEXT:    andd $r11 = $r6, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r6 = $r3, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r3 = $r7, $r3
; V2-NEXT:    andd $r7 = $r7, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    addd $r8 = $r9, $r8
; V2-NEXT:    ;;
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    addd $r4 = $r10, $r4
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    addd $r5 = $r11, $r5
; V2-NEXT:    ;;
; V2-NEXT:    andd $r2 = $r2, 0x8080808080808080
; V2-NEXT:    addd $r6 = $r7, $r6
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    xord $r0 = $r8, $r0
; V2-NEXT:    ;;
; V2-NEXT:    xord $r1 = $r4, $r1
; V2-NEXT:    xord $r2 = $r5, $r2
; V2-NEXT:    xord $r3 = $r6, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = add <32 x i8> %1, %0
  ret <32 x i8> %3
...
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r4 = $r4, 0x101010101010101
; V2-NEXT:    andd $r5 = $r0, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r7 = $r1, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r8 = $r2, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r9 = $r3, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r0 = $r4, $r0
; V2-NEXT:    xord $r1 = $r4, $r1
; V2-NEXT:    xord $r2 = $r4, $r2
; V2-NEXT:    ;;
; V2-NEXT:    xord $r3 = $r4, $r3
; V2-NEXT:    andd $r6 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    andd $r2 = $r2, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    addd $r4 = $r6, $r5
; V2-NEXT:    addd $r5 = $r6, $r7
; V2-NEXT:    addd $r7 = $r6, $r8
; V2-NEXT:    ;;
; V2-NEXT:    addd $r6 = $r6, $r9
; V2-NEXT:    xord $r0 = $r4, $r0
; V2-NEXT:    xord $r1 = $r5, $r1
; V2-NEXT:    xord $r2 = $r7, $r2
; V2-NEXT:    ;;
; V2-NEXT:    xord $r3 = $r6, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    ord $r8 = $r0, 0x8080808080808080
; V2-NEXT:    nxord $r0 = $r0, $r4
; V2-NEXT:    andd $r9 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    ord $r4 = $r1, 0x8080808080808080
; V2-NEXT:    nxord $r1 = $r1, $r5
; V2-NEXT:    andd $r10 = $r5, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    ord $r5 = $r2, 0x8080808080808080
; V2-NEXT:    nxord $r2 = $r2, $r6
; V2-NEXT:    andd $r11 = $r6, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    ord $r6 = $r3, 0x8080808080808080
; V2-NEXT:    nxord $r3 = $r3, $r7
; V2-NEXT:    andd $r7 = $r7, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    sbfd $r8 = $r9, $r8
; V2-NEXT:    ;;
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    sbfd $r4 = $r10, $r4
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    sbfd $r5 = $r11, $r5
; V2-NEXT:    ;;
; V2-NEXT:    andd $r2 = $r2, 0x8080808080808080
; V2-NEXT:    sbfd $r6 = $r7, $r6
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    xord $r0 = $r0, $r8
; V2-NEXT:    ;;
; V2-NEXT:    xord $r1 = $r1, $r4
; V2-NEXT:    xord $r2 = $r2, $r5
; V2-NEXT:    xord $r3 = $r3, $r6
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = sub <32 x i8> %0, %1
  ret <32 x i8> %3
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andd $r3 = $r3, 0x8080808080808080
; CHECK-NEXT:    sbfd $r4 = $r6, $r5
; CHECK-NEXT:    sbfd $r5 = $r6, $r7
; CHECK-NEXT:    sbfd $r7 = $r6, $r8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfd $r6 = $r6, $r9
; CHECK-NEXT:    xord $r0 = $r0, $r4
; CHECK-NEXT:    xord $r1 = $r1, $r5
; CHECK-NEXT:    xord $r2 = $r2, $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    xord $r3 = $r3, $r6
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r4 = $r4, 0x101010101010101
; V2-NEXT:    ord $r5 = $r0, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    ord $r7 = $r1, 0x8080808080808080
; V2-NEXT:    ord $r8 = $r2, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    ord $r9 = $r3, 0x8080808080808080
; V2-NEXT:    nxord $r0 = $r0, $r4
; V2-NEXT:    nxord $r1 = $r1, $r4
; V2-NEXT:    nxord $r2 = $r2, $r4
; V2-NEXT:    ;;
; V2-NEXT:    nxord $r3 = $r3, $r4
; V2-NEXT:    andd $r6 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
...
; V2-NEXT:    ;;
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    sbfd $r4 = $r6, $r5
; V2-NEXT:    sbfd $r5 = $r6, $r7
; V2-NEXT:    sbfd $r7 = $r6, $r8
; V2-NEXT:    ;;
; V2-NEXT:    sbfd $r6 = $r6, $r9
; V2-NEXT:    xord $r0 = $r0, $r4
; V2-NEXT:    xord $r1 = $r1, $r5
; V2-NEXT:    xord $r2 = $r2, $r7
; V2-NEXT:    ;;
; V2-NEXT:    xord $r3 = $r3, $r6
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r16 = $r2
; CHECK-NEXT:    sxmbhq $r17 = $r6
; CHECK-NEXT:    mulhq $r3 = $r7, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r7 = $r1
; CHECK-NEXT:    sxmbhq $r32 = $r5
; CHECK-NEXT:    mulhq $r16 = $r17, $r16
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r17 = $r0
; CHECK-NEXT:    sxlbhq $r1 = $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r5 = $r5
; CHECK-NEXT:    mulhq $r7 = $r32, $r7
; CHECK-NEXT:    sxmbhq $r32 = $r4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r0 = $r0
; CHECK-NEXT:    sxlbhq $r4 = $r4
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r0 = $r4, $r0
; CHECK-NEXT:    sbmm8 $r4 = $r15, 0x40100401
; CHECK-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; CHECK-NEXT:    andd $r15 = $r11, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r2 = $r6, $r2
; CHECK-NEXT:    sbmm8 $r6 = $r7, 0x40100401
; CHECK-NEXT:    sbmm8 $r7 = $r16, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r5 = $r32, $r17
; CHECK-NEXT:    sbmm8 $r1 = $r1, 0x40100401
...
; V2-NEXT:    mulhq $r3 = $r7, $r3
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r7 = $r1
; V2-NEXT:    sxmbhq $r32 = $r5
; V2-NEXT:    mulhq $r16 = $r17, $r16
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r17 = $r0
; V2-NEXT:    sxlbhq $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r5 = $r5
; V2-NEXT:    mulhq $r7 = $r32, $r7
; V2-NEXT:    sxmbhq $r32 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r0 = $r0
; V2-NEXT:    sxlbhq $r4 = $r4
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r0 = $r4, $r0
; V2-NEXT:    sbmm8 $r4 = $r15, 0x40100401
; V2-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; V2-NEXT:    andd $r15 = $r11, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r2 = $r6, $r2
; V2-NEXT:    sbmm8 $r6 = $r7, 0x40100401
; V2-NEXT:    sbmm8 $r7 = $r16, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r5 = $r32, $r17
; V2-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; V2-NEXT:    insf $r3 = $r4, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; V2-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; V2-NEXT:    ;;
...
; V2-NEXT:    andd $r6 = $r1, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r1 = $r1, $r9
; V2-NEXT:    andd $r7 = $r9, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    insf $r0 = $r5, 63, 32
; V2-NEXT:    andd $r5 = $r8, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r9 = $r10, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    andd $r4 = $r0, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r0 = $r0, $r8
; V2-NEXT:    ;;
; V2-NEXT:    andd $r8 = $r2, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r2 = $r2, $r10
; V2-NEXT:    andd $r10 = $r3, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r3 = $r3, $r11
; V2-NEXT:    ;;
; V2-NEXT:    addd $r4 = $r4, $r5
; V2-NEXT:    addd $r5 = $r6, $r7
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    addd $r6 = $r8, $r9
; V2-NEXT:    ;;
; V2-NEXT:    andd $r2 = $r2, 0x8080808080808080
; V2-NEXT:    addd $r7 = $r10, $r15
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    xord $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    xord $r1 = $r5, $r1
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v4f64_f64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r1 = $r5, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r0 = $r4, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r2 = $r6, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    so 24[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -16
; V2-NEXT:    .cfi_offset 21, -24
; V2-NEXT:    .cfi_offset 22, -32
; V2-NEXT:    .cfi_offset 23, -40
; V2-NEXT:    sd 16[$r12] = $r18
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -48
; V2-NEXT:    lo $r20r21r22r23 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r18 = 0[$r1]
; V2-NEXT:    copyd $r0 = $r21
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_add_v4f64_f64:
; V2:       # %bb.0:
; V2-NEXT:    ld $r4 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r0]
; V2-NEXT:    copyd $r5 = $r4
; V2-NEXT:    copyd $r6 = $r4
; V2-NEXT:    copyd $r7 = $r4
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_add_v4f64_v4f64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r8r9r10r11 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r1 = $r5, $r9
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r6 = $r6, $r10
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r7 = $r7, $r11
; V2-NEXT:    ;;
; V2-NEXT:    fmuld $r0 = $r4, $r8
; V2-NEXT:    lo $r8r9r10r11 = 0[$r2]
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r6r7 = $r10r11, $r6r7
; V2-NEXT:    ;;
; V2-NEXT:    fadddp $r4r5 = $r8r9, $r0r1
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    muld $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    muld $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    muld $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    muld $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v4i64_i64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    muld $r1 = $r3, $r5
; V2-NEXT:    ;;
; V2-NEXT:    muld $r0 = $r3, $r4
; V2-NEXT:    ;;
; V2-NEXT:    muld $r2 = $r3, $r6
; V2-NEXT:    ;;
; V2-NEXT:    muld $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_add_v4i64_v4i64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    addd $r1 = $r1, $r5
; V2-NEXT:    addd $r0 = $r0, $r4
; V2-NEXT:    addd $r2 = $r2, $r6
; V2-NEXT:    addd $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = load <4 x i64>, <4 x i64>* %0, align 32
  %4 = load <4 x i64>, <4 x i64>* %1, align 32
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_add_v4i64_i64:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    addd $r1 = $r3, $r5
; V2-NEXT:    addd $r0 = $r3, $r4
; V2-NEXT:    addd $r2 = $r3, $r6
; V2-NEXT:    addd $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = load <4 x i64>, <4 x i64>* %0, align 32
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_add_v4i64_v4i64:
; V2:       # %bb.0:
...
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r5 = $r33, $r9
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r4 = $r32, $r8
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r6 = $r34, $r10
; V2-NEXT:    ;;
; V2-NEXT:    maddd $r7 = $r35, $r11
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r2] = $r4r5r6r7
; V2-NEXT:    copyd $r0 = $r4
; V2-NEXT:    copyd $r1 = $r5
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_vv8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r2r3 = $r6r7, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_add_v8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r2r3 = $r6r7, $r2r3
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r0r1 = $r4r5, $r0r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_add_v8f32_v8f32:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r8r9r10r11 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r0r1 = $r6r7, $r10r11
; V2-NEXT:    ;;
; V2-NEXT:    fmulwq $r4r5 = $r4r5, $r8r9
; V2-NEXT:    lo $r8r9r10r11 = 0[$r2]
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r6r7 = $r10r11, $r0r1
; V2-NEXT:    ;;
; V2-NEXT:    faddwq $r4r5 = $r8r9, $r4r5
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r2] = $r4r5r6r7
; V2-NEXT:    copyd $r0 = $r4
; V2-NEXT:    copyd $r1 = $r5
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v8i32_v8i32:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    mulwq $r2r3 = $r2r3, $r6r7
; V2-NEXT:    ;;
; V2-NEXT:    mulwq $r0r1 = $r0r1, $r4r5
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    get $r16 = $ra
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_def_cfa_offset 128
; V2-NEXT:    .cfi_register 67, 16
...
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 28, -16
; V2-NEXT:    .cfi_offset 29, -24
; V2-NEXT:    .cfi_offset 30, -32
; V2-NEXT:    .cfi_offset 31, -40
; V2-NEXT:    so 56[$r12] = $r24r25r26r27
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 24, -48
; V2-NEXT:    .cfi_offset 25, -56
; V2-NEXT:    .cfi_offset 26, -64
; V2-NEXT:    .cfi_offset 27, -72
; V2-NEXT:    so 24[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -80
; V2-NEXT:    .cfi_offset 21, -88
; V2-NEXT:    .cfi_offset 22, -96
; V2-NEXT:    .cfi_offset 23, -104
; V2-NEXT:    sq 8[$r12] = $r18r19
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -112
; V2-NEXT:    .cfi_offset 19, -120
...
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    insf $r24 = $r0, 63, 32
; V2-NEXT:    insf $r22 = $r23, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r21, 63, 32
; V2-NEXT:    insf $r18 = $r19, 63, 32
; V2-NEXT:    copyd $r0 = $r24
; V2-NEXT:    copyd $r1 = $r22
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r2 = $r20
...
; V2-NEXT:    so 40[$r12] = $r20r21r22r23
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -64
; V2-NEXT:    .cfi_offset 21, -72
; V2-NEXT:    .cfi_offset 22, -80
; V2-NEXT:    .cfi_offset 23, -88
; V2-NEXT:    sq 24[$r12] = $r18r19
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -96
; V2-NEXT:    .cfi_offset 19, -104
; V2-NEXT:    lo $r28r29r30r31 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lws $r18 = 0[$r1]
; V2-NEXT:    sxwd $r0 = $r31
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r1 = $r18
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    srld $r1 = $r31, 32
; V2-NEXT:    copyd $r19 = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r1
; V2-NEXT:    copyd $r1 = $r18
...
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    insf $r25 = $r0, 63, 32
; V2-NEXT:    insf $r23 = $r24, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r22, 63, 32
; V2-NEXT:    insf $r19 = $r20, 63, 32
; V2-NEXT:    copyd $r0 = $r25
; V2-NEXT:    copyd $r1 = $r23
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r2 = $r21
...
; V2-NEXT:    copyd $r4 = $r2
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r4]
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r3 = $r35, $r11
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r2 = $r34, $r10
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r1 = $r33, $r9
; V2-NEXT:    ;;
; V2-NEXT:    maddwp $r0 = $r32, $r8
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r4] = $r0r1r2r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    fmulhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    sbmm8 $r3 = $r1, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r0 = $r4, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r1 = $r5, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r2 = $r6, $r3
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r28 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r20
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r24
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r18 = $r0
; V2-NEXT:    srld $r0 = $r21, 48
; V2-NEXT:    srld $r1 = $r25, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r18 = $r28, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r18 = $r19, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
...
; V2-NEXT:    fwidenlhw $r0 = $r21
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r25
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r19 = $r0
; V2-NEXT:    srld $r0 = $r22, 48
; V2-NEXT:    srld $r1 = $r26, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r19 = $r24, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r19 = $r20, 63, 32
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
...
; V2-NEXT:    fwidenlhw $r0 = $r22
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r26
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r20 = $r0
; V2-NEXT:    srld $r0 = $r23, 48
; V2-NEXT:    srld $r1 = $r27, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r0 = $r0
; V2-NEXT:    fwidenlhw $r1 = $r1
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r21 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r23
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r1 = $r27
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
; V2-NEXT:    fnarrowwh $r3 = $r0
...
; V2-NEXT:    srld $r1 = $r20, 48
; V2-NEXT:    ;;
; V2-NEXT:    fwidenlhw $r18 = $r0
; V2-NEXT:    fwidenlhw $r0 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r1 = $r18
; V2-NEXT:    call __divsf3
; V2-NEXT:    ;;
...
; V2-NEXT:    faddhq $r0 = $r4, $r0
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r1 = $r5, $r1
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r2 = $r6, $r2
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = load <16 x half>, <16 x half>* %0, align 32
  %4 = load <16 x half>, <16 x half>* %1, align 32
...
; V2-NEXT:    sbmm8 $r3 = $r1, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r0 = $r4, $r3
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r1 = $r5, $r3
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r2 = $r6, $r3
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r3 = $r7, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    fmulhq $r0 = $r5, $r9
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r1 = $r4, $r8
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r3 = $r6, $r10
; V2-NEXT:    ;;
; V2-NEXT:    fmulhq $r7 = $r7, $r11
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r5 = $r33, $r0
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r4 = $r32, $r1
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r6 = $r34, $r3
; V2-NEXT:    ;;
; V2-NEXT:    faddhq $r7 = $r35, $r7
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r2] = $r4r5r6r7
; V2-NEXT:    copyd $r0 = $r4
; V2-NEXT:    copyd $r1 = $r5
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v16i16_v16i16:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r0 = $r0, $r4
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r1 = $r1, $r5
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r2 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    sbmm8 $r3 = $r1, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r0 = $r3, $r4
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r1 = $r3, $r5
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r2 = $r3, $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V2-NEXT:    .cfi_offset 26, -64
; V2-NEXT:    .cfi_offset 27, -72
; V2-NEXT:    sd 48[$r12] = $r22
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 22, -80
; V2-NEXT:    sq 32[$r12] = $r20r21
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 20, -88
; V2-NEXT:    .cfi_offset 21, -96
; V2-NEXT:    sq 16[$r12] = $r18r19
; V2-NEXT:    ;;
; V2-NEXT:    .cfi_offset 18, -104
; V2-NEXT:    .cfi_offset 19, -112
; V2-NEXT:    lo $r24r25r26r27 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r28r29r30r31 = 0[$r1]
; V2-NEXT:    srad $r0 = $r24, 48
; V2-NEXT:    ;;
; V2-NEXT:    srad $r1 = $r28, 48
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    extfs $r1 = $r28, 47, 32
; V2-NEXT:    copyd $r18 = $r0
; V2-NEXT:    extfs $r0 = $r24, 47, 32
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
...
; V2-NEXT:    copyd $r18 = $r0
; V2-NEXT:    srad $r0 = $r25, 48
; V2-NEXT:    srad $r1 = $r29, 48
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r18 = $r20, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r18 = $r19, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    extfs $r1 = $r29, 47, 32
; V2-NEXT:    copyd $r19 = $r0
; V2-NEXT:    extfs $r0 = $r25, 47, 32
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r21 = $r0
; V2-NEXT:    srad $r0 = $r26, 48
; V2-NEXT:    srad $r1 = $r30, 48
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r19, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r21 = $r20, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    extfs $r1 = $r30, 47, 32
; V2-NEXT:    copyd $r19 = $r0
; V2-NEXT:    extfs $r0 = $r26, 47, 32
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r20 = $r0
; V2-NEXT:    extfs $r0 = $r26, 31, 16
; V2-NEXT:    extfs $r1 = $r30, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r22 = $r0
; V2-NEXT:    srad $r0 = $r27, 48
; V2-NEXT:    srad $r1 = $r31, 48
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
; V2-NEXT:    insf $r22 = $r19, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r22 = $r20, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    extfs $r1 = $r31, 47, 32
; V2-NEXT:    copyd $r19 = $r0
; V2-NEXT:    extfs $r0 = $r27, 47, 32
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r20 = $r0
; V2-NEXT:    extfs $r0 = $r27, 31, 16
; V2-NEXT:    extfs $r1 = $r31, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    sxwd $r1 = $r1
; V2-NEXT:    ;;
...
; V2-NEXT:    copyd $r2 = $r22
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r19, 31, 16
; V2-NEXT:    lq $r18r19 = 16[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r20, 63, 32
; V2-NEXT:    lq $r20r21 = 32[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    ld $r22 = 48[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r24r25r26r27 = 56[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r28r29r30r31 = 88[$r12]
...
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r23 = $r19, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r23 = $r20, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r19 = $r0
; V2-NEXT:    extfs $r0 = $r27, 47, 32
...
; V2-NEXT:    sbmm8 $r3 = $r1, 0x201020102010201
; V2-NEXT:    ;;
; V2-NEXT:    addhq $r0 = $r3, $r4
; V2-NEXT:    addhq $r1 = $r3, $r5
; V2-NEXT:    addhq $r2 = $r3, $r6
; V2-NEXT:    addhq $r3 = $r3, $r7
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = load <16 x i16>, <16 x i16>* %0, align 32
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_add_v16i16_v16i16:
; V2:       # %bb.0:
; V2-NEXT:    lo $r8r9r10r11 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r32r33r34r35 = 0[$r1]
...
; V2-NEXT:    lo $r4r5r6r7 = 0[$r2]
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r5 = $r33, $r9
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r4 = $r32, $r8
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r6 = $r34, $r10
; V2-NEXT:    ;;
; V2-NEXT:    maddhq $r7 = $r35, $r11
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r2] = $r4r5r6r7
; V2-NEXT:    copyd $r0 = $r4
; V2-NEXT:    copyd $r1 = $r5
...
; CHECK-NEXT:    sxmbhq $r10 = $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r7 = $r7
; CHECK-NEXT:    sxlbhq $r3 = $r3
; CHECK-NEXT:    mulhq $r2 = $r2, $r4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r4 = $r10, $r9
; CHECK-NEXT:    sbmm8 $r8 = $r8, 0x40100401
; CHECK-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r3 = $r3, $r7
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v32i8_v32i8:
; V2:       # %bb.0:
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    sxmbhq $r8 = $r4
; V2-NEXT:    sxlbhq $r4 = $r4
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r9 = $r0
; V2-NEXT:    sxlbhq $r0 = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r10 = $r1
; V2-NEXT:    sxlbhq $r1 = $r1
; V2-NEXT:    mulhq $r8 = $r9, $r8
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r9 = $r5
; V2-NEXT:    mulhq $r0 = $r0, $r4
; V2-NEXT:    sxlbhq $r4 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r5 = $r10, $r9
; V2-NEXT:    sxmbhq $r10 = $r2
; V2-NEXT:    sxmbhq $r9 = $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r1 = $r1, $r4
; V2-NEXT:    sxlbhq $r4 = $r6
; V2-NEXT:    sxlbhq $r2 = $r2
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r6 = $r10, $r9
; V2-NEXT:    sxmbhq $r9 = $r7
; V2-NEXT:    sxmbhq $r10 = $r3
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r7 = $r7
; V2-NEXT:    sxlbhq $r3 = $r3
; V2-NEXT:    mulhq $r2 = $r2, $r4
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r4 = $r10, $r9
; V2-NEXT:    sbmm8 $r8 = $r8, 0x40100401
; V2-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r3, $r7
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: p_mul_v32i8_i8:
; V2:       # %bb.0:
; V2-NEXT:    lbz $r1 = 0[$r1]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    insf $r1 = $r1, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r8 = $r7
; V2-NEXT:    sxmbhq $r0 = $r4
; V2-NEXT:    ;;
...
; V2-NEXT:    sxlbhq $r4 = $r5
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r1 = $r1, 0x8000400020001
; V2-NEXT:    sxmbhq $r5 = $r6
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r6 = $r6
; V2-NEXT:    sxlbhq $r7 = $r7
; V2-NEXT:    mulhq $r0 = $r1, $r0
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r1, $r3
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r2 = $r1, $r2
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r4 = $r1, $r4
; V2-NEXT:    sbmm8 $r9 = $r0, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r5 = $r1, $r5
; V2-NEXT:    sbmm8 $r10 = $r3, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r7 = $r1, $r7
; V2-NEXT:    sbmm8 $r0 = $r2, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r6 = $r1, $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r8 = $r1, $r8
; V2-NEXT:    sbmm8 $r1 = $r4, 0x40100401
; V2-NEXT:    sbmm8 $r4 = $r5, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r3 = $r7, 0x40100401
; V2-NEXT:    insf $r0 = $r9, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r2 = $r6, 0x40100401
; V2-NEXT:    insf $r1 = $r10, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r5 = $r8, 0x40100401
...
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r20 = $r21, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r20 = $r22, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r21 = $r0
; V2-NEXT:    extfz $r0 = $r26, 55, 48
...
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r23 = $r21, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r23 = $r22, 31, 16
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r21 = $r0
; V2-NEXT:    extfz $r0 = $r26, 23, 16
...
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r0
; V2-NEXT:    insf $r24 = $r21, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxwd $r0 = $r0
; V2-NEXT:    insf $r24 = $r22, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r24 = $r23, 63, 32
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r21 = $r0
; V2-NEXT:    extfz $r0 = $r27, 55, 48
...
; V2-NEXT:    copyd $r0 = $r19
; V2-NEXT:    copyd $r1 = $r20
; V2-NEXT:    copyd $r2 = $r24
; V2-NEXT:    ;;
; V2-NEXT:    lq $r18r19 = 8[$r12]
; V2-NEXT:    insf $r3 = $r21, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r22, 31, 16
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r23, 63, 32
; V2-NEXT:    lo $r20r21r22r23 = 24[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    lo $r24r25r26r27 = 56[$r12]
; V2-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    lo $r0r1r2r3 = 0[$r1]
; V2-NEXT:    andd $r11 = $r7, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r8 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r9 = $r0, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r0 = $r0, $r4
; V2-NEXT:    andd $r10 = $r1, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r4 = $r5, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r1 = $r1, $r5
; V2-NEXT:    andd $r5 = $r6, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r6 = $r2, $r6
; V2-NEXT:    ;;
; V2-NEXT:    andd $r2 = $r2, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r7 = $r3, $r7
; V2-NEXT:    andd $r3 = $r3, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    addd $r8 = $r9, $r8
; V2-NEXT:    ;;
; V2-NEXT:    andd $r0 = $r0, 0x8080808080808080
; V2-NEXT:    addd $r2 = $r2, $r5
; V2-NEXT:    andd $r5 = $r6, 0x8080808080808080
; V2-NEXT:    addd $r4 = $r10, $r4
; V2-NEXT:    ;;
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    addd $r3 = $r3, $r11
; V2-NEXT:    andd $r6 = $r7, 0x8080808080808080
; V2-NEXT:    xord $r0 = $r8, $r0
; V2-NEXT:    ;;
; V2-NEXT:    xord $r1 = $r4, $r1
; V2-NEXT:    xord $r2 = $r2, $r5
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    lo $r4r5r6r7 = 0[$r0]
; CHECK-NEXT:    sbmm8 $r0 = $r1, 0x101010101010101
; CHECK-NEXT:    ;;
...
; V2-NEXT:    ;;
; V2-NEXT:    lo $r4r5r6r7 = 0[$r0]
; V2-NEXT:    sbmm8 $r0 = $r1, 0x101010101010101
; V2-NEXT:    ;;
; V2-NEXT:    andd $r8 = $r6, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r1 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r9 = $r7, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r3 = $r0, $r4
; V2-NEXT:    xord $r6 = $r0, $r6
; V2-NEXT:    andd $r2 = $r0, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    andd $r4 = $r5, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r5 = $r0, $r5
; V2-NEXT:    xord $r0 = $r0, $r7
; V2-NEXT:    addd $r7 = $r2, $r8
; V2-NEXT:    ;;
; V2-NEXT:    addd $r8 = $r2, $r9
; V2-NEXT:    addd $r1 = $r2, $r1
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    andd $r9 = $r0, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    addd $r4 = $r2, $r4
; V2-NEXT:    andd $r6 = $r6, 0x8080808080808080
; V2-NEXT:    andd $r5 = $r5, 0x8080808080808080
; V2-NEXT:    xord $r0 = $r1, $r3
; V2-NEXT:    ;;
; V2-NEXT:    xord $r1 = $r4, $r5
; V2-NEXT:    xord $r2 = $r7, $r6
; V2-NEXT:    xord $r3 = $r8, $r9
; V2-NEXT:    ret
; V2-NEXT:    ;;
  %3 = load <32 x i8>, <32 x i8>* %0, align 32
  %4 = load i8, i8* %1, align 1
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    lo $r32r33r34r35 = 0[$r2]
; CHECK-NEXT:    sxmbhq $r1 = $r11
; CHECK-NEXT:    sxmbhq $r15 = $r8
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r0 = $r7
; CHECK-NEXT:    sxlbhq $r3 = $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r7 = $r4
; CHECK-NEXT:    sxmbhq $r16 = $r9
; CHECK-NEXT:    mulhq $r0 = $r1, $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxmbhq $r1 = $r5
; CHECK-NEXT:    sxlbhq $r5 = $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r9 = $r9
; CHECK-NEXT:    sxlbhq $r4 = $r4
; CHECK-NEXT:    mulhq $r7 = $r15, $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sxlbhq $r8 = $r8
; CHECK-NEXT:    mulhq $r1 = $r16, $r1
; CHECK-NEXT:    sxmbhq $r15 = $r6
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r5 = $r9, $r5
; CHECK-NEXT:    sxmbhq $r9 = $r10
; CHECK-NEXT:    sxlbhq $r6 = $r6
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r4 = $r8, $r4
; CHECK-NEXT:    sxlbhq $r8 = $r10
; CHECK-NEXT:    sxlbhq $r10 = $r11
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r9 = $r9, $r15
; CHECK-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; CHECK-NEXT:    sbmm8 $r7 = $r7, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r3 = $r10, $r3
; CHECK-NEXT:    sbmm8 $r5 = $r5, 0x40100401
; CHECK-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; CHECK-NEXT:    andd $r10 = $r35, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    ;;
; CHECK-NEXT:    mulhq $r6 = $r8, $r6
; CHECK-NEXT:    sbmm8 $r4 = $r4, 0x40100401
; CHECK-NEXT:    sbmm8 $r8 = $r9, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    insf $r5 = $r1, 63, 32
; CHECK-NEXT:    andd $r9 = $r32, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    insf $r4 = $r7, 63, 32
; CHECK-NEXT:    andd $r7 = $r33, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    sbmm8 $r1 = $r6, 0x40100401
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andd $r6 = $r5, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    xord $r5 = $r33, $r5
; CHECK-NEXT:    insf $r3 = $r0, 63, 32
; CHECK-NEXT:    insf $r1 = $r8, 63, 32
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andd $r8 = $r4, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    addd $r0 = $r7, $r6
; CHECK-NEXT:    andd $r5 = $r5, 0x8080808080808080
; CHECK-NEXT:    xord $r4 = $r32, $r4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addd $r6 = $r9, $r8
; CHECK-NEXT:    andd $r7 = $r1, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    xord $r1 = $r34, $r1
; CHECK-NEXT:    andd $r9 = $r3, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    ;;
; CHECK-NEXT:    xord $r3 = $r35, $r3
; CHECK-NEXT:    andd $r8 = $r34, 0x7f7f7f7f7f7f7f7f
; CHECK-NEXT:    andd $r4 = $r4, 0x8080808080808080
; CHECK-NEXT:    xord $r5 = $r0, $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andd $r1 = $r1, 0x8080808080808080
; CHECK-NEXT:    addd $r0 = $r8, $r7
; CHECK-NEXT:    addd $r7 = $r10, $r9
; CHECK-NEXT:    andd $r3 = $r3, 0x8080808080808080
; CHECK-NEXT:    ;;
; CHECK-NEXT:    xord $r4 = $r6, $r4
; CHECK-NEXT:    xord $r6 = $r0, $r1
; CHECK-NEXT:    xord $r7 = $r7, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    so 0[$r2] = $r4r5r6r7
; CHECK-NEXT:    copyd $r0 = $r4
; CHECK-NEXT:    copyd $r1 = $r5
...
; V2-NEXT:    sxmbhq $r15 = $r8
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r0 = $r7
; V2-NEXT:    sxlbhq $r3 = $r7
; V2-NEXT:    ;;
; V2-NEXT:    sxmbhq $r7 = $r4
; V2-NEXT:    sxmbhq $r16 = $r9
; V2-NEXT:    mulhq $r0 = $r1, $r0
; V2-NEXT:    ;;
...
; V2-NEXT:    sxlbhq $r4 = $r4
; V2-NEXT:    mulhq $r7 = $r15, $r7
; V2-NEXT:    ;;
; V2-NEXT:    sxlbhq $r8 = $r8
; V2-NEXT:    mulhq $r1 = $r16, $r1
; V2-NEXT:    sxmbhq $r15 = $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r5 = $r9, $r5
; V2-NEXT:    sxmbhq $r9 = $r10
; V2-NEXT:    sxlbhq $r6 = $r6
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r4 = $r8, $r4
; V2-NEXT:    sxlbhq $r8 = $r10
; V2-NEXT:    sxlbhq $r10 = $r11
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r9 = $r9, $r15
; V2-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; V2-NEXT:    sbmm8 $r7 = $r7, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r3 = $r10, $r3
; V2-NEXT:    sbmm8 $r5 = $r5, 0x40100401
; V2-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; V2-NEXT:    andd $r10 = $r35, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    mulhq $r6 = $r8, $r6
; V2-NEXT:    sbmm8 $r4 = $r4, 0x40100401
; V2-NEXT:    sbmm8 $r8 = $r9, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    insf $r5 = $r1, 63, 32
; V2-NEXT:    andd $r9 = $r32, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    sbmm8 $r3 = $r3, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    insf $r4 = $r7, 63, 32
; V2-NEXT:    andd $r7 = $r33, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    sbmm8 $r1 = $r6, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    andd $r6 = $r5, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r5 = $r33, $r5
; V2-NEXT:    insf $r3 = $r0, 63, 32
; V2-NEXT:    insf $r1 = $r8, 63, 32
; V2-NEXT:    ;;
; V2-NEXT:    andd $r8 = $r4, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    addd $r0 = $r7, $r6
; V2-NEXT:    andd $r5 = $r5, 0x8080808080808080
; V2-NEXT:    xord $r4 = $r32, $r4
; V2-NEXT:    ;;
; V2-NEXT:    addd $r6 = $r9, $r8
; V2-NEXT:    andd $r7 = $r1, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    xord $r1 = $r34, $r1
; V2-NEXT:    andd $r9 = $r3, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    ;;
; V2-NEXT:    xord $r3 = $r35, $r3
; V2-NEXT:    andd $r8 = $r34, 0x7f7f7f7f7f7f7f7f
; V2-NEXT:    andd $r4 = $r4, 0x8080808080808080
; V2-NEXT:    xord $r5 = $r0, $r5
; V2-NEXT:    ;;
; V2-NEXT:    andd $r1 = $r1, 0x8080808080808080
; V2-NEXT:    addd $r0 = $r8, $r7
; V2-NEXT:    addd $r7 = $r10, $r9
; V2-NEXT:    andd $r3 = $r3, 0x8080808080808080
; V2-NEXT:    ;;
; V2-NEXT:    xord $r4 = $r6, $r4
; V2-NEXT:    xord $r6 = $r0, $r1
; V2-NEXT:    xord $r7 = $r7, $r3
; V2-NEXT:    ;;
; V2-NEXT:    so 0[$r2] = $r4r5r6r7
; V2-NEXT:    copyd $r0 = $r4
; V2-NEXT:    copyd $r1 = $r5
