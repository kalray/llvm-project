...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fwidenlhw $r18 = $r4
; CHECK-NEXT:    fwidenlhw $r19 = $r5
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andw $r19 = $r0, 0
; CHECK-NEXT:    srad $r20 = $r1, 32
; CHECK-NEXT:    srad $r21 = $r0, 32
