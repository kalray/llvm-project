...
%struct.__sFILE.5.34.63.1774.1803.1948 = type { i8*, i32, i32, i16, i16, %struct.__sbuf.0.29.58.1769.1798.1943, i32, i8*, i32 (%struct._reent.13.42.71.1782.1811.1956*, i8*, i8*, i32)*, i32 (%struct._reent.13.42.71.1782.1811.1956*, i8*, i8*, i32)*, i64 (%struct._reent.13.42.71.1782.1811.1956*, i8*, i64, i32)*, i32 (%struct._reent.13.42.71.1782.1811.1956*, i8*)*, %struct.__sbuf.0.29.58.1769.1798.1943, i8*, i32, [3 x i8], [1 x i8], %struct.__sbuf.0.29.58.1769.1798.1943, i32, i64, %struct._reent.13.42.71.1782.1811.1956*, [32 x i8], %struct.__lock.2.31.60.1771.1800.1945, %struct._mbstate_t.4.33.62.1773.1802.1947, i32, [52 x i8] }
%struct.__sbuf.0.29.58.1769.1798.1943 = type { i8*, i32 }
...
%struct.anon.3.8.37.66.1777.1806.1951 = type { [30 x i8*], [30 x i32] }
...
%struct._on_exit_args.10.39.68.1779.1808.1953 = type { [32 x i8*], [32 x i8*], i32, i32 }
...
%struct.LIST_HELP.14.43.72.1783.1812.1957 = type { %struct.LIST_HELP.14.43.72.1783.1812.1957*, i8* }
...
%struct.MEMORY_RESOURCEHELP.19.48.77.1788.1817.1962 = type { i8*, i8*, i8*, i8*, i32, i32, i32 }
%struct.CLAUSE_HELP.21.50.79.1790.1819.1964 = type { i32, i32, i32, i32, i64*, i32, %struct.LIST_HELP.14.43.72.1783.1812.1957*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i32, i32, %struct.LITERAL_HELP.20.49.78.1789.1818.1963**, i32, i32, i32, i32 }
...
%struct.DEF_HELP.28.57.86.1797.1826.1971 = type { %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i8*, i32, i32 }
...
@stack_STACK = external dso_local local_unnamed_addr global [10000 x i8*], align 8
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_EqualityResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32*, i32*) local_unnamed_addr #0
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_EqualityFactoring(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*, i32*) local_unnamed_addr #0

declare dso_local fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_ApplyEqualityFactoring(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, i32, i32, %struct.subst.22.51.80.1791.1820.1965*, i32*, i32*) unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenSuperpositionRight(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32, i32*, i32*) local_unnamed_addr #0
...
declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenLitSPRight(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32*, i32*) unnamed_addr #0

declare dso_local void @clause_Delete(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_MergingParamodulation(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32*, i32*) local_unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_LitMParamod(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32*, i32*) unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_MParamodLitToGiven(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32*, i32*) unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GeneralResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32*, i32*) local_unnamed_addr #0
...
declare dso_local i32 @fprintf(%struct.__sFILE.5.34.63.1774.1803.1948*, i8*, ...) local_unnamed_addr #0

declare dso_local void @misc_ErrorReport(i8*, ...) local_unnamed_addr #0
...
declare dso_local fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_ApplyGenRes(%struct.LITERAL_HELP.20.49.78.1789.1818.1963*, %struct.LITERAL_HELP.20.49.78.1789.1818.1963*, %struct.subst.22.51.80.1791.1820.1965*, %struct.subst.22.51.80.1791.1820.1965*, i32*, i32*) unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_UnitResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_BoundedDepthUnitResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32*, i32*) local_unnamed_addr #0
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GeneralFactoring(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_ApplyGeneralFactoring(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, %struct.subst.22.51.80.1791.1820.1965*, i32*, i32*) unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenSuperpositionLeft(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenLitSPLeft(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32*, i32*) unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_ApplyDefinition(%struct.PROOFSEARCH_HELP.27.56.85.1796.1825.1970*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @def_ApplyDefToClauseOnce(%struct.DEF_HELP.28.57.86.1797.1826.1971*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GeneralHyperResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32*, i32*) local_unnamed_addr #0
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_ForwardSortResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.st.23.52.81.1792.1821.1966*, %struct.SORTTHEORY_HELP.26.55.84.1795.1824.1969*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_ForwardEmptySort(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.st.23.52.81.1792.1821.1966*, %struct.SORTTHEORY_HELP.26.55.84.1795.1824.1969*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_BackwardEmptySort(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.st.23.52.81.1792.1821.1966*, %struct.SORTTHEORY_HELP.26.55.84.1795.1824.1969*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_BackwardSortResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.st.23.52.81.1792.1821.1966*, %struct.SORTTHEORY_HELP.26.55.84.1795.1824.1969*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local void @misc_UserErrorReport(i8*, ...) local_unnamed_addr #0

declare dso_local fastcc void @misc_Error() unnamed_addr #0

declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_URResolution(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32*, i32*) local_unnamed_addr #0

declare dso_local i32 @ord_LiteralCompare(%struct.term.16.45.74.1785.1814.1959*, i32, %struct.term.16.45.74.1785.1814.1959*, i32, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local void @term_Delete(%struct.term.16.45.74.1785.1814.1959*) #0

declare dso_local void @clause_OrientEqualities(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*, i32*) local_unnamed_addr #0

declare dso_local void @clause_Normalize(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*) local_unnamed_addr #0

declare dso_local void @clause_SetMaxLitFlags(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*, i32*) local_unnamed_addr #0

declare dso_local void @clause_UpdateMaxVar(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*) local_unnamed_addr #0

declare dso_local i32 @clause_ComputeWeight(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32*) local_unnamed_addr #0

declare dso_local i8* @memory_Malloc(i32) local_unnamed_addr #0

declare dso_local void @free(i8*) local_unnamed_addr #0

declare dso_local i32 @ord_Compare(%struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, i32*, i32*) local_unnamed_addr #0
...
declare dso_local fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_ApplyGenSuperposition(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, %struct.subst.22.51.80.1791.1820.1965*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, %struct.subst.22.51.80.1791.1820.1965*, %struct.term.16.45.74.1785.1814.1959*, i32, i32, i32, i32*, i32*) unnamed_addr #0
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @list_CopyWithElement(%struct.LIST_HELP.14.43.72.1783.1812.1957*, i8* (i8*)*) local_unnamed_addr #0

declare dso_local void @list_DeleteWithElement(%struct.LIST_HELP.14.43.72.1783.1812.1957*, void (i8*)*) local_unnamed_addr #0
...
declare dso_local fastcc void @clause_SetDataFromParents(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32*, i32*) unnamed_addr #0

define internal fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenSPRightEqToGiven(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964* %0, i32 %1, i32 %2, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967* %3, i32 %4, i32 %5, i32 %6, i32* %7, i32* %8) unnamed_addr #0 {
...
13:                                               ; preds = %9
  ...
  %17 = bitcast i8** %16 to %struct.term.16.45.74.1785.1814.1959**
...
86:                                               ; preds = %85, %84
  %87 = call i32 @ord_Compare(%struct.term.16.45.74.1785.1814.1959* undef, %struct.term.16.45.74.1785.1814.1959* undef, i32* %7, i32* %8) #2
  br label %88
...
101:                                              ; preds = %100, %97
  ...
  %103 = call fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_ApplyGenSuperposition(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964* %34, i32 undef, %struct.subst.22.51.80.1791.1820.1965* undef, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* %0, i32 %1, %struct.subst.22.51.80.1791.1820.1965* undef, %struct.term.16.45.74.1785.1814.1959* %102, i32 1, i32 %4, i32 %5, i32* %7, i32* %8)
  br label %104
...
declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_Lit2MParamod(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.subst.22.51.80.1791.1820.1965*, i32*, i32*) unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_ApplyMParamod(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, i32, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.term.16.45.74.1785.1814.1959*, %struct.subst.22.51.80.1791.1820.1965*, %struct.subst.22.51.80.1791.1820.1965*, i32*, i32*) unnamed_addr #0
...
declare dso_local void @clause_DeleteLiteral(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32*, i32*) local_unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_GenSPLeftEqToGiven(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, i32, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32, i32, i32, i32*, i32*) unnamed_addr #0

declare dso_local void @sharing_PushOnStack(%struct.term.16.45.74.1785.1814.1959*) local_unnamed_addr #0

declare dso_local fastcc %struct.LIST_HELP.14.43.72.1783.1812.1957* @inf_HyperResolvents(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.subst.22.51.80.1791.1820.1965*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i32, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i32, %struct.SHARED_INDEX_NODE.24.53.82.1793.1822.1967*, i32*, i32*) unnamed_addr #0

declare dso_local fastcc %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @inf_BuildHyperResolvent(%struct.CLAUSE_HELP.21.50.79.1790.1819.1964*, %struct.subst.22.51.80.1791.1820.1965*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i32, i32*, i32*) unnamed_addr #0
...
declare dso_local %struct.CLAUSE_HELP.21.50.79.1790.1819.1964* @clause_Create(%struct.LIST_HELP.14.43.72.1783.1812.1957*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, %struct.LIST_HELP.14.43.72.1783.1812.1957*, i32*, i32*) local_unnamed_addr #0
...
declare dso_local %struct.LIST_HELP.14.43.72.1783.1812.1957* @list_PointerDeleteElement(%struct.LIST_HELP.14.43.72.1783.1812.1957*, i8*) local_unnamed_addr #0

declare dso_local void @exit(i32) local_unnamed_addr #0

; Function Attrs: nounwind
declare i64 @fwrite(i8*, i64, i64, %struct.__sFILE.5.34.63.1774.1803.1948*) local_unnamed_addr #2
