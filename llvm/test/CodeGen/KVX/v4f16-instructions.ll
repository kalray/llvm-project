...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cmoved.wnez $r7 ? $r4 = $r8
...
; CHECK-NEXT:    fwidenlwd $r2 = $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    fwidenlwd $r3 = $r4
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
