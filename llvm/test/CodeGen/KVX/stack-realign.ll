...
; CHECK-NEXT:    sbfw $r4 = $r3, $r1
; CHECK-NEXT:    compd.ne $r5 = $r2, 1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r3[$r0] = $r4
; CHECK-NEXT:    cb.even $r5 ? .LBB1_13
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    andd $r0 = $r0, -32
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfd $r8 = $r0, $r12
; CHECK-NEXT:    ;;
; CHECK-NEXT:    copyd $r12 = $r8
; CHECK-NEXT:    cb.wlez $r45 ? .LBB3_13
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.1: # %for.body.preheader
; CHECK-NEXT:    make $r3 = 0
; CHECK-NEXT:    zxwd $r4 = $r45
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addd $r2 = $r4, -1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    andd $r2 = $r4, 7
...
; CHECK-NEXT:    addd $r1 = $r0, 0xfffffffd
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 28[$r6] = $r0
; CHECK-NEXT:    cb.dnez $r1 ? .LBB3_3
; CHECK-NEXT:    addd $r6 = $r6, 32
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.4: # %for.cond.cleanup.loopexit.unr-lcssa.loopexit
; CHECK-NEXT:    negd $r3 = $r3
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.6: # %for.body.epil
; CHECK-NEXT:    sbfw $r4 = $r3, $r45
; CHECK-NEXT:    compd.ne $r5 = $r2, 1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r3[$r8] = $r4
; CHECK-NEXT:    cb.even $r5 ? .LBB3_13
; CHECK-NEXT:    ;;
; CHECK-NEXT:  # %bb.7: # %for.body.epil.1
; CHECK-NEXT:    addd $r0 = $r3, 1
; CHECK-NEXT:    compd.eq $r4 = $r2, 2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sbfw $r1 = $r0, $r45
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw.xs $r0[$r8] = $r1
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sd 192[$r31] = $r0
; CHECK-NEXT:    ;;
; CHECK-NEXT:    make $r2 = g15
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    make $r2 = g45
; CHECK-NEXT:    lwz $r63 = 0[$r2]
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    make $r2 = g57
; CHECK-NEXT:    lwz $r29 = 0[$r2]
; CHECK-NEXT:    ;;
