...
; CV1-NEXT:    sraw $r0 = $r5, 1
; CV1-NEXT:    insf $r2 = $r4, 15, 8
; CV1-NEXT:    sraw $r6 = $r0, 1
...
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    addd $r0 = $r5, $r2
; CV1-NEXT:    andd $r1 = $r1, 0x80808080.@
; CV1-NEXT:    xord $r3 = $r4, $r0
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    xord $r1 = $r0, $r1
; CV1-NEXT:    extfz $r2 = $r3, 55, 48
; CV1-NEXT:    extfz $r4 = $r3, 47, 40
...
; CV1-NEXT:    sxbd $r3 = $r3
; CV1-NEXT:    sraw $r4 = $r4, 1
; CV1-NEXT:    insf $r8 = $r2, 31, 16
; CV1-NEXT:    ;; # (end cycle 10)
; CV1-NEXT:    sraw $r2 = $r3, 1
; CV1-NEXT:    extfz $r3 = $r1, 47, 40
...
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    addd $r0 = $r9, $r4
; CV1-NEXT:    andd $r1 = $r1, 0x80808080.@
; CV1-NEXT:    andd $r4 = $r6, 0x7f7f7f7f.@
; CV1-NEXT:    xord $r5 = $r8, $r0
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    srld $r0 = $r5, 56
; CV1-NEXT:    extfz $r8 = $r5, 55, 48
; CV1-NEXT:    extfz $r9 = $r5, 47, 40
; CV1-NEXT:    xord $r10 = $r0, $r1
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    sxbd $r1 = $r8
...
; CV1-NEXT:    sxbd $r8 = $r9
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    extfz $r0 = $r5, 39, 32
; CV1-NEXT:    insf $r1 = $r0, 15, 8
; CV1-NEXT:    sraw $r4 = $r8, 1
; CV1-NEXT:    srlw $r8 = $r5, 24
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    sxbd $r0 = $r0
...
; CV1-NEXT:    sxbd $r9 = $r9
; CV1-NEXT:    sraw $r11 = $r0, 1
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    sraw $r0 = $r9, 1
; CV1-NEXT:    extfz $r4 = $r5, 23, 16
; CV1-NEXT:    zxbd $r9 = $r10
; CV1-NEXT:    insf $r11 = $r4, 15, 8
; CV1-NEXT:    ;; # (end cycle 9)
; CV1-NEXT:    sxbd $r1 = $r4
; CV1-NEXT:    srlw $r4 = $r10, 24
; CV1-NEXT:    srld $r6 = $r10, 56
; CV1-NEXT:    insf $r11 = $r1, 31, 16
; CV1-NEXT:    ;; # (end cycle 10)
; CV1-NEXT:    extfz $r5 = $r5, 15, 8
; CV1-NEXT:    sxbd $r6 = $r6
; CV1-NEXT:    sraw $r15 = $r1, 1
; CV1-NEXT:    srld $r16 = $r2, 56
; CV1-NEXT:    ;; # (end cycle 11)
; CV1-NEXT:    sxbd $r1 = $r5
; CV1-NEXT:    sraw $r5 = $r6, 1
; CV1-NEXT:    srlw $r6 = $r2, 24
; CV1-NEXT:    insf $r15 = $r8, 15, 8
; CV1-NEXT:    ;; # (end cycle 12)
; CV1-NEXT:    sraw $r1 = $r1, 1
; CV1-NEXT:    sxbd $r8 = $r9
; CV1-NEXT:    extfz $r9 = $r10, 55, 48
; CV1-NEXT:    ;; # (end cycle 13)
; CV1-NEXT:    insf $r0 = $r1, 15, 8
; CV1-NEXT:    sraw $r1 = $r8, 1
; CV1-NEXT:    sxbd $r8 = $r9
; CV1-NEXT:    ;; # (end cycle 14)
; CV1-NEXT:    insf $r0 = $r15, 31, 16
; CV1-NEXT:    sraw $r8 = $r8, 1
; CV1-NEXT:    extfz $r9 = $r10, 47, 40
; CV1-NEXT:    ;; # (end cycle 15)
; CV1-NEXT:    sxbd $r5 = $r9
...
; CV1-NEXT:    sraw $r5 = $r5, 1
; CV1-NEXT:    extfz $r9 = $r10, 39, 32
; CV1-NEXT:    ;; # (end cycle 17)
; CV1-NEXT:    sxbd $r9 = $r9
; CV1-NEXT:    extfz $r11 = $r10, 23, 16
; CV1-NEXT:    ;; # (end cycle 18)
; CV1-NEXT:    sxbd $r4 = $r4
...
; CV1-NEXT:    extfz $r10 = $r10, 15, 8
; CV1-NEXT:    sraw $r11 = $r11, 1
; CV1-NEXT:    ;; # (end cycle 20)
; CV1-NEXT:    sxbd $r5 = $r10
...
; CV1-NEXT:    ;; # (end cycle 23)
; CV1-NEXT:    insf $r1 = $r5, 15, 8
; CV1-NEXT:    sxbd $r5 = $r16
...
; CV1-NEXT:    addd $r10 = $r10, $r8
; CV1-NEXT:    extfz $r11 = $r0, 47, 40
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    xord $r1 = $r10, $r1
; CV1-NEXT:    xord $r2 = $r2, $r6
; CV1-NEXT:    sxbd $r9 = $r9
...
; CV1-NEXT:    andd $r16 = $r2, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 13)
; CV1-NEXT:    sraw $r0 = $r11, 1
; CV1-NEXT:    srld $r5 = $r1, 56
; CV1-NEXT:    insf $r10 = $r5, 15, 8
; CV1-NEXT:    sraw $r17 = $r0, 1
; CV1-NEXT:    ;; # (end cycle 14)
; CV1-NEXT:    insf $r0 = $r17, 15, 8
; CV1-NEXT:    xord $r2 = $r2, $r4
; CV1-NEXT:    extfz $r11 = $r1, 55, 48
; CV1-NEXT:    ;; # (end cycle 15)
; CV1-NEXT:    andd $r2 = $r2, 0x80808080.@
; CV1-NEXT:    sxbd $r5 = $r5
; CV1-NEXT:    insf $r6 = $r9, 31, 16
; CV1-NEXT:    srlw $r9 = $r1, 24
; CV1-NEXT:    ;; # (end cycle 16)
; CV1-NEXT:    insf $r0 = $r10, 31, 16
; CV1-NEXT:    sraw $r5 = $r5, 1
; CV1-NEXT:    sxbd $r10 = $r11
; CV1-NEXT:    addd $r11 = $r16, $r8
; CV1-NEXT:    ;; # (end cycle 17)
; CV1-NEXT:    insf $r0 = $r6, 63, 32
; CV1-NEXT:    xord $r2 = $r11, $r2
...
; CV1-NEXT:    ;; # (end cycle 23)
; CV1-NEXT:    sraw $r1 = $r15, 1
; CV1-NEXT:    sraw $r5 = $r16, 1
; CV1-NEXT:    insf $r6 = $r5, 15, 8
; CV1-NEXT:    sraw $r16 = $r1, 1
; CV1-NEXT:    ;; # (end cycle 24)
; CV1-NEXT:    insf $r1 = $r16, 15, 8
; CV1-NEXT:    insf $r5 = $r9, 15, 8
; CV1-NEXT:    ;; # (end cycle 25)
; CV1-NEXT:    insf $r1 = $r5, 31, 16
; CV1-NEXT:    srld $r5 = $r2, 56
; CV1-NEXT:    insf $r6 = $r10, 31, 16
; CV1-NEXT:    ;; # (end cycle 26)
...
; CV1-NEXT:    andd $r5 = $r7, 0x80808080.@
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    andd $r0 = $r0, 0xff00ff00.@
; CV1-NEXT:    xord $r3 = $r3, $r5
; CV1-NEXT:    andd $r8 = $r0, 0xff00ff.@
; CV1-NEXT:    andd $r9 = $r1, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    andd $r1 = $r1, 0xff00ff00.@
...
; CV1-NEXT:    srld $r8 = $r8, 1
; CV1-NEXT:    srld $r9 = $r9, 1
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    srld $r1 = $r1, 1
; CV1-NEXT:    srld $r2 = $r2, 1
...
; CV1-NEXT:    andd $r10 = $r0, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    andd $r0 = $r0, 0x80808080.@
; CV1-NEXT:    xord $r1 = $r8, $r1
; CV1-NEXT:    andd $r8 = $r2, 0x7f7f7f7f.@
; CV1-NEXT:    addd $r10 = $r10, $r9
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    xord $r0 = $r10, $r0
; CV1-NEXT:    xord $r2 = $r2, $r6
; CV1-NEXT:    addd $r5 = $r8, $r5
; CV1-NEXT:    andd $r10 = $r1, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    xord $r1 = $r1, $r4
; CV1-NEXT:    andd $r2 = $r2, 0x80808080.@
...
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    sxbd $r7 = $r7
; CV1-NEXT:    sraw $r8 = $r9, 1
; CV1-NEXT:    ;; # (end cycle 15)
; CV1-NEXT:    sxbd $r1 = $r1
; CV1-NEXT:    sxbd $r6 = $r6
; CV1-NEXT:    sraw $r7 = $r7, 1
; CV1-NEXT:    sraw $r9 = $r0, 1
; CV1-NEXT:    ;; # (end cycle 16)
; CV1-NEXT:    sraw $r0 = $r10, 1
; CV1-NEXT:    sraw $r1 = $r1, 1
; CV1-NEXT:    sraw $r6 = $r6, 1
; CV1-NEXT:    insf $r7 = $r8, 15, 8
; CV1-NEXT:    ;; # (end cycle 17)
...
; CV1-NEXT:    xord $r6 = $r6, $r0
; CV1-NEXT:    sxbd $r7 = $r7
; CV1-NEXT:    srlw $r15 = $r1, 24
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    sraw $r7 = $r7, 1
; CV1-NEXT:    extfz $r8 = $r6, 55, 48
; CV1-NEXT:    srld $r9 = $r6, 56
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    srlw $r0 = $r6, 24
; CV1-NEXT:    sxbd $r8 = $r8
; CV1-NEXT:    sxbd $r9 = $r9
; CV1-NEXT:    sraw $r10 = $r0, 1
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    sxbd $r4 = $r4
; CV1-NEXT:    sraw $r5 = $r9, 1
; CV1-NEXT:    insf $r7 = $r5, 15, 8
; CV1-NEXT:    sraw $r8 = $r8, 1
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    sraw $r4 = $r4, 1
; CV1-NEXT:    extfz $r5 = $r6, 47, 40
; CV1-NEXT:    insf $r8 = $r5, 15, 8
; CV1-NEXT:    zxbd $r32 = $r1
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    sxbd $r11 = $r11
; CV1-NEXT:    extfz $r16 = $r6, 39, 32
; CV1-NEXT:    srld $r33 = $r2, 56
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    sxbd $r5 = $r5
; CV1-NEXT:    sraw $r11 = $r11, 1
...
; CV1-NEXT:    sxbd $r1 = $r1
; CV1-NEXT:    ;; # (end cycle 15)
; CV1-NEXT:    sxbd $r1 = $r32
; CV1-NEXT:    sraw $r4 = $r1, 1
...
; CV1-NEXT:    andd $r1 = $r1, 0x80808080.@
; CV1-NEXT:    xord $r2 = $r3, $r0
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    xord $r1 = $r0, $r1
; CV1-NEXT:    extfz $r3 = $r2, 55, 48
...
; CV1-NEXT:    andd $r5 = $r0, 0x7f7f7f7f.@
; CV1-NEXT:    make $r6 = 0x101010101010101
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    xord $r0 = $r0, $r4
; CV1-NEXT:    andd $r4 = $r6, 0x7f7f7f7f.@
; CV1-NEXT:    andd $r7 = $r4, 0x7f7f7f7f.@
; CV1-NEXT:    andd $r8 = $r1, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    andd $r0 = $r0, 0x80808080.@
; CV1-NEXT:    xord $r1 = $r1, $r6
; CV1-NEXT:    addd $r5 = $r5, $r7
; CV1-NEXT:    addd $r7 = $r8, $r4
; CV1-NEXT:    ;; # (end cycle 2)
...
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    sraw $r5 = $r5, 1
; CV1-NEXT:    xord $r6 = $r3, $r6
; CV1-NEXT:    extfz $r8 = $r0, 55, 48
; CV1-NEXT:    srlw $r11 = $r0, 24
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    andd $r3 = $r6, 0x80808080.@
...
; CV1-NEXT:    ;; # (end cycle 11)
; CV1-NEXT:    sraw $r0 = $r0, 1
; CV1-NEXT:    insf $r8 = $r9, 15, 8
; CV1-NEXT:    sraw $r9 = $r11, 1
; CV1-NEXT:    extfz $r10 = $r1, 55, 48
; CV1-NEXT:    ;; # (end cycle 12)
...
; CV1-NEXT:    ;; # (end cycle 16)
; CV1-NEXT:    sraw $r5 = $r5, 1
; CV1-NEXT:    sxbd $r7 = $r11
; CV1-NEXT:    sxbd $r10 = $r10
; CV1-NEXT:    srld $r11 = $r2, 56
; CV1-NEXT:    ;; # (end cycle 17)
; CV1-NEXT:    sxbd $r6 = $r6
; CV1-NEXT:    sraw $r7 = $r7, 1
; CV1-NEXT:    sraw $r8 = $r10, 1
...
; CV1-NEXT:    ;; # (end cycle 22)
; CV1-NEXT:    insf $r5 = $r7, 15, 8
; CV1-NEXT:    sxbd $r8 = $r10
; CV1-NEXT:    sraw $r9 = $r1, 1
; CV1-NEXT:    ;; # (end cycle 23)
; CV1-NEXT:    sraw $r1 = $r8, 1
; CV1-NEXT:    sxbd $r7 = $r11
; CV1-NEXT:    extfz $r8 = $r2, 47, 40
...
; CV1-NEXT:    xord $r0 = $r0, $r4
; CV1-NEXT:    andd $r4 = $r4, 0x7f7f7f7f.@
; CV1-NEXT:    andd $r7 = $r6, 0x7f7f7f7f.@
; CV1-NEXT:    andd $r8 = $r1, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    andd $r0 = $r0, 0x80808080.@
; CV1-NEXT:    xord $r1 = $r1, $r6
...
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    andd $r1 = $r1, 0x80808080.@
; CV1-NEXT:    addd $r4 = $r4, $r7
; CV1-NEXT:    addd $r5 = $r8, $r7
; CV1-NEXT:    addd $r7 = $r9, $r7
; CV1-NEXT:    ;; # (end cycle 4)
...
; CV1-NEXT:    xord $r2 = $r4, $r2
; CV1-NEXT:    xord $r3 = $r7, $r3
; CV1-NEXT:    srld $r5 = $r8, 1
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    andd $r1 = $r1, 0xff00ff00.@
; CV1-NEXT:    andd $r2 = $r2, 0xff00ff00.@
; CV1-NEXT:    andd $r4 = $r2, 0xff00ff.@
; CV1-NEXT:    andd $r8 = $r1, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    srld $r0 = $r0, 1
; CV1-NEXT:    andd $r3 = $r3, 0xff00ff00.@
; CV1-NEXT:    srld $r6 = $r8, 1
; CV1-NEXT:    andd $r7 = $r3, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    srld $r1 = $r1, 1
; CV1-NEXT:    srld $r2 = $r2, 1
