...
; V1-NEXT:    compnhq.ltu $r9 = $r4, $r11
; V1-NEXT:    andd $r10 = $r6, 0xff00ff00.@
; V1-NEXT:    andd $r11 = $r2, 0xff00ff00.@
; V1-NEXT:    ;; # (end cycle 4)
; V1-NEXT:    ord $r1 = $r1, $r5
; V1-NEXT:    sllhqs $r2 = $r2, 8
; V1-NEXT:    addhq $r5 = $r11, $r10
; V1-NEXT:    sllhqs $r6 = $r6, 8
; V1-NEXT:    ;; # (end cycle 5)
; V1-NEXT:    ord $r4 = $r9, $r4
; V1-NEXT:    addhq $r6 = $r2, $r6
; V1-NEXT:    compnhq.ltu $r9 = $r5, $r11
