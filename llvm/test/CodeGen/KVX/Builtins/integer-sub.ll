...
; V1-NEXT:    sbmm8 $r9 = $r5, 0x4000200004000100
; V1-NEXT:    ;; # (end cycle 1)
; V1-NEXT:    sbfshq $r0 = $r0, $r4
; V1-NEXT:    sbmm8 $r1 = $r1, 0x4000200004000100
; V1-NEXT:    andd $r4 = $r1, 0xff00ff00.@
; V1-NEXT:    andd $r10 = $r6, 0xff00ff00.@
; V1-NEXT:    ;; # (end cycle 2)
; V1-NEXT:    andd $r0 = $r0, 0xff00ff00.@
; V1-NEXT:    sbfshq $r4 = $r4, $r5
; V1-NEXT:    andd $r5 = $r2, 0xff00ff00.@
; V1-NEXT:    sbmm8 $r6 = $r6, 0x4000200004000100
; V1-NEXT:    ;; # (end cycle 3)
; V1-NEXT:    sbfshq $r1 = $r1, $r9
; V1-NEXT:    sbmm8 $r2 = $r2, 0x4000200004000100
; V1-NEXT:    andd $r4 = $r4, 0xff00ff00.@
...
; V1-NEXT:    ord $r1 = $r4, $r1
; V1-NEXT:    srlhqs $r2 = $r2, 8
; V1-NEXT:    srlhqs $r3 = $r3, 8
; V1-NEXT:    ;; # (end cycle 9)
; V1-NEXT:    ord $r2 = $r5, $r2
...
; V1-NEXT:    compnhq.leu $r9 = $r4, $r10
; V1-NEXT:    andd $r10 = $r6, 0xff00ff00.@
; V1-NEXT:    andd $r11 = $r2, 0xff00ff00.@
; V1-NEXT:    ;; # (end cycle 4)
; V1-NEXT:    andd $r1 = $r5, $r1
; V1-NEXT:    sllhqs $r2 = $r2, 8
; V1-NEXT:    sbfhq $r5 = $r11, $r10
; V1-NEXT:    sllhqs $r6 = $r6, 8
; V1-NEXT:    ;; # (end cycle 5)
; V1-NEXT:    sbfhq $r2 = $r2, $r6
; V1-NEXT:    andd $r4 = $r9, $r4
; V1-NEXT:    compnhq.leu $r9 = $r5, $r10
...
; V1-NEXT:    andd $r5 = $r9, $r5
; V1-NEXT:    sbfhq $r6 = $r11, $r10
; V1-NEXT:    ;; # (end cycle 8)
; V1-NEXT:    srlhqs $r0 = $r0, 8
; V1-NEXT:    compnhq.leu $r7 = $r3, $r7
; V1-NEXT:    andd $r8 = $r8, 0xff00ff00.@
; V1-NEXT:    compnhq.leu $r9 = $r6, $r10
; V1-NEXT:    ;; # (end cycle 9)
; V1-NEXT:    srlhqs $r1 = $r1, 8
