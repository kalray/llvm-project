...
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    abdhq $r0 = $r1, $r0
; CV1-NEXT:    abdhq $r2 = $r3, $r2
; CV1-NEXT:    ;; # (end cycle 2)
...
; CV1-NEXT:    make $r2 = 0x4000300020001
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    abdhq $r1 = $r2, $r1
; CV1-NEXT:    abshq $r2 = $r0
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    sbmm8 $r0 = $r1, 0x40100401
; CV1-NEXT:    sbmm8 $r1 = $r2, 0x40100401
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    insf $r0 = $r1, 63, 32
; CV1-NEXT:    ret
...
; CV1-NEXT:    sbmm8 $r1 = $r0, 0x8000400020001
; CV1-NEXT:    make $r2 = 0x4000300020001
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    abdhq $r1 = $r2, $r1
; CV1-NEXT:    ;; # (end cycle 1)
...
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; CV1-NEXT:    sbmm8 $r5 = $r8, 0x40100401
; CV1-NEXT:    ;; # (end cycle 7)
...
; CV1:       # %bb.0:
; CV1-NEXT:    sbmm8 $r8 = $r0, 0x80004000200010
...
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    sbmm8 $r4 = $r8, 0x40100401
; CV1-NEXT:    sbmm8 $r8 = $r1, 0x80004000200010
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sbmm8 $r1 = $r1, 0x8000400020001
...
; CV1-NEXT:    abdhq $r4 = $r5, $r4
; CV1-NEXT:    ;; # (end cycle 11)
; CV1-NEXT:    sbmm8 $r5 = $r3, 0x80004000200010
...
; CV2:       # %bb.0:
; CV2-NEXT:    abdubo $r0 = $r0, $r4
; CV2-NEXT:    abdubo $r1 = $r1, $r5
; CV2-NEXT:    abdubo $r2 = $r2, $r6
; CV2-NEXT:    abdubo $r3 = $r3, $r7
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <32 x i8> %0, <32 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <32 x i8> %1, <32 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; CV1-NEXT:    make $r5 = 0x4000300020001
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    sxlbhq $r1 = $r1
; CV1-NEXT:    sxmbhq $r6 = $r1
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    abdhq $r0 = $r5, $r0
; CV1-NEXT:    abdhq $r4 = $r5, $r4
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    abdhq $r1 = $r5, $r1
; CV1-NEXT:    abdhq $r6 = $r5, $r6
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; CV1-NEXT:    sbmm8 $r4 = $r4, 0x40100401
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; CV1-NEXT:    sbmm8 $r6 = $r6, 0x40100401
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    insf $r0 = $r4, 63, 32
...
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    abdhq $r2 = $r5, $r2
; CV1-NEXT:    abdhq $r4 = $r5, $r4
; CV1-NEXT:    ;; # (end cycle 9)
; CV1-NEXT:    abdhq $r3 = $r5, $r3
; CV1-NEXT:    abdhq $r6 = $r5, $r6
; CV1-NEXT:    ;; # (end cycle 10)
; CV1-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; CV1-NEXT:    sbmm8 $r4 = $r4, 0x40100401
...
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    sbmm8 $r2 = $r2, 0x8000400020001
; CV1-NEXT:    sbmm8 $r6 = $r3, 0x80004000200010
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    sbmm8 $r3 = $r3, 0x8000400020001
; CV1-NEXT:    abdhq $r4 = $r5, $r4
; CV1-NEXT:    ;; # (end cycle 9)
...
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    sbmm8 $r2 = $r4, 0x40100401
; CV1-NEXT:    sbmm8 $r4 = $r1, 0x80004000200010
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sbmm8 $r1 = $r1, 0x8000400020001
; CV1-NEXT:    sbmm8 $r5 = $r3, 0x80004000200010
; CV1-NEXT:    ;; # (end cycle 4)
...
; CV2:       # %bb.0:
; CV2-NEXT:    abdubo $r0 = $r0, $r2
; CV2-NEXT:    abdubo $r1 = $r1, $r3
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <16 x i8> %0, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <16 x i8> %1, <16 x i8> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
; CV1-NEXT:    sxlbhq $r0 = $r0
; CV1-NEXT:    sxmbhq $r2 = $r0
; CV1-NEXT:    make $r3 = 0x4000300020001
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    sxlbhq $r1 = $r1
; CV1-NEXT:    sxmbhq $r4 = $r1
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    abdhq $r0 = $r3, $r0
; CV1-NEXT:    abdhq $r2 = $r3, $r2
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    abdhq $r1 = $r3, $r1
; CV1-NEXT:    abdhq $r4 = $r3, $r4
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; CV1-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; CV1-NEXT:    ;; # (end cycle 4)
...
; ALL-LABEL: abddp_rr_:
; ALL:       # %bb.0:
; ALL-NEXT:    abdd $r0 = $r0, $r2
; ALL-NEXT:    abdd $r1 = $r1, $r3
; ALL-NEXT:    ret
; ALL-NEXT:    ;; # (end cycle 0)
...
; CV2:       # %bb.0:
; CV2-NEXT:    abdud $r0 = $r0, $r2
; CV2-NEXT:    abdud $r1 = $r1, $r3
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = extractelement <2 x i64> %0, i64 0
  %4 = extractelement <2 x i64> %1, i64 0
...
; CV2:       # %bb.0:
; CV2-NEXT:    abdud $r0 = $r0, $r4
; CV2-NEXT:    abdud $r1 = $r1, $r5
; CV2-NEXT:    abdud $r2 = $r2, $r6
; CV2-NEXT:    abdud $r3 = $r3, $r7
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = extractelement <4 x i64> %0, i64 0
  %4 = extractelement <4 x i64> %1, i64 0
...
; CV2:       # %bb.0:
; CV2-NEXT:    abduhq $r0 = $r0, $r2
; CV2-NEXT:    abduhq $r1 = $r1, $r3
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <8 x i16> %0, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %4 = shufflevector <8 x i16> %1, <8 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CV2:       # %bb.0:
; CV2-NEXT:    abduhq $r0 = $r0, $r4
; CV2-NEXT:    abduhq $r1 = $r1, $r5
; CV2-NEXT:    abduhq $r2 = $r2, $r6
; CV2-NEXT:    abduhq $r3 = $r3, $r7
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <16 x i16> %0, <16 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %4 = shufflevector <16 x i16> %1, <16 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CV2-NEXT:    ;; # (end cycle 0)
; CV2-NEXT:    abduhq $r0 = $r0, $r4
; CV2-NEXT:    abduhq $r1 = $r1, $r4
; CV2-NEXT:    abduhq $r2 = $r2, $r4
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 1)
  %2 = shufflevector <16 x i16> %0, <16 x i16> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CV2:       # %bb.0:
; CV2-NEXT:    abduwp $r0 = $r0, $r4
; CV2-NEXT:    abduwp $r1 = $r1, $r5
; CV2-NEXT:    abduwp $r2 = $r2, $r6
; CV2-NEXT:    abduwp $r3 = $r3, $r7
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <8 x i32> %0, <8 x i32> undef, <2 x i32> <i32 0, i32 1>
  %4 = shufflevector <8 x i32> %1, <8 x i32> undef, <2 x i32> <i32 0, i32 1>
...
; CV2:       # %bb.0:
; CV2-NEXT:    abduwp $r0 = $r0, $r2
; CV2-NEXT:    abduwp $r1 = $r1, $r3
; CV2-NEXT:    ret
; CV2-NEXT:    ;; # (end cycle 0)
  %3 = shufflevector <4 x i32> %0, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
  %4 = shufflevector <4 x i32> %1, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
