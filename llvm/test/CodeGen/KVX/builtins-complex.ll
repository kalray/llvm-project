...
; RUN: llc -mcpu=kv3-1 < %s -O2 | FileCheck %s --check-prefixes=CHECK,KVCV1
; RUN: llc -mcpu=kv3-2 < %s -O2 | FileCheck %s --check-prefixes=CHECK,KVCV2
...
; KVCV1-LABEL: fmulwcp:
; KVCV1:       # %bb.0: # %entry
; KVCV1-NEXT:    fmulwc.rn $r1 = $r1, $r3
; KVCV1-NEXT:    ;;
; KVCV1-NEXT:    fmulwc.rn $r0 = $r0, $r2
; KVCV1-NEXT:    ret
; KVCV1-NEXT:    ;;
;
; KVCV2-LABEL: fmulwcp:
; KVCV2:       # %bb.0: # %entry
; KVCV2-NEXT:    fmulwcp.rn $r0r1 = $r0r1, $r2r3
; KVCV2-NEXT:    ret
; KVCV2-NEXT:    ;;
entry:
...
; KVCV1-LABEL: fmulwcq:
; KVCV1:       # %bb.0: # %entry
; KVCV1-NEXT:    fmulwc.rn $r1 = $r1, $r5
; KVCV1-NEXT:    ;;
; KVCV1-NEXT:    fmulwc.rn $r0 = $r0, $r4
; KVCV1-NEXT:    ;;
; KVCV1-NEXT:    fmulwc.rn $r3 = $r3, $r7
; KVCV1-NEXT:    ;;
; KVCV1-NEXT:    fmulwc.rn $r2 = $r2, $r6
; KVCV1-NEXT:    ret
; KVCV1-NEXT:    ;;
;
; KVCV2-LABEL: fmulwcq:
; KVCV2:       # %bb.0: # %entry
; KVCV2-NEXT:    fmulwcp.rn $r0r1 = $r0r1, $r4r5
; KVCV2-NEXT:    ;;
; KVCV2-NEXT:    fmulwcp.rn $r2r3 = $r2r3, $r6r7
; KVCV2-NEXT:    ret
; KVCV2-NEXT:    ;;
entry:
