...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <4 x i16> @llvm.kvx.stsuhq(<4 x i16> %v, <4 x i16> %a)
  ret <4 x i16> %0
}

declare <4 x i16> @llvm.kvx.stsuhq(<4 x i16>, <4 x i16>)
...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <4 x i16> @llvm.kvx.stsuhq(<4 x i16> %v, <4 x i16> <i16 15, i16 12, i16 0, i16 0>)
  ret <4 x i16> %0
}
...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <4 x i16> @llvm.kvx.stsuhq(<4 x i16> %v, <4 x i16> <i16 15, i16 12, i16 15, i16 12>)
  ret <4 x i16> %0
}
...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <2 x i32> @llvm.kvx.stsuwp(<2 x i32> %v, <2 x i32> %a)
  ret <2 x i32> %0
}

declare <2 x i32> @llvm.kvx.stsuwp(<2 x i32>, <2 x i32>)
...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <2 x i32> @llvm.kvx.stsuwp(<2 x i32> %v, <2 x i32> <i32 999, i32 0>)
  ret <2 x i32> %0
}
...
; CHECK-NEXT:    ;;
entry:
  %0 = tail call <2 x i32> @llvm.kvx.stsuwp(<2 x i32> %v, <2 x i32> <i32 999, i32 999>)
  ret <2 x i32> %0
}
