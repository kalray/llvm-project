...
; ALL-LABEL: test_fma:
; ALL:       # %bb.0:
; ALL-NEXT:    sxmbhq $r3 = $r2
; ALL-NEXT:    sxmbhq $r4 = $r1
; ALL-NEXT:    ;;
; ALL-NEXT:    sxlbhq $r2 = $r2
; ALL-NEXT:    sxlbhq $r1 = $r1
; ALL-NEXT:    mulhq $r3 = $r4, $r3
; ALL-NEXT:    ;;
; ALL-NEXT:    mulhq $r1 = $r1, $r2
; ALL-NEXT:    sbmm8 $r2 = $r3, 0x40100401
; ALL-NEXT:    andd $r3 = $r0, 0x7f7f7f7f7f7f7f7f
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; ALL-NEXT:    ;;
; ALL-NEXT:    insf $r1 = $r2, 63, 32
; ALL-NEXT:    ;;
; ALL-NEXT:    xord $r0 = $r0, $r1
; ALL-NEXT:    andd $r2 = $r1, 0x7f7f7f7f7f7f7f7f
; ALL-NEXT:    ;;
; ALL-NEXT:    addd $r1 = $r3, $r2
; ALL-NEXT:    andd $r0 = $r0, 0x8080808080808080
; ALL-NEXT:    ;;
; ALL-NEXT:    xord $r0 = $r1, $r0
; ALL-NEXT:    ret
; ALL-NEXT:    ;;
  %m = mul <8 x i8> %b, %c
  %ad = add <8 x i8> %a, %m
...
; ALL-NEXT:    make $r3 = 0x3000100020007
; ALL-NEXT:    sxlbhq $r1 = $r1
; ALL-NEXT:    ;;
; ALL-NEXT:    mulhq $r2 = $r2, $r3
; ALL-NEXT:    ;;
; ALL-NEXT:    mulhq $r1 = $r1, $r3
; ALL-NEXT:    andd $r3 = $r0, 0x7f7f7f7f7f7f7f7f
; ALL-NEXT:    sbmm8 $r2 = $r2, 0x40100401
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; ALL-NEXT:    ;;
; ALL-NEXT:    insf $r1 = $r2, 63, 32
...
; ALL:       # %bb.0:
; ALL-NEXT:    sxmbhq $r2 = $r1
; ALL-NEXT:    make $r3 = 0x2000100020001
; ALL-NEXT:    sxlbhq $r1 = $r1
; ALL-NEXT:    ;;
; ALL-NEXT:    mulhq $r2 = $r2, $r3
; ALL-NEXT:    ;;
...
; ALL-LABEL: test_sub:
; ALL:       # %bb.0:
; ALL-NEXT:    ord $r2 = $r0, 0x8080808080808080
; ALL-NEXT:    nxord $r0 = $r0, $r1
; ALL-NEXT:    andd $r3 = $r1, 0x7f7f7f7f7f7f7f7f
; ALL-NEXT:    ;;
; ALL-NEXT:    sbfd $r1 = $r3, $r2
; ALL-NEXT:    andd $r0 = $r0, 0x8080808080808080
; ALL-NEXT:    ;;
; ALL-NEXT:    xord $r0 = $r0, $r1
; ALL-NEXT:    ret
...
; ALL-NEXT:    andd $r3 = $r0, 0x7f7f7f7f7f7f7f7f
; ALL-NEXT:    ;;
; ALL-NEXT:    nxord $r0 = $r1, $r0
; ALL-NEXT:    ord $r2 = $r1, 0x8080808080808080
; ALL-NEXT:    ;;
; ALL-NEXT:    sbfd $r1 = $r3, $r2
; ALL-NEXT:    andd $r0 = $r0, 0x8080808080808080
; ALL-NEXT:    ;;
...
; ALL:       # %bb.0:
; ALL-NEXT:    sxlbhq $r4 = $r3
; ALL-NEXT:    sxlbhq $r5 = $r2
; ALL-NEXT:    ;;
; ALL-NEXT:    sxmbhq $r3 = $r3
; ALL-NEXT:    sxmbhq $r2 = $r2
; ALL-NEXT:    compnhq.lt $r4 = $r5, $r4
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r5 = $r1, 0x80004000200010
; ALL-NEXT:    sbmm8 $r1 = $r1, 0x8000400020001
; ALL-NEXT:    compnhq.lt $r2 = $r2, $r3
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r3 = $r0, 0x80004000200010
; ALL-NEXT:    sbmm8 $r0 = $r0, 0x8000400020001
; ALL-NEXT:    ;;
; ALL-NEXT:    andd $r4 = $r4, 0xff00ff00ff00ff
; ALL-NEXT:    andd $r2 = $r2, 0xff00ff00ff00ff
; ALL-NEXT:    ;;
; ALL-NEXT:    cmovehq.even $r4 ? $r0 = $r1
; ALL-NEXT:    cmovehq.even $r2 ? $r3 = $r5
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r0 = $r0, 0x40100401
...
; ALL-NEXT:    mulhq $r1 = $r1, $r2
; ALL-NEXT:    sbmm8 $r2 = $r3, 0x40100401
; ALL-NEXT:    ord $r3 = $r0, 0x8080808080808080
; ALL-NEXT:    ;;
; ALL-NEXT:    sbmm8 $r1 = $r1, 0x40100401
; ALL-NEXT:    ;;
; ALL-NEXT:    insf $r1 = $r2, 63, 32
