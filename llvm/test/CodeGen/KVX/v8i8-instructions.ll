...
; CV1-NEXT:    ;;
; CV1-NEXT:    minuw $r1 = $r0, $r1
; CV1-NEXT:    minuw $r6 = $r11, $r10
; CV1-NEXT:    zxhd $r15 = $r15
; CV1-NEXT:    zxhd $r16 = $r16
; CV1-NEXT:    ;;
; CV1-NEXT:    minuw $r0 = $r16, $r15
; CV1-NEXT:    insf $r3 = $r2, 15, 8
; CV1-NEXT:    insf $r4 = $r8, 15, 8
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r3 = $r4, 31, 16
