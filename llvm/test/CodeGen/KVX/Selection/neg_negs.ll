...
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    sbmm8 $r1 = $r1, 0x4000200004000100
; CV1-NEXT:    andd $r5 = $r5, 0xff00ff00.@
; CV1-NEXT:    sbmm8 $r7 = $r5, 0x4000200004000100
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    sbmm8 $r2 = $r2, 0x4000200004000100
; CV1-NEXT:    sbfshq $r4 = $r4, $r7
...
; CV1-NEXT:    ;; # (end cycle 3)
; CV1-NEXT:    andd $r0 = $r0, 0xff00ff00.@
; CV1-NEXT:    sbfshq $r1 = $r1, $r7
; CV1-NEXT:    sbfshq $r6 = $r6, $r5
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    sbfshq $r2 = $r2, $r7
; CV1-NEXT:    andd $r6 = $r6, 0xff00ff00.@
; CV1-NEXT:    sbfshq $r8 = $r8, $r5
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    sbfshq $r3 = $r3, $r7
; CV1-NEXT:    sbfshq $r5 = $r9, $r5
; CV1-NEXT:    andd $r7 = $r8, 0xff00ff00.@
