...
; CHECK-NEXT:    negd $r4 = $r2
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    mulwd $r1 = $r1, $r3
; CHECK-NEXT:    srld $r4 = $r4, 32
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    msbfwd $r2 = $r4, $r3
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    maddwd $r1 = $r4, $r0
; CHECK-NEXT:    ;; # (end cycle 4)
...
; V1-NEXT:    clrf $r4 = $r1, 31, 47
; V1-NEXT:    clrf $r5 = $r0, 47, 0
; V1-NEXT:    ;; # (end cycle 0)
; V1-NEXT:    addd $r1 = $r5, $r1
; V1-NEXT:    clrf $r2 = $r1, 15, 31
; V1-NEXT:    clrf $r3 = $r3, 63, 16
; V1-NEXT:    sbfd $r4 = $r4, $r0
; V1-NEXT:    ;; # (end cycle 1)
; V1-NEXT:    clrf $r1 = $r1, 47, 0
; V1-NEXT:    clrf $r4 = $r4, 31, 47
; V1-NEXT:    ;; # (end cycle 2)
; V1-NEXT:    adduwd $r0 = $r2, $r0
; V1-NEXT:    ord $r2 = $r4, $r3
; V1-NEXT:    ;; # (end cycle 3)
...
; V2-NEXT:    clrf $r0 = $r0, 15, 31
; V2-NEXT:    clrf $r1 = $r1, 47, 0
; V2-NEXT:    clrf $r4 = $r4, 31, 47
; V2-NEXT:    ;; # (end cycle 2)
; V2-NEXT:    ord $r2 = $r4, $r3
; V2-NEXT:    ;; # (end cycle 3)
; V2-NEXT:    ord $r1 = $r2, $r1
; V2-NEXT:    ;; # (end cycle 4)
; V2-NEXT:    ord $r0 = $r1, $r0
...
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fmuld $r4 = $r1, $r0
; CHECK-NEXT:    ;; # (end cycle 6)
; CHECK-NEXT:    fmuld $r1 = $r2, $r1
; CHECK-NEXT:    ;; # (end cycle 7)
; CHECK-NEXT:    ffmad $r4 = $r3, $r2
; CHECK-NEXT:    ;; # (end cycle 10)
; CHECK-NEXT:    ffmsd $r1 = $r3, $r0
...
; V1:       # %bb.0:
; V1-NEXT:    sxwd $r2 = $r0
; V1-NEXT:    extfs $r5 = $r1, 63, 32
; V1-NEXT:    ;; # (end cycle 0)
; V1-NEXT:    muld $r1 = $r5, $r2
; V1-NEXT:    extfs $r3 = $r0, 63, 32
; V1-NEXT:    sxwd $r4 = $r1
; V1-NEXT:    ;; # (end cycle 1)
; V1-NEXT:    muld $r0 = $r4, $r2
; V1-NEXT:    ;; # (end cycle 2)
; V1-NEXT:    maddd $r0 = $r5, $r3
; V1-NEXT:    ;; # (end cycle 3)
; V1-NEXT:    msbfd $r1 = $r4, $r3
; V1-NEXT:    ret
; V1-NEXT:    ;; # (end cycle 4)
;
; V2-LABEL: MULCWDC_3:
; V2:       # %bb.0:
; V2-NEXT:    sxwd $r2 = $r0
; V2-NEXT:    extfs $r3 = $r0, 63, 32
; V2-NEXT:    sxwd $r4 = $r1
; V2-NEXT:    extfs $r5 = $r1, 63, 32
; V2-NEXT:    ;; # (end cycle 0)
; V2-NEXT:    muld $r0 = $r4, $r2
; V2-NEXT:    ;; # (end cycle 1)
; V2-NEXT:    muld $r1 = $r5, $r2
; V2-NEXT:    ;; # (end cycle 2)
; V2-NEXT:    maddd $r0 = $r5, $r3
; V2-NEXT:    ;; # (end cycle 3)
; V2-NEXT:    msbfd $r1 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;; # (end cycle 4)
...
; V1-NEXT:    muld $r0 = $r4, $r2
; V1-NEXT:    ;; # (end cycle 2)
; V1-NEXT:    msbfd $r0 = $r5, $r3
; V1-NEXT:    ;; # (end cycle 3)
; V1-NEXT:    maddd $r1 = $r4, $r3
; V1-NEXT:    ret
; V1-NEXT:    ;; # (end cycle 4)
;
; V2-LABEL: MULWDC_3:
...
; V2-NEXT:    muld $r1 = $r5, $r2
; V2-NEXT:    ;; # (end cycle 2)
; V2-NEXT:    msbfd $r0 = $r5, $r3
; V2-NEXT:    ;; # (end cycle 3)
; V2-NEXT:    maddd $r1 = $r4, $r3
; V2-NEXT:    ret
; V2-NEXT:    ;; # (end cycle 4)
  %3 = sext <2 x i32> %0 to <2 x i64>
  %4 = sext <2 x i32> %1 to <2 x i64>
