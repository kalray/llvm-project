...
; CV1-NEXT:    extfz $r11 = $r4, 19, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r8 = $r9, 47, 0
; CV1-NEXT:    srlhqs $r10 = $r0, $r4
; CV1-NEXT:    ;;
; CV1-NEXT:    srlhqs $r9 = $r0, $r11
; CV1-NEXT:    extfz $r11 = $r4, 35, 32
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r9 = $r10, 15, 0
...
; CV2-NEXT:    extfz $r10 = $r4, 19, 16
; CV2-NEXT:    ;;
; CV2-NEXT:    extfz $r4 = $r4, 51, 48
; CV2-NEXT:    srlhqs $r9 = $r0, $r4
; CV2-NEXT:    srlhqs $r10 = $r0, $r10
