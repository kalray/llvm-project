...
; ALL-NEXT:    ;; # (end cycle 0)
; ALL-NEXT:    addhq $r0 = $r0, 0xffd5fff4
; ALL-NEXT:    ;; # (end cycle 1)
...
; ALL-NEXT:    ;; # (end cycle 0)
; ALL-NEXT:    addd $r1 = $r2, -12
; ALL-NEXT:    ;; # (end cycle 1)
; ALL-NEXT:    absd $r0 = $r1
; ALL-NEXT:    ;; # (end cycle 2)
; ALL-NEXT:    insf $r0 = $r3, 63, 32
; ALL-NEXT:    ret
; ALL-NEXT:    ;; # (end cycle 3)
