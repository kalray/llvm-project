...
; CV2-NEXT:    sxlbhq $r1 = $r1
; CV2-NEXT:    sxmbhq $r2 = $r1
; CV2-NEXT:    sxmbhq $r3 = $r0
; CV2-NEXT:    ;;
; CV2-NEXT:    mulhq $r2 = $r3, $r2
; CV2-NEXT:    ;;
; CV2-NEXT:    mulhq $r0 = $r0, $r1
; CV2-NEXT:    ;;
...
; CV2-NEXT:    sxmbhq $r4 = $r0
; CV2-NEXT:    ;;
; CV2-NEXT:    mulhq $r3 = $r4, $r3
; CV2-NEXT:    sxmbhq $r4 = $r2
; CV2-NEXT:    ;;
; CV2-NEXT:    mulhq $r0 = $r0, $r1
; CV2-NEXT:    sxlbhq $r1 = $r2
; CV2-NEXT:    ;;
...
; CV1-NEXT:    ;;
; CV1-NEXT:    compnhq.lt $r2 = $r2, $r4
; CV1-NEXT:    compnhq.lt $r3 = $r5, $r3
...
; CV1-NEXT:    cmovehq.even $r3 ? $r4 = $r5
; CV1-NEXT:    ;;
; CV1-NEXT:    cmovehq.even $r2 ? $r0 = $r1
; CV1-NEXT:    sbmm8 $r1 = $r4, 0x40100401
; CV1-NEXT:    ;;
; CV1-NEXT:    sbmm8 $r0 = $r0, 0x40100401
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r0 = $r1, 63, 32
