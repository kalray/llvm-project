...
; CV1-NEXT:    ;; # (end cycle 0)
; CV1-NEXT:    mulhq $r1 = $r1, $r2
; CV1-NEXT:    srlhqs $r4 = $r2, 8
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    mulhq $r2 = $r3, $r4
; CV1-NEXT:    andd $r3 = $r0, 0x7f7f7f7f.@
; CV1-NEXT:    ;; # (end cycle 2)
; CV1-NEXT:    andd $r1 = $r1, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 3)
...
; CV2-NEXT:    andd $r3 = $r1, 0xff00ff00.@
; CV2-NEXT:    ;; # (end cycle 0)
; CV2-NEXT:    mulhq $r1 = $r1, $r2
; CV2-NEXT:    srlhqs $r4 = $r2, 8
; CV2-NEXT:    ;; # (end cycle 1)
; CV2-NEXT:    mulhq $r2 = $r3, $r4
; CV2-NEXT:    ;; # (end cycle 2)
; CV2-NEXT:    andd $r1 = $r1, 0xff00ff.@
; CV2-NEXT:    ;; # (end cycle 3)
; CV2-NEXT:    ord $r1 = $r1, $r2
...
; CV1-NEXT:    sllw $r2 = $r8, $r2
; CV1-NEXT:    andw $r5 = $r5, 7
; CV1-NEXT:    srld $r6 = $r6, 1
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    sllw $r0 = $r0, $r5
; CV1-NEXT:    andd $r1 = $r1, 0xff00ff00.@
; CV1-NEXT:    notd $r3 = $r3
...
; CV1-NEXT:    extfz $r11 = $r3, 39, 32
; CV1-NEXT:    ;; # (end cycle 11)
; CV1-NEXT:    srlw $r5 = $r5, $r6
; CV1-NEXT:    andw $r9 = $r9, 7
; CV1-NEXT:    zxbd $r10 = $r10
; CV1-NEXT:    andw $r11 = $r11, 7
; CV1-NEXT:    ;; # (end cycle 12)
; CV1-NEXT:    srlw $r2 = $r7, $r2
...
; CV1-NEXT:    ;; # (end cycle 1)
; CV1-NEXT:    sllw $r3 = $r3, $r4
; CV1-NEXT:    sllw $r4 = $r5, $r6
; CV1-NEXT:    andw $r5 = $r9, 7
; CV1-NEXT:    srlw $r7 = $r0, 24
; CV1-NEXT:    ;; # (end cycle 2)
...
; CV1-NEXT:    extfz $r10 = $r2, 23, 16
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    sllw $r5 = $r6, $r5
; CV1-NEXT:    sllw $r6 = $r7, $r8
; CV1-NEXT:    andw $r7 = $r10, 7
; CV1-NEXT:    extfz $r9 = $r0, 23, 16
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    sllw $r3 = $r9, $r7
...
; CV1-NEXT:    extfz $r8 = $r0, 15, 8
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    andw $r4 = $r7, 7
; CV1-NEXT:    insf $r5 = $r4, 31, 16
; CV1-NEXT:    andw $r6 = $r6, 7
; CV1-NEXT:    andd $r7 = $r1, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    sllw $r0 = $r0, $r6
; CV1-NEXT:    andd $r1 = $r1, 0xff00ff00.@
; CV1-NEXT:    sllw $r4 = $r8, $r4
; CV1-NEXT:    srld $r6 = $r7, 1
; CV1-NEXT:    ;; # (end cycle 9)
...
; CV2-NEXT:    extfz $r5 = $r3, 18, 16
; CV2-NEXT:    extfz $r6 = $r2, 10, 8
; CV2-NEXT:    srlbos $r7 = $r1, $r3
; CV2-NEXT:    ;; # (end cycle 1)
; CV2-NEXT:    srlbos $r4 = $r1, $r4
; CV2-NEXT:    srlbos $r5 = $r1, $r5
; CV2-NEXT:    sllbos $r6 = $r0, $r6
; CV2-NEXT:    extfz $r8 = $r2, 18, 16
; CV2-NEXT:    ;; # (end cycle 2)
; CV2-NEXT:    insf $r4 = $r7, 7, 0
; CV2-NEXT:    sllbos $r7 = $r0, $r2
; CV2-NEXT:    sllbos $r8 = $r0, $r8
; CV2-NEXT:    extfz $r9 = $r3, 42, 40
; CV2-NEXT:    ;; # (end cycle 3)
; CV2-NEXT:    extfz $r4 = $r2, 26, 24
; CV2-NEXT:    insf $r5 = $r4, 15, 0
; CV2-NEXT:    insf $r6 = $r7, 7, 0
; CV2-NEXT:    extfz $r7 = $r3, 26, 24
; CV2-NEXT:    ;; # (end cycle 4)
; CV2-NEXT:    sllbos $r4 = $r0, $r4
; CV2-NEXT:    extfz $r6 = $r3, 34, 32
; CV2-NEXT:    srlbos $r7 = $r1, $r7
; CV2-NEXT:    insf $r8 = $r6, 15, 0
; CV2-NEXT:    ;; # (end cycle 5)
; CV2-NEXT:    insf $r4 = $r8, 23, 0
; CV2-NEXT:    srlbos $r5 = $r1, $r6
; CV2-NEXT:    extfz $r6 = $r2, 34, 32
; CV2-NEXT:    insf $r7 = $r5, 23, 0
; CV2-NEXT:    ;; # (end cycle 6)
; CV2-NEXT:    insf $r5 = $r7, 31, 0
; CV2-NEXT:    sllbos $r6 = $r0, $r6
...
; CV2-NEXT:    ;; # (end cycle 8)
; CV2-NEXT:    insf $r4 = $r5, 39, 0
; CV2-NEXT:    extfz $r5 = $r3, 50, 48
; CV2-NEXT:    extfz $r6 = $r2, 50, 48
; CV2-NEXT:    insf $r7 = $r6, 39, 0
; CV2-NEXT:    ;; # (end cycle 9)
; CV2-NEXT:    extfz $r2 = $r2, 58, 56
; CV2-NEXT:    extfz $r3 = $r3, 58, 56
; CV2-NEXT:    srlbos $r5 = $r1, $r5
...
; CV2-NEXT:    sllbos $r0 = $r0, $r2
; CV2-NEXT:    srlbos $r1 = $r1, $r3
; CV2-NEXT:    insf $r5 = $r4, 47, 0
; CV2-NEXT:    insf $r6 = $r7, 47, 0
; CV2-NEXT:    ;; # (end cycle 11)
; CV2-NEXT:    insf $r0 = $r6, 55, 0
; CV2-NEXT:    insf $r1 = $r5, 55, 0
; CV2-NEXT:    ;; # (end cycle 12)
; CV2-NEXT:    ord $r0 = $r0, $r1
; CV2-NEXT:    ret
...
; CV1-NEXT:    slld $r5 = $r7, 1
; CV1-NEXT:    extfz $r10 = $r3, 15, 8
; CV1-NEXT:    ;; # (end cycle 9)
; CV1-NEXT:    andd $r0 = $r0, 0xff00ff00.@
; CV1-NEXT:    insf $r1 = $r2, 15, 8
; CV1-NEXT:    andd $r2 = $r5, 0xff00ff.@
...
; CV1-NEXT:    extfz $r8 = $r0, 47, 40
; CV1-NEXT:    ;; # (end cycle 12)
; CV1-NEXT:    sllw $r2 = $r6, $r2
; CV1-NEXT:    sllw $r5 = $r7, $r5
...
; CV1-NEXT:    ;; # (end cycle 14)
; CV1-NEXT:    sllw $r2 = $r8, $r6
; CV1-NEXT:    sllw $r6 = $r9, $r7
...
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    srlw $r5 = $r6, $r5
; CV1-NEXT:    zxbd $r6 = $r8
; CV1-NEXT:    andw $r7 = $r7, 7
; CV1-NEXT:    andw $r8 = $r9, 7
; CV1-NEXT:    ;; # (end cycle 6)
; CV1-NEXT:    srlw $r3 = $r6, $r7
; CV1-NEXT:    insf $r5 = $r3, 15, 8
; CV1-NEXT:    extfz $r7 = $r2, 15, 8
...
; CV1-NEXT:    zxbd $r4 = $r2
; CV1-NEXT:    insf $r5 = $r4, 31, 16
; CV1-NEXT:    srlw $r6 = $r9, $r8
; CV1-NEXT:    andd $r8 = $r0, 0xff00ff.@
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    zxbd $r1 = $r1
; CV1-NEXT:    andw $r3 = $r7, 7
; CV1-NEXT:    insf $r6 = $r3, 15, 8
...
; CV1-NEXT:    ;; # (end cycle 10)
; CV1-NEXT:    slld $r0 = $r0, 1
; CV1-NEXT:    srlw $r1 = $r1, $r4
; CV1-NEXT:    srlw $r3 = $r7, $r3
...
; CV2-NEXT:    ;; # (end cycle 0)
; CV2-NEXT:    extfz $r4 = $r3, 10, 8
; CV2-NEXT:    srlbos $r5 = $r1, $r3
; CV2-NEXT:    extfz $r6 = $r2, 10, 8
; CV2-NEXT:    extfz $r7 = $r3, 18, 16
; CV2-NEXT:    ;; # (end cycle 1)
; CV2-NEXT:    srlbos $r4 = $r1, $r4
; CV2-NEXT:    sllbos $r6 = $r0, $r6
; CV2-NEXT:    srlbos $r7 = $r1, $r7
; CV2-NEXT:    sllbos $r8 = $r0, $r2
; CV2-NEXT:    ;; # (end cycle 2)
; CV2-NEXT:    insf $r4 = $r5, 7, 0
; CV2-NEXT:    extfz $r5 = $r2, 18, 16
; CV2-NEXT:    insf $r6 = $r8, 7, 0
; CV2-NEXT:    extfz $r8 = $r3, 26, 24
; CV2-NEXT:    ;; # (end cycle 3)
; CV2-NEXT:    extfz $r4 = $r2, 26, 24
; CV2-NEXT:    sllbos $r5 = $r0, $r5
; CV2-NEXT:    insf $r7 = $r4, 15, 0
; CV2-NEXT:    srlbos $r8 = $r1, $r8
; CV2-NEXT:    ;; # (end cycle 4)
; CV2-NEXT:    sllbos $r4 = $r0, $r4
; CV2-NEXT:    insf $r5 = $r6, 15, 0
; CV2-NEXT:    extfz $r6 = $r3, 34, 32
; CV2-NEXT:    insf $r8 = $r7, 23, 0
; CV2-NEXT:    ;; # (end cycle 5)
; CV2-NEXT:    insf $r4 = $r5, 23, 0
; CV2-NEXT:    srlbos $r6 = $r1, $r6
; CV2-NEXT:    extfz $r7 = $r2, 34, 32
; CV2-NEXT:    extfz $r9 = $r3, 42, 40
; CV2-NEXT:    ;; # (end cycle 6)
; CV2-NEXT:    sllbos $r5 = $r0, $r7
; CV2-NEXT:    insf $r6 = $r8, 31, 0
; CV2-NEXT:    extfz $r7 = $r2, 42, 40
; CV2-NEXT:    ;; # (end cycle 7)
; CV2-NEXT:    srlbos $r4 = $r1, $r9
