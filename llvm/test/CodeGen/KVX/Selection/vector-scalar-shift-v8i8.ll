...
; CV1-NEXT:    sraw $r0 = $r5, 3
; CV1-NEXT:    insf $r3 = $r4, 15, 8
; CV1-NEXT:    sraw $r6 = $r0, 3
...
; CV2-NEXT:    ;; # (end cycle 0)
; CV2-NEXT:    srabos $r2 = $r0, $r1
; CV2-NEXT:    extfz $r3 = $r1, 10, 8
; CV2-NEXT:    extfz $r4 = $r1, 18, 16
; CV2-NEXT:    extfz $r5 = $r1, 26, 24
; CV2-NEXT:    ;; # (end cycle 1)
; CV2-NEXT:    srabos $r3 = $r0, $r3
; CV2-NEXT:    srabos $r4 = $r0, $r4
; CV2-NEXT:    srabos $r5 = $r0, $r5
; CV2-NEXT:    extfz $r6 = $r1, 34, 32
; CV2-NEXT:    ;; # (end cycle 2)
; CV2-NEXT:    srabos $r2 = $r0, $r6
; CV2-NEXT:    insf $r3 = $r2, 7, 0
; CV2-NEXT:    ;; # (end cycle 3)
; CV2-NEXT:    extfz $r3 = $r1, 42, 40
...
; CV2-NEXT:    insf $r2 = $r5, 31, 0
; CV2-NEXT:    ;; # (end cycle 6)
; CV2-NEXT:    srabos $r0 = $r0, $r1
; CV2-NEXT:    srabos $r2 = $r0, $r4
; CV2-NEXT:    insf $r3 = $r2, 39, 0
; CV2-NEXT:    ;; # (end cycle 7)
; CV2-NEXT:    insf $r2 = $r3, 47, 0
...
; CV2-NEXT:    srlbos $r5 = $r0, $r5
; CV2-NEXT:    extfz $r6 = $r1, 34, 32
; CV2-NEXT:    ;; # (end cycle 2)
; CV2-NEXT:    srlbos $r2 = $r0, $r6
; CV2-NEXT:    insf $r3 = $r2, 7, 0
; CV2-NEXT:    ;; # (end cycle 3)
; CV2-NEXT:    extfz $r3 = $r1, 42, 40
; CV2-NEXT:    insf $r4 = $r3, 15, 0
...
; CV1-NEXT:    ;; # (end cycle 4)
; CV1-NEXT:    sraw $r3 = $r3, $r6
; CV1-NEXT:    sxbd $r4 = $r4
; CV1-NEXT:    extfz $r8 = $r0, 15, 8
; CV1-NEXT:    ;; # (end cycle 5)
; CV1-NEXT:    zxbd $r0 = $r0
; CV1-NEXT:    sraw $r4 = $r4, $r5
; CV1-NEXT:    extfz $r5 = $r0, 23, 16
...
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    zxbd $r1 = $r1
; CV1-NEXT:    sraw $r3 = $r3, $r9
; CV1-NEXT:    sxbd $r5 = $r5
; CV1-NEXT:    extfz $r7 = $r1, 15, 8
; CV1-NEXT:    ;; # (end cycle 8)
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    sraw $r5 = $r5, $r6
; CV1-NEXT:    sxbd $r8 = $r8
; CV1-NEXT:    ;; # (end cycle 9)
; CV1-NEXT:    sraw $r0 = $r0, $r1
; CV1-NEXT:    insf $r4 = $r2, 31, 16
...
; CV1-NEXT:    zxbd $r4 = $r4
; CV1-NEXT:    srlw $r6 = $r8, $r6
; CV1-NEXT:    ;; # (end cycle 7)
; CV1-NEXT:    srlw $r0 = $r0, $r1
; CV1-NEXT:    srlw $r4 = $r4, $r5
; CV1-NEXT:    srlw $r5 = $r7, $r9
; CV1-NEXT:    ;; # (end cycle 8)
