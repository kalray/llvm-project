...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp3:
; CHECK-NEXT:    #DEBUG_VALUE: f_2_pairpack:a <- $r1
; CHECK-NEXT:    .loc 1 30 12 # cfi-csr.c:30:12
; CHECK-NEXT:    ld $r0 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp4:
; CHECK-NEXT:    #DEBUG_VALUE: f_2_pairpack:b <- $r0
; CHECK-NEXT:    .loc 1 34 12 # cfi-csr.c:34:12
; CHECK-NEXT:    addd $r18 = $r0, $r1
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp7:
; CHECK-NEXT:    #DEBUG_VALUE: f_3_pairpack:a <- $r1
; CHECK-NEXT:    .loc 1 53 12 # cfi-csr.c:53:12
; CHECK-NEXT:    ld $r2 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp8:
; CHECK-NEXT:    #DEBUG_VALUE: f_3_pairpack:b <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_3_pairpack:c <- $r0
; CHECK-NEXT:    .loc 1 54 12 # cfi-csr.c:54:12
; CHECK-NEXT:    ld $r0 = 16[$r0]
; CHECK-NEXT:    addd $r1 = $r2, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp9:
; CHECK-NEXT:    .loc 1 58 16 # cfi-csr.c:58:16
; CHECK-NEXT:    addd $r18 = $r1, $r0
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 58 3 is_stmt 0 # cfi-csr.c:58:3
; CHECK-NEXT:    copyd $r0 = $r18
; CHECK-NEXT:    addd $r12 = $r14, -16
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld $r18 = 8[$r12]
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp11:
; CHECK-NEXT:    #DEBUG_VALUE: f_4_quadpack:a <- $r1
; CHECK-NEXT:    .loc 1 81 12 # cfi-csr.c:81:12
; CHECK-NEXT:    ld $r2 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp12:
; CHECK-NEXT:    #DEBUG_VALUE: f_4_quadpack:b <- $r2
; CHECK-NEXT:    .loc 1 82 12 # cfi-csr.c:82:12
; CHECK-NEXT:    ld $r3 = 16[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp13:
; CHECK-NEXT:    #DEBUG_VALUE: f_4_quadpack:c <- $r3
; CHECK-NEXT:    #DEBUG_VALUE: f_4_quadpack:d <- $r19
; CHECK-NEXT:    .loc 1 83 12 # cfi-csr.c:83:12
; CHECK-NEXT:    ld $r19 = 24[$r0]
; CHECK-NEXT:    addd $r1 = $r2, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp14:
; CHECK-NEXT:    .loc 1 87 16 # cfi-csr.c:87:16
; CHECK-NEXT:    addd $r18 = $r1, $r3
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 87 20 is_stmt 0 # cfi-csr.c:87:20
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp16:
; CHECK-NEXT:    #DEBUG_VALUE: f_5_quadpack:a <- $r1
; CHECK-NEXT:    .loc 1 109 12 # cfi-csr.c:109:12
; CHECK-NEXT:    ld $r2 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp17:
; CHECK-NEXT:    #DEBUG_VALUE: f_5_quadpack:b <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_5_quadpack:c <- $r3
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp19:
; CHECK-NEXT:    #DEBUG_VALUE: f_5_quadpack:d <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_5_quadpack:e <- $r18
...
; CHECK-NEXT:    addd $r19 = $r1, $r2
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 116 24 is_stmt 0 # cfi-csr.c:116:24
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp22:
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:a <- $r1
; CHECK-NEXT:    .loc 1 142 12 # cfi-csr.c:142:12
; CHECK-NEXT:    ld $r2 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp23:
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:b <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:c <- $r3
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp25:
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:d <- $r2
; CHECK-NEXT:    .loc 1 145 12 # cfi-csr.c:145:12
; CHECK-NEXT:    ld $r19 = 32[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp26:
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:e <- $r19
; CHECK-NEXT:    #DEBUG_VALUE: f_6_1quad1pairpack:f <- $r20
; CHECK-NEXT:    .loc 1 146 12 # cfi-csr.c:146:12
; CHECK-NEXT:    ld $r20 = 40[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp27:
; CHECK-NEXT:    .loc 1 150 20 # cfi-csr.c:150:20
; CHECK-NEXT:    addd $r18 = $r1, $r2
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 150 24 is_stmt 0 # cfi-csr.c:150:24
; CHECK-NEXT:    addd $r0 = $r18, $r19
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp30:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:a <- $r1
; CHECK-NEXT:    .loc 1 176 12 # cfi-csr.c:176:12
; CHECK-NEXT:    ld $r2 = 8[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp31:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:b <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:c <- $r3
; CHECK-NEXT:    .loc 1 177 12 # cfi-csr.c:177:12
; CHECK-NEXT:    ld $r3 = 16[$r0]
; CHECK-NEXT:    addd $r1 = $r2, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp32:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:d <- $r2
; CHECK-NEXT:    .loc 1 178 12 # cfi-csr.c:178:12
; CHECK-NEXT:    ld $r2 = 24[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp33:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:e <- $r3
; CHECK-NEXT:    .loc 1 179 12 # cfi-csr.c:179:12
; CHECK-NEXT:    ld $r3 = 32[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp34:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:f <- $r2
; CHECK-NEXT:    .loc 1 180 12 # cfi-csr.c:180:12
; CHECK-NEXT:    ld $r2 = 40[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp35:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:g <- $r3
; CHECK-NEXT:    .loc 1 181 12 # cfi-csr.c:181:12
; CHECK-NEXT:    ld $r3 = 48[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp36:
; CHECK-NEXT:    .loc 1 182 12 # cfi-csr.c:182:12
; CHECK-NEXT:    ld $r2 = 56[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp37:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:h <- $r2
; CHECK-NEXT:    .loc 1 183 12 # cfi-csr.c:183:12
; CHECK-NEXT:    ld $r18 = 64[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp38:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:i <- $r18
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:j <- $r19
; CHECK-NEXT:    .loc 1 184 12 # cfi-csr.c:184:12
; CHECK-NEXT:    ld $r19 = 72[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp39:
; CHECK-NEXT:    .loc 1 185 12 # cfi-csr.c:185:12
; CHECK-NEXT:    ld $r20 = 80[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp40:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:k <- $r20
; CHECK-NEXT:    .loc 1 186 12 # cfi-csr.c:186:12
; CHECK-NEXT:    ld $r21 = 88[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp41:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:l <- $r21
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:m <- $r23
; CHECK-NEXT:    .loc 1 187 12 # cfi-csr.c:187:12
; CHECK-NEXT:    ld $r23 = 96[$r0]
; CHECK-NEXT:    addd $r22 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp42:
; CHECK-NEXT:    #DEBUG_VALUE: f_14_3quad1pairpack:n <- $r24
; CHECK-NEXT:    .loc 1 188 12 # cfi-csr.c:188:12
; CHECK-NEXT:    ld $r24 = 104[$r0]
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp43:
; CHECK-NEXT:    .loc 1 192 40 # cfi-csr.c:192:40
; CHECK-NEXT:    addd $r0 = $r22, $r18
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 192 44 is_stmt 0 # cfi-csr.c:192:44
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp48:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:b <- $r2
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:c <- $r3
; CHECK-NEXT:    .loc 1 233 12 # cfi-csr.c:233:12
; CHECK-NEXT:    ld $r3 = 16[$r0]
; CHECK-NEXT:    addd $r1 = $r2, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp49:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:d <- $r2
; CHECK-NEXT:    .loc 1 234 12 # cfi-csr.c:234:12
; CHECK-NEXT:    ld $r2 = 24[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp50:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:e <- $r3
; CHECK-NEXT:    .loc 1 235 12 # cfi-csr.c:235:12
; CHECK-NEXT:    ld $r3 = 32[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp51:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:f <- $r2
; CHECK-NEXT:    .loc 1 236 12 # cfi-csr.c:236:12
; CHECK-NEXT:    ld $r2 = 40[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp52:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:g <- $r3
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp54:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:h <- $r2
; CHECK-NEXT:    .loc 1 239 12 # cfi-csr.c:239:12
; CHECK-NEXT:    ld $r4 = 64[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp55:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:i <- $r4
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:j <- $r18
; CHECK-NEXT:    .loc 1 240 12 # cfi-csr.c:240:12
; CHECK-NEXT:    ld $r18 = 72[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp56:
; CHECK-NEXT:    .loc 1 241 12 # cfi-csr.c:241:12
; CHECK-NEXT:    ld $r19 = 80[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp57:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:k <- $r19
; CHECK-NEXT:    .loc 1 242 12 # cfi-csr.c:242:12
; CHECK-NEXT:    ld $r20 = 88[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp58:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:l <- $r20
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:m <- $r21
; CHECK-NEXT:    .loc 1 243 12 # cfi-csr.c:243:12
; CHECK-NEXT:    ld $r21 = 96[$r0]
; CHECK-NEXT:    addd $r1 = $r1, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp59:
; CHECK-NEXT:    .loc 1 244 12 # cfi-csr.c:244:12
; CHECK-NEXT:    ld $r22 = 104[$r0]
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp60:
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:n <- $r22
; CHECK-NEXT:    #DEBUG_VALUE: f_15_3quad1pairpack:o <- $r23
; CHECK-NEXT:    .loc 1 245 12 # cfi-csr.c:245:12
; CHECK-NEXT:    ld $r23 = 112[$r0]
; CHECK-NEXT:    addd $r24 = $r1, $r4
; CHECK-NEXT:    call foo
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp61:
; CHECK-NEXT:    .loc 1 249 44 # cfi-csr.c:249:44
; CHECK-NEXT:    addd $r0 = $r24, $r18
; CHECK-NEXT:    ;;
; CHECK-NEXT:    .loc 1 249 48 is_stmt 0 # cfi-csr.c:249:48
; CHECK-NEXT:    addd $r0 = $r0, $r19
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    sd -24[$r14] = $r8
; CHECK-NEXT:    cb.wlez $r3 ? .LBB8_2
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .Ltmp72:
