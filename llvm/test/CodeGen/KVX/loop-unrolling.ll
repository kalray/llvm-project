...
; CHECK-NEXT:    ord $r4 = $r1, 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ord $r5 = $r1, 4
; CHECK-NEXT:    sw 24[$r0] = $r2
; CHECK-NEXT:    ord $r6 = $r1, 2
; CHECK-NEXT:    ord $r7 = $r1, 1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    addd $r8 = $r1, 8
; CHECK-NEXT:    ord $r1 = $r1, 5
; CHECK-NEXT:    addd $r2 = $r0, 32
; CHECK-NEXT:    sw 16[$r0] = $r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 12[$r0] = $r4
; CHECK-NEXT:    compd.eq $r4 = $r8, 1024
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 4[$r0] = $r7
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 8[$r0] = $r6
; CHECK-NEXT:    ;;
; CHECK-NEXT:    sw 28[$r0] = $r3
; CHECK-NEXT:    ;;
