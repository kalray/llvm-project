...
; CHECK-NEXT:    copyd $r0 = $r4
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r1 = $r3, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r0 = $r2, $r0
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r3 = $r7, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r2 = $r6, $r2
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r1 = $r5, $r1
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ffmawp $r0 = $r4, $r0
; CHECK-NEXT:    ret
; CHECK-NEXT:    ;;
