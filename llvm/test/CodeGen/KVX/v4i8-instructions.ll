...
; V2-NEXT:    call __divdi3
; V2-NEXT:    ;;
; V2-NEXT:    insf $r0 = $r20, 15, 8
; V2-NEXT:    lq $r18r19 = 24[$r12]
; V2-NEXT:    ;;
; V2-NEXT:    insf $r0 = $r21, 31, 16
...
; V2-NEXT:    ;;
; V2-NEXT:    andd $r2 = $r2, 0xff00ff00ff00ff
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    sbmm8 $r9 = $r9, 0x8000400020001
; V2-NEXT:    sbmm8 $r8 = $r8, 0x8000400020001
; V2-NEXT:    ;;
; V2-NEXT:    compnhq.ltu $r8 = $r8, $r9
; V2-NEXT:    ;;
; V2-NEXT:    sbmm8 $r8 = $r8, 0x40100401
; V2-NEXT:    ;;
; V2-NEXT:    srlw $r9 = $r8, 24
; V2-NEXT:    extfz $r10 = $r8, 23, 16
; V2-NEXT:    zxbd $r11 = $r8
; V2-NEXT:    extfz $r8 = $r8, 15, 8
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r9 = $r9
; V2-NEXT:    sxbd $r10 = $r10
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r11 = $r11
; V2-NEXT:    sxbd $r8 = $r8
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    zxbd $r1 = $r0
; V2-NEXT:    extfz $r2 = $r0, 15, 8
; V2-NEXT:    extfz $r3 = $r0, 23, 16
; V2-NEXT:    srlw $r4 = $r0, 24
; V2-NEXT:    ;;
; V2-NEXT:    sxbd $r0 = $r1
; V2-NEXT:    sxbd $r1 = $r2
; V2-NEXT:    ;;
...
; V2:       # %bb.0:
; V2-NEXT:    addd $r12 = $r12, -32
; V2-NEXT:    andd $r2 = $r2, 3
; V2-NEXT:    ;;
; V2-NEXT:    addd $r3 = $r12, 28
; V2-NEXT:    sw 28[$r12] = $r0
; V2-NEXT:    ;;
; V2-NEXT:    sb $r2[$r3] = $r1
; V2-NEXT:    ;;
; V2-NEXT:    lwz $r0 = 28[$r12]
; V2-NEXT:    addd $r12 = $r12, 32
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: nandw_v2i8_ri10:
; V2:       # %bb.0:
; V2-NEXT:    nandw $r0 = $r0, 0xff00ff
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: nandw_v2i8_ri37:
; V2:       # %bb.0:
; V2-NEXT:    nandw $r0 = $r0, 0xfc00fc
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; CHECK-NEXT:    ;;
;
; V2-LABEL: nandw_v2i8_ri37_2:
; V2:       # %bb.0:
; V2-NEXT:    nandw $r0 = $r0, 0xd0d0d0d
; V2-NEXT:    ret
; V2-NEXT:    ;;
