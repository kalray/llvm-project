...
; FP-NONE-NEXT:    cb.wlez $r1 ? .LBB0_1
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:  # %bb.2: # %for.body.preheader
; FP-NONE-NEXT:    addw $r0 = $r1, -1
; FP-NONE-NEXT:    ld $r4 = 0[$r12]
; FP-NONE-NEXT:    andw $r2 = $r1, 7
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    compw.ltu $r0 = $r0, 7
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    cb.even $r0 ? .LBB0_8
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:  # %bb.3:
...
; FP-ALL-NEXT:    cb.wlez $r1 ? .LBB0_1
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:  # %bb.2: # %for.body.preheader
; FP-ALL-NEXT:    addw $r0 = $r1, -1
; FP-ALL-NEXT:    ld $r4 = -8[$r14]
; FP-ALL-NEXT:    andw $r2 = $r1, 7
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    compw.ltu $r0 = $r0, 7
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    cb.even $r0 ? .LBB0_8
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:  # %bb.3:
