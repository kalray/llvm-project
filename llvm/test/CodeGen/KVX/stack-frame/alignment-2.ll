...
; FP-NONE-NEXT:    sd 0[$r12] = $r16
; FP-NONE-NEXT:    make $r0 = 0
; FP-NONE-NEXT:    make $r4 = 9
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    .cfi_offset 67, -96
...
; FP-NONE-NEXT:    so 64[$r12] = $r0r1r2r3
; FP-NONE-NEXT:    copyd $r7 = $r0
; FP-NONE-NEXT:    addd $r0 = $r12, 32
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    so 32[$r12] = $r4r5r6r7
; FP-NONE-NEXT:    call i
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    ld $r16 = 0[$r12]
; FP-NONE-NEXT:    ;;
...
; FP-ALL-NEXT:    so 64[$r12] = $r0r1r2r3
; FP-ALL-NEXT:    copyd $r7 = $r0
; FP-ALL-NEXT:    addd $r0 = $r12, 32
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    so 32[$r12] = $r4r5r6r7
; FP-ALL-NEXT:    call i
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    ld $r16 = 0[$r12]
; FP-ALL-NEXT:    ;;
