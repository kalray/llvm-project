...
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    lwz $r16 = 92[$r0]
; FP-NONE-NEXT:    ;;
; FP-NONE-NEXT:    lwz $r17 = 88[$r0]
; FP-NONE-NEXT:    ;;
...
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    lwz $r16 = 92[$r0]
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    lwz $r17 = 88[$r0]
; FP-ALL-NEXT:    ;;
