...
; FP-ALL-NEXT:    sd 16[$r12] = $r16
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    .cfi_offset 67, -16
; FP-ALL-NEXT:    sd 8[$r12] = $r14
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    .cfi_offset 14, -24
...
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    ld $r16 = 16[$r12]
; FP-ALL-NEXT:    ;;
; FP-ALL-NEXT:    set $ra = $r16
; FP-ALL-NEXT:    ld $r14 = 8[$r12]
; FP-ALL-NEXT:    addd $r12 = $r12, 32
; FP-ALL-NEXT:    ;;
