...
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r1 = $r8, 0xff00ff00ff00ff
...
; CV1-NEXT:    ;;
; CV1-NEXT:    srld $r5 = $r5, $r7
; CV1-NEXT:    srld $r9 = $r9, $r7
...
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r2 = $r5, 0xff00ff00ff00ff
...
; CV1-NEXT:    sraw $r2 = $r4, 4
; CV1-NEXT:    sxbd $r5 = $r5
; CV1-NEXT:    andd $r9 = $r2, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r4 = $r6
; CV1-NEXT:    sxbd $r7 = $r7
; CV1-NEXT:    ;;
...
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r7 = $r11, 0xff00ff00ff00ff
; CV1-NEXT:    andd $r9 = $r11, 0xff00ff00ff00ff00
...
; CV1-NEXT:    sraw $r11 = $r11, 7
; CV1-NEXT:    andd $r16 = $r1, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    insf $r17 = $r16, 15, 8
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r7 = $r7, 0xff00ff00ff00ff
; CV1-NEXT:    andd $r9 = $r9, 0xff00ff00ff00ff00
; CV1-NEXT:    sxbd $r32 = $r32
; CV1-NEXT:    sxbd $r34 = $r34
; CV1-NEXT:    ;;
; CV1-NEXT:    ord $r7 = $r9, $r7
; CV1-NEXT:    insf $r15 = $r11, 15, 8
; CV1-NEXT:    sraw $r32 = $r32, 7
; CV1-NEXT:    sraw $r34 = $r34, 7
; CV1-NEXT:    ;;
; CV1-NEXT:    xord $r0 = $r0, $r7
; CV1-NEXT:    andd $r5 = $r7, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    insf $r17 = $r15, 31, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r0 = $r0, 0x8080808080808080
; CV1-NEXT:    addd $r5 = $r8, $r5
; CV1-NEXT:    insf $r17 = $r10, 63, 32
; CV1-NEXT:    ;;
; CV1-NEXT:    xord $r0 = $r5, $r0
; CV1-NEXT:    andd $r5 = $r17, 0xff00ff00ff00ff
; CV1-NEXT:    andd $r6 = $r17, 0xff00ff00ff00ff00
...
; CV1-NEXT:    sxbd $r11 = $r11
; CV1-NEXT:    andd $r15 = $r5, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    sraw $r17 = $r17, 7
; CV1-NEXT:    ;;
; CV1-NEXT:    zxbd $r0 = $r0
; CV1-NEXT:    sraw $r5 = $r9, 5
...
; CV1-NEXT:    andd $r1 = $r1, 0x8080808080808080
; CV1-NEXT:    sxbd $r9 = $r9
; CV1-NEXT:    addd $r15 = $r16, $r15
; CV1-NEXT:    extfz $r16 = $r2, 23, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r0 = $r0
; CV1-NEXT:    insf $r5 = $r6, 15, 8
; CV1-NEXT:    xord $r6 = $r15, $r1
; CV1-NEXT:    sraw $r7 = $r10, 5
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r0 = $r0, 5
; CV1-NEXT:    sraw $r1 = $r11, 5
...
; CV1-NEXT:    ;;
; CV1-NEXT:    srld $r8 = $r6, 56
; CV1-NEXT:    insf $r11 = $r10, 15, 8
; CV1-NEXT:    extfz $r17 = $r6, 47, 40
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r9 = $r7, 15, 8
; CV1-NEXT:    extfz $r10 = $r3, 55, 48
; CV1-NEXT:    ;;
; CV1-NEXT:    extfz $r15 = $r3, 47, 40
; CV1-NEXT:    insf $r16 = $r15, 15, 8
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r10 = $r10
; CV1-NEXT:    insf $r11 = $r9, 31, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    srld $r9 = $r3, 56
; CV1-NEXT:    extfz $r16 = $r3, 39, 32
...
; CV1-NEXT:    sxbd $r15 = $r15
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r11 = $r15, 7
; CV1-NEXT:    sxbd $r16 = $r16
; CV1-NEXT:    insf $r32 = $r11, 63, 32
; CV1-NEXT:    ;;
; CV1-NEXT:    extfz $r7 = $r6, 55, 48
; CV1-NEXT:    sraw $r9 = $r9, 7
; CV1-NEXT:    andd $r32 = $r32, 0xff00ff00ff00ff00
; CV1-NEXT:    andd $r35 = $r32, 0xff00ff00ff00ff
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r8 = $r8
...
; CV1-NEXT:    insf $r10 = $r9, 15, 8
; CV1-NEXT:    srld $r35 = $r35, $r4
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r8 = $r8, 5
; CV1-NEXT:    extfz $r11 = $r3, 15, 8
; CV1-NEXT:    insf $r15 = $r11, 15, 8
; CV1-NEXT:    srld $r32 = $r32, $r4
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r7 = $r7, 5
; CV1-NEXT:    sxbd $r9 = $r9
; CV1-NEXT:    sxbd $r16 = $r16
...
; CV1-NEXT:    sxbd $r11 = $r11
; CV1-NEXT:    sraw $r16 = $r16, 7
; CV1-NEXT:    extfz $r33 = $r6, 39, 32
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r11 = $r11, 7
; CV1-NEXT:    insf $r15 = $r10, 31, 16
; CV1-NEXT:    sxbd $r17 = $r17
; CV1-NEXT:    ;;
; CV1-NEXT:    extfz $r10 = $r6, 23, 16
; CV1-NEXT:    sxbd $r33 = $r33
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r7 = $r8, 15, 8
; CV1-NEXT:    srlw $r8 = $r6, 24
; CV1-NEXT:    andd $r9 = $r35, 0xff00ff00ff00ff
; CV1-NEXT:    insf $r16 = $r9, 15, 8
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r11 = $r32, 0xff00ff00ff00ff00
; CV1-NEXT:    sraw $r17 = $r17, 5
; CV1-NEXT:    sraw $r33 = $r33, 5
; CV1-NEXT:    insf $r34 = $r11, 15, 8
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r0 = $r1, 31, 16
; CV1-NEXT:    sxbd $r8 = $r8
; CV1-NEXT:    ;;
; CV1-NEXT:    ord $r9 = $r11, $r9
; CV1-NEXT:    andd $r16 = $r2, 0x7f7f7f7f7f7f7f7f
...
; CV1-NEXT:    andd $r17 = $r3, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    ;;
...
; CV1-NEXT:    ;;
; CV1-NEXT:    zxbd $r6 = $r6
; CV1-NEXT:    extfz $r10 = $r6, 15, 8
; CV1-NEXT:    addd $r11 = $r16, $r11
; CV1-NEXT:    insf $r33 = $r7, 31, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    andd $r2 = $r2, 0x8080808080808080
; CV1-NEXT:    andd $r15 = $r34, 0xff00ff00ff00ff
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r6 = $r6
; CV1-NEXT:    sraw $r9 = $r9, 5
; CV1-NEXT:    sxbd $r10 = $r10
; CV1-NEXT:    andd $r16 = $r34, 0xff00ff00ff00ff00
; CV1-NEXT:    ;;
; CV1-NEXT:    xord $r2 = $r11, $r2
; CV1-NEXT:    srld $r4 = $r16, $r4
; CV1-NEXT:    sraw $r7 = $r10, 5
; CV1-NEXT:    srld $r11 = $r15, $r4
; CV1-NEXT:    ;;
; CV1-NEXT:    sraw $r1 = $r6, 5
; CV1-NEXT:    srld $r6 = $r2, 56
; CV1-NEXT:    insf $r9 = $r8, 15, 8
; CV1-NEXT:    andd $r10 = $r11, 0xff00ff00ff00ff
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r1 = $r7, 15, 8
; CV1-NEXT:    andd $r4 = $r4, 0xff00ff00ff00ff00
; CV1-NEXT:    extfz $r8 = $r2, 55, 48
; CV1-NEXT:    ;;
; CV1-NEXT:    ord $r4 = $r4, $r10
; CV1-NEXT:    sxbd $r6 = $r6
; CV1-NEXT:    extfz $r7 = $r2, 47, 40
; CV1-NEXT:    srlw $r11 = $r2, 24
; CV1-NEXT:    ;;
; CV1-NEXT:    sxbd $r8 = $r8
...
; CV1-NEXT:    andd $r16 = $r4, 0x7f7f7f7f7f7f7f7f
; CV1-NEXT:    ;;
; CV1-NEXT:    zxbd $r2 = $r2
...
; CV1-NEXT:    sxbd $r15 = $r15
; CV1-NEXT:    addd $r16 = $r17, $r16
; CV1-NEXT:    ;;
; CV1-NEXT:    xord $r3 = $r16, $r3
; CV1-NEXT:    sraw $r6 = $r6, 5
; CV1-NEXT:    sraw $r7 = $r7, 5
; CV1-NEXT:    sxbd $r10 = $r10
; CV1-NEXT:    ;;
...
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r3 = $r17, 15, 8
; CV1-NEXT:    insf $r10 = $r4, 31, 16
; CV1-NEXT:    ;;
; CV1-NEXT:    insf $r3 = $r16, 31, 16
; CV1-NEXT:    ;;
