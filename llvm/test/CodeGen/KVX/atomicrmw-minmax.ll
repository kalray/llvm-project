...
; RUN: llc -mcpu=kv3-1 -o - %s -mtriple=kvx-kalray-cos | FileCheck %s --check-prefixes=CV1
; RUN: llc -mcpu=kv3-2 -o - %s -mtriple=kvx-kalray-cos | FileCheck %s --check-prefixes=CV2
