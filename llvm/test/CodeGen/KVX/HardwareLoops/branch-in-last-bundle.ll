...
; CHECK-NEXT:    addw $r9 = $r1, 1
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    addw $r1 = $r1, $r4
; CHECK-NEXT:    sxwd $r6 = $r9
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    sxwd $r7 = $r1
; CHECK-NEXT:    addw $r8 = $r1, -1
...
; CHECK-NEXT:    lwz $r16 = 0[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.lt $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = -4[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 0[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 4[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 4[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 8[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 4[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 8[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 12[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 12[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 16[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 12[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 16[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 20[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 20[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 24[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 20[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 24[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 28[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 28[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 32[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 28[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 32[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 36[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 36[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 40[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 36[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 40[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 44[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 44[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 48[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.ge $r15 = $r15, $r7
; CHECK-NEXT:    lwz $r17 = 44[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 48[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    lwz $r32 = 52[$r9]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    fmulw $r16 = $r16, $r17
; CHECK-NEXT:    lwz $r17 = 52[$r8]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r17, $r32
...
; CHECK-NEXT:    lwz $r16 = 56[$r8]
; CHECK-NEXT:    ;; # (end cycle 0)
; CHECK-NEXT:    compd.lt $r17 = $r6, $r7
; CHECK-NEXT:    lwz $r32 = 52[$r9]
; CHECK-NEXT:    ;; # (end cycle 1)
; CHECK-NEXT:    lwz $r11 = 56[$r9]
; CHECK-NEXT:    ;; # (end cycle 2)
; CHECK-NEXT:    addd $r8 = $r8, 64
; CHECK-NEXT:    lwz $r33 = 60[$r8]
; CHECK-NEXT:    ;; # (end cycle 3)
; CHECK-NEXT:    addd $r9 = $r9, 64
; CHECK-NEXT:    fmulw $r16 = $r16, $r32
; CHECK-NEXT:    lwz $r32 = 60[$r9]
; CHECK-NEXT:    ;; # (end cycle 4)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 8)
; CHECK-NEXT:    fmulw $r16 = $r33, $r32
; CHECK-NEXT:    ;; # (end cycle 9)
; CHECK-NEXT:    fsbfw $r11 = $r16, $r11
; CHECK-NEXT:    ;; # (end cycle 13)
; CHECK-NEXT:    sw 32[$r10] = $r11
; CHECK-NEXT:    copyd $r10 = $r15
; CHECK-NEXT:    cb.odd $r17 ? .LBB0_5
; CHECK-NEXT:    ;; # (end cycle 16)
