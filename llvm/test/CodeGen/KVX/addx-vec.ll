...
; V2:       # %bb.0: # %entry
; V2-NEXT:    sllbos $r0 = $r0, 1
; V2-NEXT:    sllbos $r2 = $r0, 2
; V2-NEXT:    ;;
; V2-NEXT:    copyd $r3 = $r0
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r2, 7, 0
; V2-NEXT:    ;;
; V2-NEXT:    insf $r2 = $r3, 15, 0
; V2-NEXT:    ;;
; V2-NEXT:    insf $r0 = $r2, 23, 0
; V2-NEXT:    ;;
; V2-NEXT:    addbo $r0 = $r0, $r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V1-NEXT:    andd $r1 = $r0, 0xff00ff00ff00ff
; V1-NEXT:    make $r2 = 1
; V1-NEXT:    ;;
; V1-NEXT:    slld $r0 = $r0, $r2
; V1-NEXT:    slld $r1 = $r1, $r2
; V1-NEXT:    ;;
; V1-NEXT:    andd $r0 = $r0, 0xff00ff00ff00ff00
; V1-NEXT:    andd $r1 = $r1, 0xff00ff00ff00ff
; V1-NEXT:    ;;
...
; V1-NEXT:    ord $r2 = $r0, 0x8080808080808080
; V1-NEXT:    andd $r3 = $r1, 0x7f7f7f7f7f7f7f7f
; V1-NEXT:    ;;
; V1-NEXT:    andd $r0 = $r0, 0x8080808080808080
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x1000100010001
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x1000200010002
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V2-NEXT:    sllbos $r0 = $r0, 1
; V2-NEXT:    ;;
; V2-NEXT:    ord $r0 = $r0, 0x1000200010002
; V2-NEXT:    ret
; V2-NEXT:    ;;
entry:
  %mul = shl <8 x i8> %a, <i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1, i8 1>
...
; V1:       # %bb.0: # %entry
; V1-NEXT:    andd $r0 = $r0, 0xff00ff00ff00ff00
; V1-NEXT:    andd $r2 = $r0, 0xff00ff00ff00ff
; V1-NEXT:    make $r3 = 1
; V1-NEXT:    ;;
; V1-NEXT:    slld $r0 = $r0, $r3
; V1-NEXT:    slld $r2 = $r2, $r3
; V1-NEXT:    andd $r3 = $r1, 0x7f7f7f7f7f7f7f7f
; V1-NEXT:    ;;
; V1-NEXT:    andd $r0 = $r0, 0xff00ff00ff00ff00
; V1-NEXT:    andd $r2 = $r2, 0xff00ff00ff00ff
; V1-NEXT:    ;;
...
; V1-NEXT:    srlw $r6 = $r0, 24
; V1-NEXT:    ;;
; V1-NEXT:    extfz $r5 = $r0, 39, 32
; V1-NEXT:    extfz $r7 = $r0, 23, 16
; V1-NEXT:    zxbd $r8 = $r0
; V1-NEXT:    ;;
...
; V1-NEXT:    sllw $r7 = $r7, 1
; V1-NEXT:    sllw $r8 = $r8, 2
; V1-NEXT:    ;;
; V1-NEXT:    sllw $r0 = $r0, 1
...
; V1-NEXT:    insf $r8 = $r0, 15, 8
; V1-NEXT:    ;;
; V1-NEXT:    andd $r2 = $r1, 0x7f7f7f7f7f7f7f7f
; V1-NEXT:    insf $r5 = $r2, 31, 16
; V1-NEXT:    insf $r8 = $r7, 31, 16
; V1-NEXT:    ;;
; V1-NEXT:    insf $r8 = $r5, 63, 32
; V1-NEXT:    ;;
; V1-NEXT:    andd $r0 = $r8, 0x7f7f7f7f7f7f7f7f
; V1-NEXT:    xord $r1 = $r8, $r1
; V1-NEXT:    ;;
...
; V2-NEXT:    sllbos $r5 = $r0, $r5
; V2-NEXT:    ;;
; V2-NEXT:    extfz $r4 = $r2, 26, 24
; V2-NEXT:    ;;
; V2-NEXT:    sllbos $r4 = $r0, $r4
; V2-NEXT:    insf $r5 = $r3, 15, 0
; V2-NEXT:    ;;
; V2-NEXT:    extfz $r3 = $r2, 34, 32
; V2-NEXT:    insf $r4 = $r5, 23, 0
; V2-NEXT:    ;;
; V2-NEXT:    sllbos $r3 = $r0, $r3
; V2-NEXT:    extfz $r5 = $r2, 42, 40
; V2-NEXT:    ;;
; V2-NEXT:    insf $r3 = $r4, 31, 0
; V2-NEXT:    sllbos $r5 = $r0, $r5
; V2-NEXT:    ;;
; V2-NEXT:    extfz $r2 = $r2, 58, 56
; V2-NEXT:    extfz $r4 = $r2, 50, 48
; V2-NEXT:    ;;
; V2-NEXT:    sllbos $r3 = $r0, $r4
; V2-NEXT:    insf $r5 = $r3, 39, 0
; V2-NEXT:    ;;
; V2-NEXT:    sllbos $r0 = $r0, $r2
; V2-NEXT:    insf $r3 = $r5, 47, 0
; V2-NEXT:    ;;
; V2-NEXT:    insf $r0 = $r3, 55, 0
; V2-NEXT:    ;;
; V2-NEXT:    addbo $r0 = $r0, $r1
; V2-NEXT:    ret
; V2-NEXT:    ;;
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x3020100030201
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x1040200010402
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V2-NEXT:    sllbos $r0 = $r0, 2
; V2-NEXT:    ;;
; V2-NEXT:    ord $r0 = $r0, 0x1040200010402
; V2-NEXT:    ret
; V2-NEXT:    ;;
entry:
  %mul = shl <8 x i8> %a, <i8 2, i8 2, i8 2, i8 2, i8 2, i8 2, i8 2, i8 2>
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x7020100070201
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x1080200010802
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V2-NEXT:    sllbos $r0 = $r0, 3
; V2-NEXT:    ;;
; V2-NEXT:    ord $r0 = $r0, 0x1080200010802
; V2-NEXT:    ret
; V2-NEXT:    ;;
entry:
  %mul = shl <8 x i8> %a, <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>
...
; V1-NEXT:    sllw $r7 = $r7, 3
; V1-NEXT:    sllw $r8 = $r8, 3
; V1-NEXT:    ;;
; V1-NEXT:    sllw $r0 = $r0, 3
; V1-NEXT:    insf $r2 = $r3, 15, 8
; V1-NEXT:    insf $r5 = $r4, 15, 8
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0xf0201000f0201
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V1-NEXT:    ord $r0 = $r0, $r1
; V1-NEXT:    ;;
; V1-NEXT:    ord $r0 = $r0, 0x1100200011002
; V1-NEXT:    ret
; V1-NEXT:    ;;
;
...
; V2-NEXT:    sllbos $r0 = $r0, 4
; V2-NEXT:    ;;
; V2-NEXT:    ord $r0 = $r0, 0x1100200011002
; V2-NEXT:    ret
; V2-NEXT:    ;;
entry:
  %mul = shl <8 x i8> %a, <i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4, i8 4>
...
; V1-NEXT:    sllw $r7 = $r7, 4
; V1-NEXT:    sllw $r8 = $r8, 4
; V1-NEXT:    ;;
; V1-NEXT:    sllw $r0 = $r0, 4
; V1-NEXT:    insf $r2 = $r3, 15, 8
; V1-NEXT:    insf $r5 = $r4, 15, 8
