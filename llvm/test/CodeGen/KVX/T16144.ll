...
; RUN: llc -mcpu=kv3-1 -verify-machineinstrs -o - %s -mtriple=kvx-kalray-cos | FileCheck %s --check-prefixes=CHECK,CV1
; RUN: llc -mcpu=kv3-2 -verify-machineinstrs -o - %s -mtriple=kvx-kalray-cos | FileCheck %s --check-prefixes=CHECK,CV2
