...
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.wnez $r2 ? .LBB2_15
; CHECK-NEXT:    ;;
; CHECK-NEXT:    acswapw $r7[$r0] = $r4r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.even $r4 ? .LBB2_14
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB2_15: # Label of block must be emitted
...
; CHECK-NEXT:    slld $r3 = $r3, 3
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB2_16: # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    lwz.u $r5 = $r7[$r0]
; CHECK-NEXT:    sllw $r6 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    srlw $r2 = $r5, $r3
...
; CHECK-NEXT:    andw $r2 = $r2, 255
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.wnez $r2 ? .LBB2_13
; CHECK-NEXT:    ;;
; CHECK-NEXT:    acswapw $r7[$r0] = $r4r5
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.even $r4 ? .LBB2_12
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB2_13: # Label of block must be emitted
; CHECK-NEXT:  .LBB2_11:
