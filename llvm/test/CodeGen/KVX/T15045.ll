...
; RUN: llc -verify-machineinstrs -O3 -asm-verbose=false < %s -mtriple=kvx-kalray-cos | FileCheck %s
...
; CHECK-NEXT:    compd.eq $r2 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r2 ? .LBB0_39
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_42
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_41:
; CHECK-NEXT:    copyd $r1 = $r3
; CHECK-NEXT:    ;;
...
; CHECK-NEXT:    acswapd 24[$r12] = $r2r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r2 ? .LBB0_45
; CHECK-NEXT:    ;;
; CHECK-NEXT:    ld.u $r1 = 24[$r12]
; CHECK-NEXT:    ;;
; CHECK-NEXT:    compd.eq $r2 = $r1, $r3
; CHECK-NEXT:    ;;
; CHECK-NEXT:    cb.odd $r2 ? .LBB0_43
; CHECK-NEXT:    ;;
; CHECK-NEXT:    goto .LBB0_46
; CHECK-NEXT:    ;;
; CHECK-NEXT:  .LBB0_45:
; CHECK-NEXT:    copyd $r1 = $r3
; CHECK-NEXT:    ;;
