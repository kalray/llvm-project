...
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <4 x i64> poison, <4 x i64> [[TMP4]], <4 x i32> <i32 4, i32 5, i32 2, i32 3>
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <2 x i64> [[TMP3]], <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CHECK-NEXT:    [[TMP7:%.*]] = shufflevector <4 x i64> [[TMP5]], <4 x i64> [[TMP6]], <4 x i32> <i32 0, i32 1, i32 4, i32 5>
; CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i64> [[TMP7]], <4 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
; CHECK-NEXT:    [[TMP9:%.*]] = call i64 @llvm.vector.reduce.xor.v4i64(<4 x i64> [[TMP8]])
; CHECK-NEXT:    [[OP_RDX23:%.*]] = xor i64 [[TMP1]], [[TMP0]]
; CHECK-NEXT:    [[OP_RDX24:%.*]] = xor i64 [[OP_RDX23]], [[TMP9]]
; CHECK-NEXT:    [[OP_RDX25]] = xor i64 0, [[OP_RDX24]]
; CHECK-NEXT:    br label [[WHILE]]
;
entry:
