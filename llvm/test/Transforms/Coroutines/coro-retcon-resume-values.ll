...
; CHECK-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [[F_FRAME:%.*]], %f.Frame* [[FRAMEPTR_I1]], i64 0, i32 2
; CHECK-NEXT:    [[INPUT_RELOAD_I:%.*]] = load i32, i32* [[TMP5]], align 4, !noalias !3
; CHECK-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [[F_FRAME]], %f.Frame* [[FRAMEPTR_I1]], i64 0, i32 1
; CHECK-NEXT:    [[N_VAL3_RELOAD_I:%.*]] = load i32, i32* [[TMP6]], align 4, !noalias !3
; CHECK-NEXT:    [[SUM8_I:%.*]] = add i32 [[N_VAL3_RELOAD_I]], [[INPUT_RELOAD_I]]
; CHECK-NEXT:    store i32 [[SUM8_I]], i32* [[TMP6]], align 4, !noalias !3
; CHECK-NEXT:    store i32 4, i32* [[TMP5]], align 4, !noalias !3
...
; CHECK-NEXT:    [[TMP7:%.*]] = getelementptr inbounds [[F_FRAME]], %f.Frame* [[FRAMEPTR_I2]], i64 0, i32 2
; CHECK-NEXT:    [[INPUT_RELOAD_I3:%.*]] = load i32, i32* [[TMP7]], align 4, !noalias !6
; CHECK-NEXT:    [[TMP8:%.*]] = getelementptr inbounds [[F_FRAME]], %f.Frame* [[FRAMEPTR_I2]], i64 0, i32 1
; CHECK-NEXT:    [[N_VAL3_RELOAD_I4:%.*]] = load i32, i32* [[TMP8]], align 4, !noalias !6
; CHECK-NEXT:    [[SUM8_I5:%.*]] = add i32 [[N_VAL3_RELOAD_I4]], [[INPUT_RELOAD_I3]]
; CHECK-NEXT:    tail call void @print(i32 [[SUM8_I5]]), !noalias !6
; CHECK-NEXT:    [[TMP9:%.*]] = bitcast %f.Frame* [[FRAMEPTR_I2]] to i8*
; CHECK-NEXT:    tail call void @deallocate(i8* [[TMP9]]), !noalias !6
