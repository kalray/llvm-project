...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %cc = fcmp une <4 x float> %c, %d
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp une <4 x float> %a, %b
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ueq <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ugt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp uge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ult <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ule <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp uno <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp one <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp oeq <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ogt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp oge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp olt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ole <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = fcmp ord <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-LABEL: 'test_sqrt'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.sqrt.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_powi'
; ALL-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %r = call <4 x float> @llvm.powi.v4f32.i32(<4 x float> %a, i32 %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_sin'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.sin.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_cos'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.cos.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_pow'
; ALL-NEXT:  Cost Model: Found an estimated cost of 13 for instruction: %r = call <4 x float> @llvm.pow.v4f32(<4 x float> %a, <4 x float> %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_exp'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.exp.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_exp2'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.exp2.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_log'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.log.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.log10.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_log2'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.log2.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %r = call <4 x float> @llvm.minnum.v4f32(<4 x float> %a, <4 x float> %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %r = call fast <4 x float> @llvm.minnum.v4f32(<4 x float> %a, <4 x float> %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %r = call <4 x float> @llvm.maxnum.v4f32(<4 x float> %a, <4 x float> %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 9 for instruction: %r = call fast <4 x float> @llvm.maxnum.v4f32(<4 x float> %a, <4 x float> %b)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.floor.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_ceil'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.ceil.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.trunc.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-LABEL: 'test_rint'
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.rint.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.nearbyint.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %r = call <4 x float> @llvm.round.v4f32(<4 x float> %a)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x float> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp oeq <4 x float> %a, %b
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp oeq <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ogt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ogt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp oge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp oge <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp olt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp olt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ole <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ole <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp one <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp one <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ord <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ord <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp uno <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp uno <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ueq <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ueq <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ugt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ugt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp uge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp uge <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ult <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ult <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ule <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp ule <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp une <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp une <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast oeq <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast oeq <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ogt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ogt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast oge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast oge <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast olt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast olt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ole <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ole <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast one <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast one <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ord <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ord <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast uno <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast uno <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ueq <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ueq <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ugt <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ugt <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast uge <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast uge <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ult <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ult <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ule <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast ule <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast une <4 x float> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %0 = fcmp fast une <4 x float> %a, %a
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i32> %1
;
entry:
