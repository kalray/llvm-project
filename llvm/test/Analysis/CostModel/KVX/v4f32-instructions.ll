...
; ALL-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %1 = sext <4 x i1> %0 to <4 x i32>
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
