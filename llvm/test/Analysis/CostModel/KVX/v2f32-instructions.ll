...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %t1 = load <2 x float>, <2 x float>* %a, align 8
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <2 x float> %t1, <2 x float>* %b, align 16
