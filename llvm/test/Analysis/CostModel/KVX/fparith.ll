...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %fdivv2f16 = fdiv <2 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %fabsv8f64 = call <8 x double> @llvm.fabs.v8f64(<8 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %faddv8f64 = fadd <8 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %fmav8f64 = call <8 x double> @llvm.fma.v8f64(<8 x double> undef, <8 x double> undef, <8 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fmulv8f64 = fmul <8 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 40 for instruction: %fdivv8f64 = fdiv <8 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fabsv16f32 = call <16 x float> @llvm.fabs.v16f32(<16 x float> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %fdivv16f32 = fdiv <16 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fabsv16f64 = call <16 x double> @llvm.fabs.v16f64(<16 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 128 for instruction: %faddv16f64 = fadd <16 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fmav16f64 = call <16 x double> @llvm.fma.v16f64(<16 x double> undef, <16 x double> undef, <16 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 128 for instruction: %fmulv16f64 = fmul <16 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %fdivv16f64 = fdiv <16 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f16 = call <32 x half> @llvm.fabs.v32f16(<32 x half> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %faddv32f16 = fadd <32 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fmav32f16 = call <32 x half> @llvm.fma.v32f16(<32 x half> undef, <32 x half> undef, <32 x half> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fmulv32f16 = fmul <32 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 96 for instruction: %fdivv32f16 = fdiv <32 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %fsubv32f16 = fsub <32 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f32 = call <32 x float> @llvm.fabs.v32f32(<32 x float> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %fdivv32f32 = fdiv <32 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f64 = call <32 x double> @llvm.fabs.v32f64(<32 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %faddv32f64 = fadd <32 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fmav32f64 = call <32 x double> @llvm.fma.v32f64(<32 x double> undef, <32 x double> undef, <32 x double> undef)
; CV1-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %fmulv32f64 = fmul <32 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %fdivv32f64 = fdiv <32 x double> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %fdivv2f16 = fdiv <2 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %fabsv8f64 = call <8 x double> @llvm.fabs.v8f64(<8 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %faddv8f64 = fadd <8 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %fmav8f64 = call <8 x double> @llvm.fma.v8f64(<8 x double> undef, <8 x double> undef, <8 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fmulv8f64 = fmul <8 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 40 for instruction: %fdivv8f64 = fdiv <8 x double> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fabsv16f32 = call <16 x float> @llvm.fabs.v16f32(<16 x float> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %fdivv16f32 = fdiv <16 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fabsv16f64 = call <16 x double> @llvm.fabs.v16f64(<16 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 128 for instruction: %faddv16f64 = fadd <16 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 32 for instruction: %fmav16f64 = call <16 x double> @llvm.fma.v16f64(<16 x double> undef, <16 x double> undef, <16 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 128 for instruction: %fmulv16f64 = fmul <16 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 80 for instruction: %fdivv16f64 = fdiv <16 x double> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f16 = call <32 x half> @llvm.fabs.v32f16(<32 x half> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 96 for instruction: %fdivv32f16 = fdiv <32 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f32 = call <32 x float> @llvm.fabs.v32f32(<32 x float> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %fdivv32f32 = fdiv <32 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fabsv32f64 = call <32 x double> @llvm.fabs.v32f64(<32 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %faddv32f64 = fadd <32 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 64 for instruction: %fmav32f64 = call <32 x double> @llvm.fma.v32f64(<32 x double> undef, <32 x double> undef, <32 x double> undef)
; CV2-NEXT:  Cost Model: Found an estimated cost of 512 for instruction: %fmulv32f64 = fmul <32 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 160 for instruction: %fdivv32f64 = fdiv <32 x double> undef, undef
