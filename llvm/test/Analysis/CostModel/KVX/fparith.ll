...
; CV1-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf16 = fdiv half undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulf32 = fmul float undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf32 = fdiv float undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulf64 = fmul double undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf64 = fdiv double undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f16 = fdiv <2 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulv2f32 = fmul <2 x float> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f32 = fdiv <2 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f64 = fdiv <2 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f16 = fdiv <4 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f32 = fdiv <4 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %faddv4f64 = fadd <4 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f64 = fdiv <4 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %fmuladdv4f64 = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> undef, <4 x double> undef, <4 x double> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 17 for instruction: %faddv8f16 = fadd <8 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv8f16 = fdiv <8 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 22 for instruction: %fmuladdv8f16 = call <8 x half> @llvm.fmuladd.v8f16(<8 x half> undef, <8 x half> undef, <8 x half> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv8f32 = fdiv <8 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %faddv8f64 = fadd <8 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv8f64 = fdiv <8 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %fmuladdv8f64 = call <8 x double> @llvm.fmuladd.v8f64(<8 x double> undef, <8 x double> undef, <8 x double> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 33 for instruction: %faddv16f16 = fadd <16 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %fmulv16f16 = fmul <16 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv16f16 = fdiv <16 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 40 for instruction: %fmuladdv16f16 = call <16 x half> @llvm.fmuladd.v16f16(<16 x half> undef, <16 x half> undef, <16 x half> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv16f32 = fdiv <16 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %faddv16f64 = fadd <16 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv16f64 = fdiv <16 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %fmuladdv16f64 = call <16 x double> @llvm.fmuladd.v16f64(<16 x double> undef, <16 x double> undef, <16 x double> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 88 for instruction: %faddv32f16 = fadd <32 x half> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 10 for instruction: %fmulv32f16 = fmul <32 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv32f16 = fdiv <32 x half> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 122 for instruction: %fmuladdv32f16 = call <32 x half> @llvm.fmuladd.v32f16(<32 x half> undef, <32 x half> undef, <32 x half> undef)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv32f32 = fdiv <32 x float> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %faddv32f64 = fadd <32 x double> undef, undef
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv32f64 = fdiv <32 x double> undef, undef
; CV1-NEXT:  Cost Model: Found an estimated cost of 48 for instruction: %fmuladdv32f64 = call <32 x double> @llvm.fmuladd.v32f64(<32 x double> undef, <32 x double> undef, <32 x double> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf16 = fdiv half undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulf32 = fmul float undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf32 = fdiv float undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulf64 = fmul double undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 50 for instruction: %fdivf64 = fdiv double undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f16 = fdiv <2 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %fmulv2f32 = fmul <2 x float> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f32 = fdiv <2 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %faddv2f64 = fadd <2 x double> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 100 for instruction: %fdivv2f64 = fdiv <2 x double> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f16 = fdiv <4 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %faddv4f32 = fadd <4 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f32 = fdiv <4 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv4f64 = fdiv <4 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %fmuladdv4f64 = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> undef, <4 x double> undef, <4 x double> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %faddv8f16 = fadd <8 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %fmulv8f16 = fmul <8 x half> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv8f16 = fdiv <8 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %faddv8f32 = fadd <8 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv8f32 = fdiv <8 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv8f64 = fdiv <8 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 12 for instruction: %fmuladdv8f64 = call <8 x double> @llvm.fmuladd.v8f64(<8 x double> undef, <8 x double> undef, <8 x double> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %faddv16f16 = fadd <16 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %fmulv16f16 = fmul <16 x half> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv16f16 = fdiv <16 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %faddv16f32 = fadd <16 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv16f32 = fdiv <16 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv16f64 = fdiv <16 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 24 for instruction: %fmuladdv16f64 = call <16 x double> @llvm.fmuladd.v16f64(<16 x double> undef, <16 x double> undef, <16 x double> undef)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %faddv32f16 = fadd <32 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 5 for instruction: %fmulv32f16 = fmul <32 x half> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 400 for instruction: %fdivv32f16 = fdiv <32 x half> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %faddv32f32 = fadd <32 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv32f32 = fdiv <32 x float> undef, undef
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 200 for instruction: %fdivv32f64 = fdiv <32 x double> undef, undef
; CV2-NEXT:  Cost Model: Found an estimated cost of 48 for instruction: %fmuladdv32f64 = call <32 x double> @llvm.fmuladd.v32f64(<32 x double> undef, <32 x double> undef, <32 x double> undef)
