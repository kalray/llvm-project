...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %t1 = load <2 x i64>, <2 x i64>* %a, align 16
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <2 x i64> %t1, <2 x i64>* %b, align 16
...
; ALL-LABEL: 'test_abs'
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %r = call <2 x i64> @llvm.abs.v2i64(<2 x i64> %a, i1 false)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x i64> %r
;
