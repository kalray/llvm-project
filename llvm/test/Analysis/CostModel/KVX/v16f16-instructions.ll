...
; ALL-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %t1 = load <16 x half>, <16 x half>* %a, align 32
; ALL-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: store <16 x half> %t1, <16 x half>* %b, align 16
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %1 = sext <16 x i1> %0 to <16 x i16>
