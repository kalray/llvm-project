...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %t1 = load <2 x half>, <2 x half>* %a, align 4
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <2 x half> %t1, <2 x half>* %b, align 16
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select <2 x i1> %cc, <2 x half> %a, <2 x half> %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x half> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %1 = sext <2 x i1> %0 to <2 x i16>
