...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %t1 = load <2 x i8>, <2 x i8>* %a, align 2
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <2 x i8> %t1, <2 x i8>* %b, align 16
