...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %0 = load <16 x i32>, ptr %in, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: store <16 x i32> %0, ptr %out, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
entry:
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = load <8 x i64>, ptr %in, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: store <8 x i64> %0, ptr %out, align 64
; CHECK-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret void
;
entry:
