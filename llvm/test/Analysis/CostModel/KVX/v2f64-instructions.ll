...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %t1 = load <2 x double>, <2 x double>* %a, align 16
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <2 x double> %t1, <2 x double>* %b, align 16
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select <2 x i1> %cc, <2 x double> %a, <2 x double> %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <2 x double> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = fcmp une <2 x double> %c, %d
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select <2 x i1> %cc, <2 x float> %a, <2 x float> %b
