...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %cc = icmp slt <4 x i8> %c, %d
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = select <4 x i1> %cc, <4 x i8> %a, <4 x i8> %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i8> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %cc = icmp ult <4 x i8> %c, %d
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = icmp ule <4 x i8> %a, %b
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = icmp slt <4 x i8> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = icmp ugt <4 x i8> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = icmp uge <4 x i8> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-NEXT:  Cost Model: Invalid cost for instruction: %r = icmp ult <4 x i8> %a, %b
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; ALL-LABEL: 'test_abs'
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = call <4 x i8> @llvm.abs.v4i8(<4 x i8> %a, i1 false)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i8> %r
;
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %0 = tail call <4 x i8> @llvm.abs.v4i8(<4 x i8> %sub, i1 true)
...
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = tail call <4 x i8> @llvm.abs.v4i8(<4 x i8> %2, i1 true)
; ALL-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i8> %3
;
