...
; ALL-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %t1 = load <16 x i8>, <16 x i8>* %a, align 16
; ALL-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: store <16 x i8> %t1, <16 x i8>* %b, align 16
