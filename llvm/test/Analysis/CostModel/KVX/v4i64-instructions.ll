...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 0
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i64 %e
;
; CV2-LABEL: 'test_extract_0'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 0
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 1
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i64 %e
;
; CV2-LABEL: 'test_extract_1'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 1
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i64 %e
;
...
; CV1-LABEL: 'test_fma'
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %m = mul <4 x i64> %b, %c
...
;
; CV2-LABEL: 'test_fma'
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %m = mul <4 x i64> %b, %c
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %m = mul <4 x i64> <i64 1, i64 2, i64 1, i64 2>, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %ad = add <4 x i64> %a, %m
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %ad
;
; CV2-LABEL: 'test_fma_imm'
; CV2-NEXT:  Cost Model: Found an estimated cost of 6 for instruction: %m = mul <4 x i64> <i64 1, i64 2, i64 1, i64 2>, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %ad = add <4 x i64> %a, %m
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %ad
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 %idx
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i64 %e
;
; CV2-LABEL: 'test_extract_i'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %e = extractelement <4 x i64> %a, i64 %idx
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret i64 %e
;
...
; CV1-LABEL: 'test_mul'
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = mul <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_mul'
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = mul <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
  %r = mul <4 x i64> %a, %b
  ret <4 x i64> %r
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = mul <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r1 = mul <4 x i64> %r, %c
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r1
;
; CV2-LABEL: 'test_mul_2'
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = mul <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r1 = mul <4 x i64> %r, %c
...
; CV1-LABEL: 'test_div'
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = sdiv <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_div'
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = sdiv <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
  %r = sdiv <4 x i64> %a, %b
  ret <4 x i64> %r
...
; CV1-LABEL: 'test_rem'
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = srem <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_rem'
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %r = srem <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
  %r = srem <4 x i64> %a, %b
  ret <4 x i64> %r
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = select i1 %c, <4 x i64> %a, <4 x i64> %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_select'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = select i1 %c, <4 x i64> %a, <4 x i64> %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %cc = icmp slt <4 x i64> %c, %d
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %cc = icmp slt <4 x i64> %c, %d
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %cc = icmp ult <4 x i64> %c, %d
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = select <4 x i1> %cc, <4 x i64> %a, <4 x i64> %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_select_cc_f32_f32'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %cc = icmp ult <4 x i64> %c, %d
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = select <4 x i1> %cc, <4 x i64> %a, <4 x i64> %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ule <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ule'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ule <4 x i64> %a, %b
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp slt <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_slt'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp slt <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ugt <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ugt'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ugt <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp uge <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_uge'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp uge <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ult <4 x i64> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ult'
; CV2-NEXT:  Cost Model: Found an estimated cost of 70000 for instruction: %r = icmp ult <4 x i64> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-LABEL: 'test_abs'
; CV1-NEXT:  Cost Model: Found an estimated cost of 140006 for instruction: %r = call <4 x i64> @llvm.abs.v4i64(<4 x i64> %a, i1 false)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
; CV2-LABEL: 'test_abs'
; CV2-NEXT:  Cost Model: Found an estimated cost of 140006 for instruction: %r = call <4 x i64> @llvm.abs.v4i64(<4 x i64> %a, i1 false)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %i = insertelement <4 x i64> %a, i64 %x, i64 %p
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %i
;
; CV2-LABEL: 'test_insertelement'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %i = insertelement <4 x i64> %a, i64 %x, i64 %p
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %i
;
...
; CV1-LABEL: 'concat'
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v = shufflevector <2 x i64> %a, <2 x i64> %b, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %v
;
; CV2-LABEL: 'concat'
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %v = shufflevector <2 x i64> %a, <2 x i64> %b, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %mul = mul nsw <4 x i64> %1, %0
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %mul = mul nsw <4 x i64> %1, %0
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = zext <4 x i32> %b to <4 x i64>
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %mul = mul nuw <4 x i64> %1, %0
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %mul
;
; CV2-LABEL: 'MULUWDP'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %0 = zext <4 x i32> %a to <4 x i64>
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %1 = zext <4 x i32> %b to <4 x i64>
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %mul = mul nuw <4 x i64> %1, %0
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %mul
;
entry:
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %6 = mul nsw <4 x i64> %5, %4
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %6 = mul nsw <4 x i64> %5, %4
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %5 = zext <4 x i32> %2 to <4 x i64>
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %6 = mul nuw <4 x i64> %5, %4
; CV1-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %7 = add <4 x i64> %6, %0
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %7
;
; CV2-LABEL: 'MADDUWDP'
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %5 = zext <4 x i32> %2 to <4 x i64>
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %6 = mul nuw <4 x i64> %5, %4
; CV2-NEXT:  Cost Model: Found an estimated cost of 7 for instruction: %7 = add <4 x i64> %6, %0
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i64> %7
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %3 = shufflevector <4 x i64> zeroinitializer, <4 x i64> undef, <2 x i32> <i32 0, i32 1>
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %4 = add nsw <2 x i64> zeroinitializer, %3
; CV1-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = shufflevector <2 x i64> %4, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CV1-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %6 = shufflevector <4 x i64> %5, <4 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %3 = shufflevector <4 x i64> zeroinitializer, <4 x i64> undef, <2 x i32> <i32 0, i32 1>
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %4 = add nsw <2 x i64> zeroinitializer, %3
; CV2-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = shufflevector <2 x i64> %4, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CV2-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %6 = shufflevector <4 x i64> %5, <4 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %4 = add nsw <2 x i64> zeroinitializer, %3
; CV1-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = shufflevector <2 x i64> %4, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CV1-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %6 = shufflevector <4 x i64> %5, <4 x i64> zeroinitializer, <4 x i32> <i32 6, i32 7, i32 2, i32 3>
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <4 x i64> %6, ptr undef, align 16
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: br label %2
;
; CV2-LABEL: 'subvec2'
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %4 = add nsw <2 x i64> zeroinitializer, %3
; CV2-NEXT:  Cost Model: Found an estimated cost of 0 for instruction: %5 = shufflevector <2 x i64> %4, <2 x i64> poison, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
; CV2-NEXT:  Cost Model: Found an estimated cost of 8 for instruction: %6 = shufflevector <4 x i64> %5, <4 x i64> zeroinitializer, <4 x i32> <i32 6, i32 7, i32 2, i32 3>
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: store <4 x i64> %6, ptr undef, align 16
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: br label %2
;
  br label %2
