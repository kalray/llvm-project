...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select i1 %c, <4 x i16> %a, <4 x i16> %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
; CV2-LABEL: 'test_select'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select i1 %c, <4 x i16> %a, <4 x i16> %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp slt <4 x i16> %c, %d
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select <4 x i1> %cc, <4 x i16> %a, <4 x i16> %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
; CV2-LABEL: 'test_select_cc'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp slt <4 x i16> %c, %d
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select <4 x i1> %cc, <4 x i16> %a, <4 x i16> %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp ult <4 x i16> %c, %d
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp ult <4 x i16> %c, %d
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ule <4 x i16> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ule'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ule <4 x i16> %a, %b
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp slt <4 x i16> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_slt'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp slt <4 x i16> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ugt <4 x i16> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ugt'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ugt <4 x i16> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp uge <4 x i16> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_uge'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp uge <4 x i16> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ult <4 x i16> %a, %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
; CV2-LABEL: 'test_icmp_ult'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = icmp ult <4 x i16> %a, %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i1> %r
;
...
; CV1-LABEL: 'test_abs'
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %r = call <4 x i16> @llvm.abs.v4i16(<4 x i16> %a, i1 false)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
; CV2-LABEL: 'test_abs'
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %r = call <4 x i16> @llvm.abs.v4i16(<4 x i16> %a, i1 false)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
...
; CV1-LABEL: 'lnand'
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = icmp eq <4 x i16> %0, zeroinitializer
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp eq <4 x i16> %1, zeroinitializer
...
;
; CV2-LABEL: 'lnand'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = icmp eq <4 x i16> %0, zeroinitializer
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp eq <4 x i16> %1, zeroinitializer
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp ne <4 x i16> %3, zeroinitializer
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp ne <4 x i16> %3, zeroinitializer
...
; CV1-LABEL: 'lnor'
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = or <4 x i16> %1, %0
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp eq <4 x i16> %3, zeroinitializer
; CV1-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %5 = zext <4 x i1> %4 to <4 x i16>
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %5
;
; CV2-LABEL: 'lnor'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %3 = or <4 x i16> %1, %0
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %4 = icmp eq <4 x i16> %3, zeroinitializer
; CV2-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %5 = zext <4 x i1> %4 to <4 x i16>
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %5
;
  %3 = or <4 x i16> %1, %0
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %0 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %sub, i1 true)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %0 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %sub, i1 true)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %3 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %2, i1 true)
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %3 = tail call <4 x i16> @llvm.abs.v4i16(<4 x i16> %2, i1 true)
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.smax.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
; CV2-LABEL: 'v4_maxhq_rr_i16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.smax.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
entry:
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.smin.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
; CV2-LABEL: 'v4_minhq_rr_i16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.smin.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
entry:
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.umax.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
; CV2-LABEL: 'v4_umaxhq_rr_i16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.umax.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
entry:
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.umin.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
; CV2-LABEL: 'v4_uminhq_rr_i16'
; CV2-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: %0 = call <4 x i16> @llvm.umin.v4i16(<4 x i16> %a, <4 x i16> %b)
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %0
;
entry:
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp ne <4 x i16> %c, %d
...
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select i1 %cmp, <4 x i16> %a, <4 x i16> %b
; CV1-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
; CV2-LABEL: 'test_select_cmp'
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %cc = icmp ne <4 x i16> %c, %d
...
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: %r = select i1 %cmp, <4 x i16> %a, <4 x i16> %b
; CV2-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: ret <4 x i16> %r
;
